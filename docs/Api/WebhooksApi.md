...
```php
webhooksMeterArchived($webhook_event)
```
...
$webhook_event = {"id":"evt_meter_archived_001","type":"meter.archived","created":1710151200,"livemode":true,"data":{"object":{"object":"meter","id":"mtr_abc123","name":"API Requests","event_name":"api_call","aggregation":"sum","unit_name":"request","status":"archived","value_key":"quantity","archived_at":"2026-03-11T10:00:00Z"}}}; // \RevKeen\Model\WebhookEvent

try {
    $apiInstance->webhooksMeterArchived($webhook_event);
} catch (Exception $e) {
    echo 'Exception when calling WebhooksApi->webhooksMeterArchived: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
webhooksMeterCreated($webhook_event)
```
...
$webhook_event = {"id":"evt_meter_created_001","type":"meter.created","created":1710061200,"livemode":true,"data":{"object":{"object":"meter","id":"mtr_abc123","name":"API Calls","event_name":"api_call","aggregation":"sum","unit_name":"call","status":"active","value_key":"quantity"}}}; // \RevKeen\Model\WebhookEvent

try {
    $apiInstance->webhooksMeterCreated($webhook_event);
} catch (Exception $e) {
    echo 'Exception when calling WebhooksApi->webhooksMeterCreated: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
webhooksMeterPriceCreated($webhook_event)
```
...
$webhook_event = {"id":"evt_meter_price_created_001","type":"meter_price.created","created":1710062100,"livemode":true,"data":{"object":{"object":"meter_price","id":"mp_abc123","meter_id":"mtr_abc123","name":"API Calls overage","pricing_model":"tiered","billing_scheme":"per_unit","tiers_mode":"graduated","currency":"gbp","unit_amount_minor":null,"active":true}}}; // \RevKeen\Model\WebhookEvent

try {
    $apiInstance->webhooksMeterPriceCreated($webhook_event);
} catch (Exception $e) {
    echo 'Exception when calling WebhooksApi->webhooksMeterPriceCreated: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
webhooksMeterPriceDeactivated($webhook_event)
```
...
$webhook_event = {"id":"evt_meter_price_deactivated_001","type":"meter_price.deactivated","created":1710152100,"livemode":true,"data":{"object":{"object":"meter_price","id":"mp_abc123","meter_id":"mtr_abc123","name":"API Requests overage","pricing_model":"tiered","billing_scheme":"per_unit","tiers_mode":"graduated","currency":"gbp","unit_amount_minor":null,"active":false,"deactivated_at":"2026-03-11T10:15:00Z"}}}; // \RevKeen\Model\WebhookEvent

try {
    $apiInstance->webhooksMeterPriceDeactivated($webhook_event);
} catch (Exception $e) {
    echo 'Exception when calling WebhooksApi->webhooksMeterPriceDeactivated: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
webhooksMeterPriceUpdated($webhook_event)
```
...
$webhook_event = {"id":"evt_meter_price_updated_001","type":"meter_price.updated","created":1710065700,"livemode":true,"data":{"object":{"object":"meter_price","id":"mp_abc123","meter_id":"mtr_abc123","name":"API Requests overage","pricing_model":"tiered","billing_scheme":"per_unit","tiers_mode":"graduated","currency":"gbp","unit_amount_minor":null,"active":true},"previous_attributes":{"name":"API Calls overage"}}}; // \RevKeen\Model\WebhookEvent

try {
    $apiInstance->webhooksMeterPriceUpdated($webhook_event);
} catch (Exception $e) {
    echo 'Exception when calling WebhooksApi->webhooksMeterPriceUpdated: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
webhooksMeterUpdated($webhook_event)
```
...
$webhook_event = {"id":"evt_meter_updated_001","type":"meter.updated","created":1710064800,"livemode":true,"data":{"object":{"object":"meter","id":"mtr_abc123","name":"API Requests","event_name":"api_call","aggregation":"sum","unit_name":"request","status":"active","value_key":"quantity"},"previous_attributes":{"name":"API Calls","unit_name":"call"}}}; // \RevKeen\Model\WebhookEvent

try {
    $apiInstance->webhooksMeterUpdated($webhook_event);
} catch (Exception $e) {
    echo 'Exception when calling WebhooksApi->webhooksMeterUpdated: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
webhooksUsageEventIngested($webhook_event)
```
...
$webhook_event = {"id":"evt_z5i6j7k8l9m0","type":"usage.event.ingested","created":1710518460,"livemode":true,"data":{"object":{"object":"usage_event","event_id":"usage_evt_abc123","idempotency_key":"api_call_2026_03_15_001","event_name":"api_call","meter_id":"a1b2c3d4-e5f6-7890-abcd-ef1234567890","meter_name":"API Calls","customer_id":"cus_xyz789","external_customer_id":"customer_123","subscription_id":"sub_abc123","quantity":1,"billable_quantity":1,"event_time":"2026-03-15T14:30:58Z","source":"api"}}}; // \RevKeen\Model\WebhookEvent

try {
    $apiInstance->webhooksUsageEventIngested($webhook_event);
} catch (Exception $e) {
    echo 'Exception when calling WebhooksApi->webhooksUsageEventIngested: ', $e->getMessage(), PHP_EOL;
}
```
...
$webhook_event = {"id":"evt_x3g4h5i6j7k8","type":"usage.event.rejected","created":1710518400,"livemode":true,"data":{"object":{"object":"usage_event","meter_id":"a1b2c3d4-e5f6-7890-abcd-ef1234567890","customer_id":"cus_xyz789","event_id":"usage_evt_abc123","event_name":"api_call","rejection_reason":"validation_failed","rejection_message":"Property 'quantity' must be a positive number","source":"api"}}}; // \RevKeen\Model\WebhookEvent
...
```php
webhooksUsageInvoiceCreated($webhook_event)
```
...
$webhook_event = {"id":"evt_y4h5i6j7k8l9","type":"usage.invoice.created","created":1711929601,"livemode":true,"data":{"object":{"object":"usage_invoice","invoice_id":"inv_usage_001","invoice_number":"INV-2026-0042","customer_id":"cus_xyz789","subscription_id":"sub_abc123","total_amount_minor":107000,"currency":"gbp","period_start":"2026-03-01T00:00:00Z","period_end":"2026-03-31T23:59:59Z","line_items":[{"meter_id":"a1b2c3d4-e5f6-7890-abcd-ef1234567890","meter_name":"API Calls","quantity":15000,"amount_minor":107000}]}}}; // \RevKeen\Model\WebhookEvent

try {
    $apiInstance->webhooksUsageInvoiceCreated($webhook_event);
} catch (Exception $e) {
    echo 'Exception when calling WebhooksApi->webhooksUsageInvoiceCreated: ', $e->getMessage(), PHP_EOL;
}
```
...
$webhook_event = {"id":"evt_w2f3g4h5i6j7","type":"usage.period_finalized","created":1710518400,"livemode":true,"data":{"object":{"object":"usage","usage_record_id":"urec_abc123","meter_id":"a1b2c3d4-e5f6-7890-abcd-ef1234567890","meter_name":"API Calls","customer_id":"cus_xyz789","subscription_id":"sub_abc123","period_start":"2025-02-01T00:00:00Z","period_end":"2025-03-01T00:00:00Z","total_usage":12500,"event_count":12500,"included_quantity":10000,"overage_quantity":2500,"calculated_amount_minor":2500,"currency":"gbp"}}}; // \RevKeen\Model\WebhookEvent
...
$webhook_event = {"id":"evt_1a2b3c4d5e6f","type":"usage.threshold.reached","created":1710518400,"livemode":true,"data":{"object":{"object":"usage","meter_id":"a1b2c3d4-e5f6-7890-abcd-ef1234567890","meter_name":"API Calls","customer_id":"cus_xyz789","subscription_id":"sub_abc123","threshold":80,"current_usage":8500,"included_quantity":10000,"estimated_amount_minor":0,"currency":"gbp"}}}; // \RevKeen\Model\WebhookEvent
