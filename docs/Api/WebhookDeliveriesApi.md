...
$limit = 20; // int | Maximum number of deliveries to return (1-100, default 20).
...
| **limit** | **int**| Maximum number of deliveries to return (1-100, default 20). | [optional] [default to 20] |
