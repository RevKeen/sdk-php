...
**track_inventory** | **bool** | Enable a finite purchase cap that blocks purchase once stock reaches zero. One-time products only; requires stock_quantity. | [optional] [default to false]
**stock_quantity** | **int** | Remaining units that can be purchased. Required (non-negative) when track_inventory is true; ignored otherwise. | [optional]
...
**image_url** | **string** | Product image S3 key or public URL (upload via /internal/storage first) | [optional]
