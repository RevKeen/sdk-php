...
**tiers** | [**\RevKeen\Model\MeterPriceTierInput[]**](MeterPriceTierInput.md) |  | [optional]
**filter_conditions** | **array<string,mixed>[]** |  | [optional]
**filter_priority** | **int** |  | [optional]
**pay_in_advance** | **bool** |  | [optional]
**spending_minimum_cents** | **int** |  | [optional]
