...
**line_items** | [**\RevKeen\Model\PaymentLinksList200ResponseDataInnerLineItemsInner[]**](PaymentLinksList200ResponseDataInnerLineItemsInner.md) |  | [optional]
...
**selection_mode** | **string** | Customer-facing checkout shape. bundle&#x3D;all products together; single_select&#x3D;radio picker; multi_select&#x3D;cart with quantity per line. | [optional] [default to 'bundle']
...
**highlighted_product_id** | **string** | For single_select only — option shown with a &#39;Popular&#39; badge. | [optional]
**created_at** | **\DateTime** |  |
**updated_at** | **\DateTime** |  |
