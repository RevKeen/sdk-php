...
**track_inventory** | **bool** | Enable/disable the finite purchase cap (one-time products only). Requires stock_quantity when enabled. | [optional]
**stock_quantity** | **int** | Remaining units that can be purchased. Required (non-negative) when track_inventory is true. | [optional]
...
**image_url** | **string** | Product image S3 key or public URL. Pass null to remove. | [optional]
