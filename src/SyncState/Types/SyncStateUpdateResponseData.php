...
class SyncStateUpdateResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var ?value-of<SyncStateUpdateResponseDataLastSyncStatus> $lastSyncStatus
     */
     ...
     *   updatedAt: DateTime,
     *   lastSyncAt?: ?DateTime,
     *   lastSyncStatus?: ?value-of<SyncStateUpdateResponseDataLastSyncStatus>,
