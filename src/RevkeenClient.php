...
use RevKeen\Meters\MetersClient;
...
use RevKeen\Usage\UsageClient;
use RevKeen\Transactions\TransactionsClient;
use RevKeen\Exports\ExportsClient;
use RevKeen\Imports\ImportsClient;
...
class RevkeenClient
{
    ...
    /**
     * @var MetersClient $meters
     */
    public MetersClient $meters;
    ...
    /**
     * @var ExportsClient $exports
     */
    public ExportsClient $exports;

    /**
     * @var ImportsClient $imports
     */
    ...
    public function __construct(
        ...
        $this->meters = new MetersClient($this->client, $this->options);
        ...
        $this->usage = new UsageClient($this->client, $this->options);
        $this->transactions = new TransactionsClient($this->client, $this->options);
        $this->exports = new ExportsClient($this->client, $this->options);
        $this->imports = new ImportsClient($this->client, $this->options);
    }
}
