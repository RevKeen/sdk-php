...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://sandbox-api.revkeen.com/v2';
    ...
    {
        $report  = 'PHP SDK (RevKeen) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2026-01-15' . PHP_EOL;
