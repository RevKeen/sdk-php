...
class EventRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Request ID that triggered this event (if applicable)
     *
     * @return self
     */
     ...
     *
     * @param string|null $idempotency_key Idempotency key used in the request (if applicable)
     *
     * @return self
     */
