...
/**
 * AnalyticsRevenueTimeSeries200Response Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class AnalyticsRevenueTimeSeries200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'analytics_revenue_time_series_200_response';
    ...
    protected static $openAPITypes = [
        'data_points' => '\RevKeen\Model\AnalyticsRevenueTimeSeries200ResponseDataPointsInner[]',
        'total_revenue' => 'float',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['data_points'] === null) {
            $invalidProperties[] = "'data_points' can't be null";
        }
     ...
     * Gets data_points
     *
     * @return \RevKeen\Model\AnalyticsRevenueTimeSeries200ResponseDataPointsInner[]
     */
     ...
     * Sets data_points
     *
     * @param \RevKeen\Model\AnalyticsRevenueTimeSeries200ResponseDataPointsInner[] $data_points data_points
     *
     * @return self
     */
     ...
     * Sets total_revenue
     *
     * @param float $total_revenue Total revenue across the period in minor units
     *
     * @return self
     */
     ...
     * Sets total_invoices
     *
     * @param float $total_invoices Total number of invoices across the period
     *
     * @return self
     */
     ...
     * Sets period_start
     *
     * @param string $period_start Start of the period
     *
     * @return self
     */
     ...
     * Sets period_end
     *
     * @param string $period_end End of the period
     *
     * @return self
     */
