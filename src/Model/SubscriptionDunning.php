...
/**
 * SubscriptionDunning Class Doc Comment
 *
 * @category Class
 ...
 */
class SubscriptionDunning implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Subscription_dunning';
    ...
    protected static $attributeMap = [
        'is_in_dunning' => 'is_in_dunning',
        'phase' => 'phase',
        'phase_label' => 'phase_label',
        'phase_severity' => 'phase_severity',
        'retry_count' => 'retry_count',
        'total_possible_retries' => 'total_possible_retries',
        'next_retry_at' => 'next_retry_at',
        'days_in_dunning' => 'days_in_dunning',
