 ...
 *
 * @category Class
 * @description A paginated list of payments matching the query filters.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentListResponse';
    ...
    */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\Payment[] $data data
     *
     * @return self
     */
