 ...
 *
 * @category Class
 * @description A paginated list of orders matching the query filters.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class OrderListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\Order[] $data data
     *
     * @return self
     */
