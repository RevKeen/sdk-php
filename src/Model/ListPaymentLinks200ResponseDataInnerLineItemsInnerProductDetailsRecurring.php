<?php
/**
 * ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetailsRecurring
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetailsRecurring Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetailsRecurring implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listPaymentLinks_200_response_data_inner_line_items_inner_product_details_recurring';
    ...
    */
    ...
    public function setIntervalCount($interval_count)
    {
        ...
        if (($interval_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $interval_count when calling ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetailsRecurring., must be bigger than or equal to 1.');
        }
