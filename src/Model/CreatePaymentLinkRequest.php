...
class CreatePaymentLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createPaymentLink_request';
    ...
    protected static $openAPITypes = [
        'product_ids' => 'string[]',
        'line_items' => '\RevKeen\Model\CreatePaymentLinkRequestLineItemsInner[]',
        'name' => 'string',
        'slug' => 'string',
        'mode' => 'string',
        'amount_minor' => 'int',
    ...
    */
     ...
     * Gets line_items
     *
     * @return \RevKeen\Model\CreatePaymentLinkRequestLineItemsInner[]|null
     */
     ...
     * Sets line_items
     *
     * @param \RevKeen\Model\CreatePaymentLinkRequestLineItemsInner[]|null $line_items line_items
     *
     * @return self
     */
    ...
    public function setAmountMinor($amount_minor)
    {
        ...
        if (($amount_minor < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount_minor when calling CreatePaymentLinkRequest., must be bigger than or equal to 0.');
        }
