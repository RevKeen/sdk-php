...
/**
 * SubscriptionReactivateResponse Class Doc Comment
 *
 * @category Class
 * @description The subscription after being reactivated from a canceled state, with updated billing schedule.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SubscriptionReactivateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionReactivateResponse';
