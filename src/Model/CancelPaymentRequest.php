 ...
 *
 * @category Class
 * @description Parameters for voiding a payment before settlement. Include a reason for your records.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CancelPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets reason
     *
     * @param string|null $reason Reason for cancellation/void
     *
     * @return self
     */
    public function setReason($reason)
    {
        ...
        if ((mb_strlen($reason) > 500)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling CancelPaymentRequest., must be smaller than or equal to 500.');
        }
