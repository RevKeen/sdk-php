 ...
 *
 * @category Class
 * @description A void cancels an unsettled payment before gateway settlement. Voids are always for the full amount — use a refund for settled payments.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Void implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Void';
    ...
    protected static $attributeMap = [
        ...
        'order_id' => 'order_id',
        'gateway' => 'gateway',
        'gateway_void_id' => 'gateway_void_id',
    ...
    protected static $setters = [
        ...
        'order_id' => 'setOrderId',
        'gateway' => 'setGateway',
        'gateway_void_id' => 'setGatewayVoidId',
    ...
    protected static $getters = [
        ...
        'order_id' => 'getOrderId',
        'gateway' => 'getGateway',
        'gateway_void_id' => 'getGatewayVoidId',
    ...
    public const REASON_CODE_ERROR = 'error';
    ...
    public function getReasonCodeAllowableValues()
    {
        return [
            ...
            self::REASON_CODE_DUPLICATE,
            self::REASON_CODE_FRAUDULENT,
            self::REASON_CODE_ERROR,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('gateway_void_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['gateway_void_id'] === null && !$this->isNullableSetToNull('gateway_void_id')) {
            $invalidProperties[] = "'gateway_void_id' can't be null";
        }
     ...
     * Sets payment_id
     *
     * @param string $payment_id The original payment ID this void is for (alias for parent_transaction_id)
     *
     * @return self
     */
     ...
     *
     * @param string $parent_transaction_id Parent transaction ID in unified transaction model.
     *
     * @return self
     */
     ...
     * Sets gateway
     *
     * @param string $gateway Name of the payment processor that handled this void
     *
     * @return self
     */
    ...
    /**
     * Gets gateway_void_id
     *
     * @return string|null
     */
    public function getGatewayVoidId()
    {
        return $this->container['gateway_void_id'];
    }

    /**
     * Sets gateway_void_id
     *
     * @param string|null $gateway_void_id gateway_void_id
     *
     * @return self
     */
    public function setGatewayVoidId($gateway_void_id)
    {
        if (is_null($gateway_void_id)) {
            array_push($this->openAPINullablesSetToNull, 'gateway_void_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('gateway_void_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['gateway_void_id'] = $gateway_void_id;
     ...
     * Sets amount_minor
     *
     * @param float $amount_minor Void amount in cents (always full amount of original transaction)
     *
     * @return self
     */
