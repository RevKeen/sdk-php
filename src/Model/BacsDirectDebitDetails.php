...
class BacsDirectDebitDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sort_code'] === null && !$this->isNullableSetToNull('sort_code')) {
        ...
        if ($this->container['mandate_ref'] === null && !$this->isNullableSetToNull('mandate_ref')) {
     ...
     * Sets sort_code
     *
     * @param string|null $sort_code Masked sort code — never the full value
     *
     * @return self
     */
     ...
     * Sets mandate_id
     *
     * @param string $mandate_id The Direct Debit mandate backing this payment method
     *
     * @return self
     */
     ...
     * Sets mandate_ref
     *
     * @param string|null $mandate_ref RevKeen mandate reference (RK-XXXXXX)
     *
     * @return self
     */
