...
/**
 * MandateListResponse Class Doc Comment
 *
 * @category Class
 * @description A list of Direct Debit mandates.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MandateListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MandateListResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\RevKeen\Model\MandateListItem[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\MandateListItem[]
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\MandateListItem[] $data data
     *
     * @return self
     */
