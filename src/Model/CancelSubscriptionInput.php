...
/**
 * CancelSubscriptionInput Class Doc Comment
 *
 * @category Class
 * @description Parameters for canceling a subscription, including whether to cancel immediately or at period end.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CancelSubscriptionInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancelSubscriptionInput';
    ...
    public const MODE_IMMEDIATELY = 'immediately';
    ...
    {
        return [
            self::MODE_IMMEDIATELY,
            self::MODE_PERIOD_END,
        ];
    }
    ...
    */
     ...
     * Sets mode
     *
     * @param string $mode Cancel mode: \"immediately\" revokes access now, \"period_end\" schedules cancellation at billing period end
     *
     * @return self
     */
