...
/**
 * PreviewCollectionResponse Class Doc Comment
 *
 * @category Class
 * @description Backend-owned Direct Debit collection date chain (notice/submission/collection/settlement).
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PreviewCollectionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PreviewCollectionResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['collection_date'] === null) {
        ...
        if ($this->container['ineligible_reason'] === null && !$this->isNullableSetToNull('ineligible_reason')) {
            $invalidProperties[] = "'ineligible_reason' can't be null";
        }
        if ($this->container['notice_days'] === null) {
     ...
     * Sets notice_date
     *
     * @param string $notice_date Advance-notice date (YYYY-MM-DD)
     *
     * @return self
     */
     ...
     *
     * @param string $submission_date Bacs submission date (YYYY-MM-DD)
     *
     * @return self
     */
     ...
     *
     * @param string $collection_date Collection date (YYYY-MM-DD)
     *
     * @return self
     */
     ...
     *
     * @param string $settlement_date Settlement date (YYYY-MM-DD)
     *
     * @return self
     */
     ...
     * Sets eligible
     *
     * @param bool $eligible Whether the requested collection is eligible
     *
     * @return self
     */
     ...
     *
     * @param string|null $ineligible_reason Reason the collection is ineligible, if applicable
     *
     * @return self
     */
     ...
     * Sets notice_days
     *
     * @param int $notice_days Advance-notice days applied
     *
     * @return self
     */
    public function setNoticeDays($notice_days)
    {
        if (is_null($notice_days)) {
            throw new \InvalidArgumentException('non-nullable notice_days cannot be null');
        }
