...
/**
 * TerminalPaymentResponse Class Doc Comment
 *
 * @category Class
 * @description A single terminal payment object with full device and transaction details.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TerminalPaymentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TerminalPaymentResponse';
