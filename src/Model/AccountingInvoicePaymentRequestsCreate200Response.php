...
/**
 * AccountingInvoicePaymentRequestsCreate200Response Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class AccountingInvoicePaymentRequestsCreate200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'accounting_invoice_payment_requests_create_200_response';
    ...
    protected static $openAPITypes = [
        'data' => '\RevKeen\Model\AccountingInvoicePaymentRequest',
        'request_id' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\AccountingInvoicePaymentRequest
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\AccountingInvoicePaymentRequest $data data
     *
     * @return self
     */
