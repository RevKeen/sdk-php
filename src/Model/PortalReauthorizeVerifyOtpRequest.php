...
/**
 * PortalReauthorizeVerifyOtpRequest Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class PortalReauthorizeVerifyOtpRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortalReauthorizeVerifyOtpRequest';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PortalReauthorizeVerifyOtpRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($code) < 4)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PortalReauthorizeVerifyOtpRequest., must be bigger than or equal to 4.');
        }
