...
/**
 * SubscriptionCancelSubscriptionResponse Class Doc Comment
 *
 * @category Class
 * @description The subscription after being canceled with the specified cancellation parameters.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SubscriptionCancelSubscriptionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionCancelSubscriptionResponse';
