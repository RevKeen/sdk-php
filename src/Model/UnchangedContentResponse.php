...
/**
 * UnchangedContentResponse Class Doc Comment
 *
 * @category Class
 * @description Returned when an external upsert is skipped because the substantive content hash matched the stored row — no DB write performed.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UnchangedContentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnchangedContentResponse';
    ...
    public const REASON_UNCHANGED_CONTENT = 'unchanged_content';
    ...
    */
     ...
     * Sets content_hash
     *
     * @param string $content_hash content_hash
     *
     * @return self
     */
