...
/**
 * SubscriptionChangePlanResponse Class Doc Comment
 *
 * @category Class
 * @description The subscription after a plan change, with proration details and updated billing schedule.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SubscriptionChangePlanResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionChangePlanResponse';
    ...
    */
     ...
     *
     * @param string|null $previous_plan_id previous_plan_id
     *
     * @return self
     */
