...
/**
 * AvsCodeInterpretation Class Doc Comment
 *
 * @category Class
 * @description AVS verification result
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AvsCodeInterpretation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AvsCodeInterpretation';
    ...
    public const MATCH_TYPE_FULL_MATCH = 'full_match';
    public const MATCH_TYPE_PARTIAL_MATCH = 'partial_match';
    public const MATCH_TYPE_NO_MATCH = 'no_match';
    public const MATCH_TYPE_NOT_SUPPORTED = 'not_supported';
    public const MATCH_TYPE_NOT_AVAILABLE = 'not_available';
    public const MATCH_TYPE_ERROR = 'error';
    public const RISK_LEVEL_LOW = 'low';
    public const RISK_LEVEL_MEDIUM = 'medium';
    public const RISK_LEVEL_HIGH = 'high';
    public const RISK_LEVEL_UNKNOWN = 'unknown';
    ...
    {
        return [
            self::MATCH_TYPE_FULL_MATCH,
            self::MATCH_TYPE_PARTIAL_MATCH,
            self::MATCH_TYPE_NO_MATCH,
            self::MATCH_TYPE_NOT_SUPPORTED,
            self::MATCH_TYPE_NOT_AVAILABLE,
            self::MATCH_TYPE_ERROR,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('zip_match', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['address_match'] === null && !$this->isNullableSetToNull('address_match')) {
            $invalidProperties[] = "'address_match' can't be null";
        }
        if ($this->container['zip_match'] === null && !$this->isNullableSetToNull('zip_match')) {
            $invalidProperties[] = "'zip_match' can't be null";
        }
     ...
     * Sets code
     *
     * @param string $code Raw AVS response code from gateway
     *
     * @return self
     */
     ...
     * Sets match_type
     *
     * @param string $match_type Type of address match
     *
     * @return self
     */
     ...
     * Sets address_match
     *
     * @param bool|null $address_match Whether the street address matched
     *
     * @return self
     */
    public function setAddressMatch($address_match)
    {
        if (is_null($address_match)) {
            array_push($this->openAPINullablesSetToNull, 'address_match');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('address_match', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets zip_match
     *
     * @param bool|null $zip_match Whether the ZIP/postal code matched
     *
     * @return self
     */
    public function setZipMatch($zip_match)
    {
        if (is_null($zip_match)) {
            array_push($this->openAPINullablesSetToNull, 'zip_match');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('zip_match', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets description
     *
     * @param string $description Human-readable description of the AVS result
     *
     * @return self
     */
     ...
     * Sets risk_level
     *
     * @param string $risk_level Risk level based on AVS result. low: full match, medium: partial match, high: no match
     *
     * @return self
     */
