...
/**
 * FulfillOrderRequest Class Doc Comment
 *
 * @category Class
 * @description Parameters for marking an order as fulfilled, with optional tracking and shipping details.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FulfillOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FulfillOrderRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('notify_customer', $data ?? [], true);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['carrier']) && (mb_strlen($this->container['carrier']) > 50)) {
            $invalidProperties[] = "invalid value for 'carrier', the character length must be smaller than or equal to 50.";
        }
     ...
     *
     * @param string|null $tracking_number Shipping tracking number
     *
     * @return self
     */
    public function setTrackingNumber($tracking_number)
    {
        ...
        if ((mb_strlen($tracking_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling FulfillOrderRequest., must be smaller than or equal to 100.');
        }
     ...
     * Sets carrier
     *
     * @param string|null $carrier Shipping carrier (e.g., 'ups', 'fedex', 'usps')
     *
     * @return self
     */
    public function setCarrier($carrier)
    {
        ...
        if ((mb_strlen($carrier) > 50)) {
            throw new \InvalidArgumentException('invalid length for $carrier when calling FulfillOrderRequest., must be smaller than or equal to 50.');
        }
     ...
     * Sets line_item_ids
     *
     * @param string[]|null $line_item_ids Specific line items to fulfill (defaults to all)
     *
     * @return self
     */
     ...
     *
     * @param bool|null $notify_customer Send fulfillment notification to customer
     *
     * @return self
     */
