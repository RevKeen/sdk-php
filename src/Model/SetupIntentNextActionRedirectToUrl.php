...
/**
 * SetupIntentNextActionRedirectToUrl Class Doc Comment
 *
 * @category Class
 ...
 */
class SetupIntentNextActionRedirectToUrl implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetupIntentNextAction_redirect_to_url';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url The URL to redirect the customer to
     *
     * @return self
     */
     ...
     * Sets return_url
     *
     * @param string $return_url The URL to redirect back to after completion
     *
     * @return self
     */
