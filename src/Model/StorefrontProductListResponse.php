...
/**
 * StorefrontProductListResponse Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class StorefrontProductListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StorefrontProductListResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\RevKeen\Model\StorefrontProduct[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\StorefrontProduct[]
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\StorefrontProduct[] $data data
     *
     * @return self
     */
