...
/**
 * RetryEligibilityResponse Class Doc Comment
 *
 * @category Class
 * @description Assessment of whether a failed payment attempt is eligible for retry, including recommended retry strategy.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RetryEligibilityResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RetryEligibilityResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\RevKeen\Model\RetryEligibilityResponseData'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\RetryEligibilityResponseData
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\RetryEligibilityResponseData $data data
     *
     * @return self
     */
