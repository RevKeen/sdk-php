...
/**
 * UpdateSetupIntentRequest Class Doc Comment
 *
 * @category Class
 * @description Parameters for updating a setup intent before confirmation.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateSetupIntentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSetupIntentRequest';
    ...
    */
     ...
     * Sets customer_id
     *
     * @param string|null $customer_id ID of the customer to attach the payment method to
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $payment_method_types Allowed payment method types
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,mixed>|null $metadata Custom metadata to attach
     *
     * @return self
     */
