...
/**
 * ApplyCartDiscountCodeInput Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class ApplyCartDiscountCodeInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplyCartDiscountCodeInput';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code Discount code to apply. Pass `null` to clear. Today the code is stored only — pricing math is not applied; convert blocks with `CART_SESSION_DISCOUNT_PENDING` until the code is cleared or the pricing slice lands.
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if (!is_null($code) && (mb_strlen($code) > 64)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ApplyCartDiscountCodeInput., must be smaller than or equal to 64.');
        }
        if (!is_null($code) && (mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ApplyCartDiscountCodeInput., must be bigger than or equal to 1.');
        }
