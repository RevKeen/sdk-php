...
/**
 * CreateAccountingInvoicePaymentRequestInputExternalInvoice Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class CreateAccountingInvoicePaymentRequestInputExternalInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAccountingInvoicePaymentRequestInput_external_invoice';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling CreateAccountingInvoicePaymentRequestInputExternalInvoice., must be bigger than or equal to 1.');
        }
