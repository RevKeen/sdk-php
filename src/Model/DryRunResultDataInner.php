...
/**
 * DryRunResultDataInner Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class DryRunResultDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DryRunResult_data_inner';
    ...
    protected static $openAPITypes = [
        'index' => 'float',
        'status' => 'string',
        'validation_details' => '\RevKeen\Model\DryRunResultDataInnerValidationDetails',
        'reason' => 'string'
    ];
    ...
    public const STATUS_WOULD_INGEST = 'would_ingest';
    public const STATUS_WOULD_SKIP = 'would_skip';
    public const STATUS_WOULD_FAIL = 'would_fail';
    ...
    {
        return [
            self::STATUS_WOULD_INGEST,
            self::STATUS_WOULD_SKIP,
            self::STATUS_WOULD_FAIL,
        ];
    }
    ...
    */
     ...
     *
     * @return \RevKeen\Model\DryRunResultDataInnerValidationDetails
     */
     ...
     *
     * @param \RevKeen\Model\DryRunResultDataInnerValidationDetails $validation_details validation_details
     *
     * @return self
     */
