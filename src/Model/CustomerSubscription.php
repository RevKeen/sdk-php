...
/**
 * CustomerSubscription Class Doc Comment
 *
 * @category Class
 * @description A subscription belonging to a specific customer, with plan and status details.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomerSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerSubscription';
