...
/**
 * CustomersCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class CustomersCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customers_create_request';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email Customer's email address (must be unique per merchant)
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,mixed>|null $metadata Arbitrary key-value metadata to attach to this customer
     *
     * @return self
     */
