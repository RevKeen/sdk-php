...
/**
 * PortalMandate Class Doc Comment
 *
 * @category Class
 * @description A customer-facing Direct Debit mandate projection. Bank details are masked — only the last 4 digits of the account number are exposed.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PortalMandate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortalMandate';
    ...
    public const OBJECT_MANDATE = 'mandate';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['next_collection_date'] === null && !$this->isNullableSetToNull('next_collection_date')) {
            $invalidProperties[] = "'next_collection_date' can't be null";
        }
     ...
     *
     * @param string|null $account_number_last4 account_number_last4
     *
     * @return self
     */
     ...
     *
     * @param string|null $next_collection_date next_collection_date
     *
     * @return self
     */
