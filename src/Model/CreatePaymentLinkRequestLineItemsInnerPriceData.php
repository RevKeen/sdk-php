...
/**
 * CreatePaymentLinkRequestLineItemsInnerPriceData Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class CreatePaymentLinkRequestLineItemsInnerPriceData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createPaymentLink_request_line_items_inner_price_data';
    ...
    protected static $openAPITypes = [
        'currency' => 'string',
        'unit_amount' => 'int',
        'product_data' => '\RevKeen\Model\CreatePaymentLinkRequestLineItemsInnerPriceDataProductData',
        'product' => 'string',
        'recurring' => '\RevKeen\Model\ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetailsRecurring',
        'tax_behavior' => 'string'
    ];
    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreatePaymentLinkRequestLineItemsInnerPriceData., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreatePaymentLinkRequestLineItemsInnerPriceData., must be bigger than or equal to 3.');
        }
    ...
    public function setUnitAmount($unit_amount)
    {
        ...
        if (($unit_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_amount when calling CreatePaymentLinkRequestLineItemsInnerPriceData., must be bigger than or equal to 0.');
        }
     ...
     * Gets product_data
     *
     * @return \RevKeen\Model\CreatePaymentLinkRequestLineItemsInnerPriceDataProductData|null
     */
     ...
     * Sets product_data
     *
     * @param \RevKeen\Model\CreatePaymentLinkRequestLineItemsInnerPriceDataProductData|null $product_data product_data
     *
     * @return self
     */
     ...
     * Gets recurring
     *
     * @return \RevKeen\Model\ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetailsRecurring|null
     */
     ...
     * Sets recurring
     *
     * @param \RevKeen\Model\ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetailsRecurring|null $recurring recurring
     *
     * @return self
     */
