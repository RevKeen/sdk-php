...
/**
 * ProductsExternalBatchRequestProductsInner Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class ProductsExternalBatchRequestProductsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'products_externalBatch_request_products_inner';
    ...
    */
     ...
     * Sets external_id
     *
     * @param string $external_id External system's product ID
     *
     * @return self
     */
    public function setExternalId($external_id)
    {
        ...
        if ((mb_strlen($external_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling ProductsExternalBatchRequestProductsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductsExternalBatchRequestProductsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setAmountCents($amount_cents)
    {
        ...
        if (($amount_cents < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount_cents when calling ProductsExternalBatchRequestProductsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ProductsExternalBatchRequestProductsInner., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ProductsExternalBatchRequestProductsInner., must be bigger than or equal to 3.');
        }
    ...
    public function setIntervalCount($interval_count)
    {
        ...
        if (($interval_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $interval_count when calling ProductsExternalBatchRequestProductsInner., must be bigger than or equal to 1.');
        }
