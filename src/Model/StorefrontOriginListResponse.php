...
/**
 * StorefrontOriginListResponse Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class StorefrontOriginListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StorefrontOriginListResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\RevKeen\Model\StorefrontOrigin[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\StorefrontOrigin[]
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\StorefrontOrigin[] $data data
     *
     * @return self
     */
