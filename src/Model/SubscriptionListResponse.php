...
/**
 * SubscriptionListResponse Class Doc Comment
 *
 * @category Class
 * @description A paginated list of subscriptions matching the query filters.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class SubscriptionListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionListResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\RevKeen\Model\SubscriptionCreateResponseData[]',
        'pagination' => '\RevKeen\Model\SubscriptionListResponsePagination'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\SubscriptionCreateResponseData[] $data data
     *
     * @return self
     */
     ...
     * Gets pagination
     *
     * @return \RevKeen\Model\SubscriptionListResponsePagination
     */
     ...
     * Sets pagination
     *
     * @param \RevKeen\Model\SubscriptionListResponsePagination $pagination pagination
     *
     * @return self
     */
