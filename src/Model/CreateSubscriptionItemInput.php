...
/**
 * CreateSubscriptionItemInput Class Doc Comment
 *
 * @category Class
 * @description Parameters for adding a new line item to an existing subscription.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreateSubscriptionItemInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSubscriptionItemInput';
    ...
    */
     ...
     * Sets product_id
     *
     * @param string|null $product_id Product UUID to link to this item
     *
     * @return self
     */
     ...
     * Sets price_id
     *
     * @param string|null $price_id Price UUID to link to this item
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateSubscriptionItemInput., must be smaller than or equal to 500.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreateSubscriptionItemInput., must be bigger than or equal to 1.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateSubscriptionItemInput., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateSubscriptionItemInput., must be bigger than or equal to 3.');
        }
     ...
     *
     * @param int $unit_amount_minor Unit price in cents
     *
     * @return self
     */
    public function setUnitAmountMinor($unit_amount_minor)
    {
        ...
        if (($unit_amount_minor < 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_amount_minor when calling CreateSubscriptionItemInput., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $fulfillment_type Determines if orders are created on renewal
     *
     * @return self
     */
