...
/**
 * SubscriptionItemDeleteResponse Class Doc Comment
 *
 * @category Class
 * @description Confirmation that the subscription line item was removed.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SubscriptionItemDeleteResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionItemDeleteResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['deleted_id'] === null) {
            $invalidProperties[] = "'deleted_id' can't be null";
        }
     ...
     * Sets deleted_id
     *
     * @param string $deleted_id deleted_id
     *
     * @return self
     */
