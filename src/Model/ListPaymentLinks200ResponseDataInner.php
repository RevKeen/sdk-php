...
/**
 * ListPaymentLinks200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class ListPaymentLinks200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listPaymentLinks_200_response_data_inner';
    ...
    protected static $openAPITypes = [
        ...
        'product_ids' => 'string[]',
        'line_items' => '\RevKeen\Model\ListPaymentLinks200ResponseDataInnerLineItemsInner[]',
        'success_url' => 'string',
        'cancel_url' => 'string',
        'redirect_url' => 'string',
    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ListPaymentLinks200ResponseDataInner., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ListPaymentLinks200ResponseDataInner., must be bigger than or equal to 3.');
        }
     ...
     * Gets line_items
     *
     * @return \RevKeen\Model\ListPaymentLinks200ResponseDataInnerLineItemsInner[]|null
     */
     ...
     * Sets line_items
     *
     * @param \RevKeen\Model\ListPaymentLinks200ResponseDataInnerLineItemsInner[]|null $line_items line_items
     *
     * @return self
     */
