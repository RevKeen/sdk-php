...
/**
 * UpdateSubscriptionScheduleRequest Class Doc Comment
 *
 * @category Class
 * @description Parameters for updating a subscription schedule&#39;s phases before they take effect.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateSubscriptionScheduleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSubscriptionScheduleRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['phases']) && (count($this->container['phases']) < 1)) {
     ...
     * Gets phases
     *
     * @return \RevKeen\Model\SchedulePhase[]|null
     */
     ...
     * Sets phases
     *
     * @param \RevKeen\Model\SchedulePhase[]|null $phases Replace all phases
     *
     * @return self
     */
    public function setPhases($phases)
    {
        ...
        if ((count($phases) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phases when calling UpdateSubscriptionScheduleRequest., number of items must be greater than or equal to 1.');
        }
     ...
     *
     * @param string|null $proration_behavior Proration behavior when updating phases
     *
     * @return self
     */
