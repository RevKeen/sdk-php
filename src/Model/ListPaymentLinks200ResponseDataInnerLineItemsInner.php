...
/**
 * ListPaymentLinks200ResponseDataInnerLineItemsInner Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class ListPaymentLinks200ResponseDataInnerLineItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listPaymentLinks_200_response_data_inner_line_items_inner';
    ...
    protected static $openAPITypes = [
        ...
        'is_adhoc' => 'bool',
        'product_details' => '\RevKeen\Model\ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails'
    ];
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ListPaymentLinks200ResponseDataInnerLineItemsInner., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \RevKeen\Model\ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails|null
     */
     ...
     *
     * @param \RevKeen\Model\ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails|null $product_details product_details
     *
     * @return self
     */
