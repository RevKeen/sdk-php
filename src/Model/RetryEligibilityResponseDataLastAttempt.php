...
/**
 * RetryEligibilityResponseDataLastAttempt Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class RetryEligibilityResponseDataLastAttempt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RetryEligibilityResponse_data_last_attempt';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['gateway_order_id'] === null) {
            $invalidProperties[] = "'gateway_order_id' can't be null";
        }
        if ($this->container['gateway_transaction_id'] === null) {
        ...
        if ($this->container['billing_run_id'] === null) {
        ...
        if ($this->container['avs_code'] === null) {
            $invalidProperties[] = "'avs_code' can't be null";
        }
        if ($this->container['cvv_code'] === null) {
            $invalidProperties[] = "'cvv_code' can't be null";
        }
        ...
        if ($this->container['payment_method_last4'] === null) {
            $invalidProperties[] = "'payment_method_last4' can't be null";
        }
        if ($this->container['payment_method_brand'] === null) {
        ...
        if ($this->container['max_retry_attempts'] === null) {
            $invalidProperties[] = "'max_retry_attempts' can't be null";
        }
        if ($this->container['next_retry_at'] === null) {
     ...
     * Sets public_id
     *
     * @param string $public_id External reference ID (payatt_xxx format). Used as order_id in gateway requests.
     *
     * @return self
     */
     ...
     *
     * @param string $gateway_order_id The exact order_id sent to the gateway (NMI). Format: payatt_<public_id>. Primary correlation key for webhook mapping.
     *
     * @return self
     */
     ...
     *
     * @param string $gateway_transaction_id Transaction ID returned by the gateway (NMI's transaction reference).
     *
     * @return self
     */
     ...
     * Sets transaction_id
     *
     * @param string $transaction_id Legacy transaction reference (deprecated - use gateway_transaction_id)
     *
     * @return self
     */
     ...
     * Sets payment_id
     *
     * @param string $payment_id Logical payment (PaymentIntent) this attempt belongs to
     *
     * @return self
     */
     ...
     * Sets invoice_id
     *
     * @param string $invoice_id Associated invoice ID
     *
     * @return self
     */
     ...
     *
     * @param string $subscription_id Associated subscription ID
     *
     * @return self
     */
     ...
     *
     * @param string $checkout_session_id Associated checkout session ID
     *
     * @return self
     */
     ...
     * Sets billing_run_id
     *
     * @param string $billing_run_id Billing run ID for batch reconciliation
     *
     * @return self
     */
    public function setBillingRunId($billing_run_id)
    {
        if (is_null($billing_run_id)) {
            throw new \InvalidArgumentException('non-nullable billing_run_id cannot be null');
        }
     ...
     * Sets gateway
     *
     * @param string $gateway Payment gateway (e.g., 'nmi', 'stripe')
     *
     * @return self
     */
     ...
     * Sets gateway_code
     *
     * @param string $gateway_code Raw gateway response code
     *
     * @return self
     */
     ...
     *
     * @param string $gateway_message Raw gateway response message
     *
     * @return self
     */
     ...
     * Sets avs_code
     *
     * @param string $avs_code Address Verification System response code
     *
     * @return self
     */
     ...
     * Sets cvv_code
     *
     * @param string $cvv_code CVV verification response code
     *
     * @return self
     */
     ...
     * Sets issuer_code
     *
     * @param string $issuer_code Issuer-specific response code
     *
     * @return self
     */
     ...
     * Sets amount_cents
     *
     * @param int $amount_cents Payment amount in cents
     *
     * @return self
     */
     ...
     *
     * @param string $payment_method_last4 Last 4 digits of card
     *
     * @return self
     */
    public function setPaymentMethodLast4($payment_method_last4)
    {
        if (is_null($payment_method_last4)) {
            throw new \InvalidArgumentException('non-nullable payment_method_last4 cannot be null');
        }
     ...
     *
     * @param string $payment_method_brand Card brand (visa, mastercard, etc.)
     *
     * @return self
     */
     ...
     *
     * @param int $max_retry_attempts Maximum retry attempts allowed
     *
     * @return self
     */
    public function setMaxRetryAttempts($max_retry_attempts)
    {
        if (is_null($max_retry_attempts)) {
            throw new \InvalidArgumentException('non-nullable max_retry_attempts cannot be null');
        }
     ...
     * Sets next_retry_at
     *
     * @param \DateTime $next_retry_at Next scheduled retry timestamp
     *
     * @return self
     */
