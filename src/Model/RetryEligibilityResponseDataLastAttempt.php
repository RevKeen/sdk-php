...
class RetryEligibilityResponseDataLastAttempt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $gateway_order_id Order ID sent to the processor. Format: payatt_<public_id>. Primary correlation key for webhook mapping.
     *
     * @return self
     */
     ...
     *
     * @param string $gateway_transaction_id Processor-assigned transaction reference.
     *
     * @return self
     */
