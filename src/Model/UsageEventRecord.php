...
/**
 * UsageEventRecord Class Doc Comment
 *
 * @category Class
 * @description A persisted usage event record.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UsageEventRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UsageEventRecord';
    ...
    protected static $setters = [
        ...
        'ingestion_timestamp' => 'setIngestionTimestamp',
    ...
    protected static $getters = [
        ...
        'ingestion_timestamp' => 'getIngestionTimestamp',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ingestion_timestamp', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['meter_id'] === null && !$this->isNullableSetToNull('meter_id')) {
        ...
        if ($this->container['idempotency_key'] === null && !$this->isNullableSetToNull('idempotency_key')) {
        ...
        if ($this->container['ingestion_timestamp'] === null && !$this->isNullableSetToNull('ingestion_timestamp')) {
            $invalidProperties[] = "'ingestion_timestamp' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id Usage event ID
     *
     * @return self
     */
     ...
     * Sets merchant_id
     *
     * @param string $merchant_id Owning merchant ID
     *
     * @return self
     */
     ...
     * Sets meter_id
     *
     * @param string|null $meter_id Meter ID
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float $quantity Event quantity
     *
     * @return self
     */
     ...
     * Sets event_time
     *
     * @param \DateTime $event_time Event timestamp (ISO 8601)
     *
     * @return self
     */
     ...
     *
     * @param string|null $idempotency_key Deduplication key
     *
     * @return self
     */
     ...
     * Sets external_id
     *
     * @param string|null $external_id External event identifier
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string $source Ingestion source
     *
     * @return self
     */
     ...
     * Sets properties
     *
     * @param array<string,mixed> $properties Arbitrary event properties used for filtering/aggregation
     *
     * @return self
     */
    ...
    /**
     * Gets ingestion_timestamp
     *
     * @return \DateTime|null
     */
    public function getIngestionTimestamp()
    {
        return $this->container['ingestion_timestamp'];
    }

    /**
     * Sets ingestion_timestamp
     *
     * @param \DateTime|null $ingestion_timestamp When the event was ingested (ISO 8601)
     *
     * @return self
     */
    public function setIngestionTimestamp($ingestion_timestamp)
    {
        if (is_null($ingestion_timestamp)) {
            array_push($this->openAPINullablesSetToNull, 'ingestion_timestamp');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ingestion_timestamp', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['ingestion_timestamp'] = $ingestion_timestamp;
