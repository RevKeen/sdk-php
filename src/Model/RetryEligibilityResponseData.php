...
/**
 * RetryEligibilityResponseData Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class RetryEligibilityResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RetryEligibilityResponse_data';
    ...
    protected static $openAPITypes = [
        'should_retry' => 'bool',
        'reason' => 'string',
        'last_attempt' => '\RevKeen\Model\RetryEligibilityResponseDataLastAttempt'
    ];
    ...
    {
        $this->setIfExists('should_retry', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['should_retry'] === null) {
            $invalidProperties[] = "'should_retry' can't be null";
        }
    ...
    {
        return $this->container['should_retry'];
    }

    /**
     * Sets should_retry
     *
     * @param bool $should_retry Whether the subscription should be retried
     *
     * @return self
     */
    public function setShouldRetry($should_retry)
    {
        if (is_null($should_retry)) {
            throw new \InvalidArgumentException('non-nullable should_retry cannot be null');
        }
        $this->container['should_retry'] = $should_retry;
     ...
     * Sets reason
     *
     * @param string $reason Explanation for the retry decision
     *
     * @return self
     */
     ...
     * Gets last_attempt
     *
     * @return \RevKeen\Model\RetryEligibilityResponseDataLastAttempt
     */
     ...
     * Sets last_attempt
     *
     * @param \RevKeen\Model\RetryEligibilityResponseDataLastAttempt $last_attempt last_attempt
     *
     * @return self
     */
