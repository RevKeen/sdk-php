...
/**
 * RefundCreateResponse Class Doc Comment
 *
 * @category Class
 * @description The newly created refund object, including the gateway response details.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RefundCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RefundCreateResponse';
    ...
    */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\Refund $data data
     *
     * @return self
     */
