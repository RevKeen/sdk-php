...
/**
 * ProductsExternalUpsert200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class ProductsExternalUpsert200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'products_externalUpsert_200_response_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('external_system', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['external_system'] === null && !$this->isNullableSetToNull('external_system')) {
            $invalidProperties[] = "'external_system' can't be null";
        }
        if ($this->container['external_ref'] === null && !$this->isNullableSetToNull('external_ref')) {
     ...
     *
     * @param string|null $external_system external_system
     *
     * @return self
     */
    public function setExternalSystem($external_system)
    {
        if (is_null($external_system)) {
            array_push($this->openAPINullablesSetToNull, 'external_system');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('external_system', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets interval_count
     *
     * @param float|null $interval_count interval_count
     *
     * @return self
     */
