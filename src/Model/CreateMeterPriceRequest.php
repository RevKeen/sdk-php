 ...
 *
 * @category Class
 * @description Parameters for creating a price attached to a usage meter, defining per-unit cost, tiered tiers, or a percentage rate.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CreateMeterPriceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'nickname' => 'string',
        'description' => 'string',
        'tiers' => '\RevKeen\Model\MeterPriceTierInput[]',
        'filter_conditions' => 'array<string,mixed>[]',
        'filter_priority' => 'int',
        'pay_in_advance' => 'bool',
        'spending_minimum_cents' => 'int',
        'percentage_rate_bps' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'pay_in_advance' => null,
        'spending_minimum_cents' => null,
        'percentage_rate_bps' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'spending_minimum_cents' => false,
        'percentage_rate_bps' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'spending_minimum_cents' => 'spending_minimum_cents',
        'percentage_rate_bps' => 'percentage_rate_bps'
    ];
    ...
    protected static $setters = [
        ...
        'filter_priority' => 'setFilterPriority',
        'pay_in_advance' => 'setPayInAdvance',
        'spending_minimum_cents' => 'setSpendingMinimumCents',
        'percentage_rate_bps' => 'setPercentageRateBps'
    ];
    ...
    protected static $getters = [
        ...
        'filter_priority' => 'getFilterPriority',
        'pay_in_advance' => 'getPayInAdvance',
        'spending_minimum_cents' => 'getSpendingMinimumCents',
        'percentage_rate_bps' => 'getPercentageRateBps'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('filter_priority', $data ?? [], null);
        $this->setIfExists('pay_in_advance', $data ?? [], null);
        $this->setIfExists('spending_minimum_cents', $data ?? [], null);
        $this->setIfExists('percentage_rate_bps', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['spending_minimum_cents']) && ($this->container['spending_minimum_cents'] < 0)) {
            $invalidProperties[] = "invalid value for 'spending_minimum_cents', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['percentage_rate_bps']) && ($this->container['percentage_rate_bps'] > 10000)) {
            $invalidProperties[] = "invalid value for 'percentage_rate_bps', must be smaller than or equal to 10000.";
        }

        if (!is_null($this->container['percentage_rate_bps']) && ($this->container['percentage_rate_bps'] < 0)) {
            $invalidProperties[] = "invalid value for 'percentage_rate_bps', must be bigger than or equal to 0.";
        }
     ...
     * Sets pricing_model
     *
     * @param string $pricing_model Pricing model. 'percentage' charges a basis-points percentage of the metered amount (REV-3465); other models charge per unit, graduated tiers, volume tiers, or packages.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string $currency ISO 4217 currency code. A usage-based subscription has one currency; metered events attributed to it are assumed to be in this currency and are not FX-converted by RevKeen.
     *
     * @return self
     */
     ...
     *
     * @param int|null $unit_amount_minor Price per unit in minor units (for per_unit). For a sub-penny rate use `unit_amount_decimal`.
     *
     * @return self
     */
     ...
     *
     * @param string|null $unit_amount_decimal Exact per-unit rate in minor units as a decimal string (sub-penny safe, e.g. \"0.02\" = 0.02 pence). Takes precedence over `unit_amount_minor`. Mirrors Stripe's `unit_amount_decimal`.
     *
     * @return self
     */
    public function setUnitAmountDecimal($unit_amount_decimal)
    {
        if (is_null($unit_amount_decimal)) {
            throw new \InvalidArgumentException('non-nullable unit_amount_decimal cannot be null');
        }
     ...
     * Sets name
     *
     * @param string|null $name Customer-facing price name
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateMeterPriceRequest., must be smaller than or equal to 100.');
        }
     ...
     * Sets nickname
     *
     * @param string|null $nickname Internal price nickname
     *
     * @return self
     */
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) > 100)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling CreateMeterPriceRequest., must be smaller than or equal to 100.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Description of this price option
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateMeterPriceRequest., must be smaller than or equal to 500.');
        }
     ...
     * Gets tiers
     *
     * @return \RevKeen\Model\MeterPriceTierInput[]|null
     */
     ...
     * Sets tiers
     *
     * @param \RevKeen\Model\MeterPriceTierInput[]|null $tiers Tier configuration (for graduated and volume)
     *
     * @return self
     */
     ...
     *
     * @param array<string,mixed>[]|null $filter_conditions Optional event property predicates for dimensional pricing. Empty or omitted = base/fallthrough price.
     *
     * @return self
     */
    ...
    /**
     * Gets filter_priority
     *
     * @return int|null
     */
    public function getFilterPriority()
    {
        return $this->container['filter_priority'];
    }

    /**
     * Sets filter_priority
     *
     * @param int|null $filter_priority Tie-breaker when multiple matching filters have the same specificity.
     *
     * @return self
     */
    public function setFilterPriority($filter_priority)
    {
        if (is_null($filter_priority)) {
            throw new \InvalidArgumentException('non-nullable filter_priority cannot be null');
        }
        $this->container['filter_priority'] = $filter_priority;
     ...
     * Sets pay_in_advance
     *
     * @param bool|null $pay_in_advance When true, matching usage events debit the customer's prepaid wallet at ingest time.
     *
     * @return self
     */
    ...
    /**
     * Gets spending_minimum_cents
     *
     * @return int|null
     */
    public function getSpendingMinimumCents()
    {
        return $this->container['spending_minimum_cents'];
    }

    /**
     * Sets spending_minimum_cents
     *
     * @param int|null $spending_minimum_cents Minimum minor-unit amount applied to each pay-in-advance usage drawdown.
     *
     * @return self
     */
    public function setSpendingMinimumCents($spending_minimum_cents)
    {
        if (is_null($spending_minimum_cents)) {
            throw new \InvalidArgumentException('non-nullable spending_minimum_cents cannot be null');
        }

        if (($spending_minimum_cents < 0)) {
            throw new \InvalidArgumentException('invalid value for $spending_minimum_cents when calling CreateMeterPriceRequest., must be bigger than or equal to 0.');
        }

        $this->container['spending_minimum_cents'] = $spending_minimum_cents;

        return $this;
    }

    /**
     * Gets percentage_rate_bps
     *
     * @return int|null
     */
    public function getPercentageRateBps()
    {
        return $this->container['percentage_rate_bps'];
    }

    /**
     * Sets percentage_rate_bps
     *
     * @param int|null $percentage_rate_bps Rate in basis points. 70 = 0.7%. Required when pricing_model='percentage'. Range 0–10000 (0%–100%).
     *
     * @return self
     */
    public function setPercentageRateBps($percentage_rate_bps)
    {
        if (is_null($percentage_rate_bps)) {
            throw new \InvalidArgumentException('non-nullable percentage_rate_bps cannot be null');
        }

        if (($percentage_rate_bps > 10000)) {
            throw new \InvalidArgumentException('invalid value for $percentage_rate_bps when calling CreateMeterPriceRequest., must be smaller than or equal to 10000.');
        }
        if (($percentage_rate_bps < 0)) {
            throw new \InvalidArgumentException('invalid value for $percentage_rate_bps when calling CreateMeterPriceRequest., must be bigger than or equal to 0.');
        }

        $this->container['percentage_rate_bps'] = $percentage_rate_bps;
