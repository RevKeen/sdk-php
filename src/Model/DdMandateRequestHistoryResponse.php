<?php
/**
 * DdMandateRequestHistoryResponse
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * DdMandateRequestHistoryResponse Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class DdMandateRequestHistoryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DdMandateRequestHistoryResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\RevKeen\Model\DdMandateRequestLifecycleItem[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\DdMandateRequestLifecycleItem[]
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\DdMandateRequestLifecycleItem[] $data data
     *
     * @return self
     */
