...
class OpenDispute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('dispute_kind', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_rail'] === null && !$this->isNullableSetToNull('payment_rail')) {
            $invalidProperties[] = "'payment_rail' can't be null";
        }
        if ($this->container['dispute_kind'] === null && !$this->isNullableSetToNull('dispute_kind')) {
            $invalidProperties[] = "'dispute_kind' can't be null";
        }
     ...
     * Sets payment_rail
     *
     * @param string|null $payment_rail Rail/payment method for the disputed transaction
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getDisputeKind()
    {
        return $this->container['dispute_kind'];
    }

    /**
     * Sets dispute_kind
     *
     * @param string|null $dispute_kind Rail-specific dispute subtype, when available
     *
     * @return self
     */
    public function setDisputeKind($dispute_kind)
    {
        if (is_null($dispute_kind)) {
            array_push($this->openAPINullablesSetToNull, 'dispute_kind');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dispute_kind', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['dispute_kind'] = $dispute_kind;
