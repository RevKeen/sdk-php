<?php
/**
 * AnalyticsCollectionsGetDso200Response
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * AnalyticsCollectionsGetDso200Response Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class AnalyticsCollectionsGetDso200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'analytics_collections_getDso_200_response';
    ...
    {
        $this->setIfExists('dso', $data ?? [], null);
        $this->setIfExists('trend', $data ?? [], null);
        $this->setIfExists('previous_dso', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dso'] === null) {
            $invalidProperties[] = "'dso' can't be null";
        }
        ...
        if (!is_null($this->container['trend']) && !in_array($this->container['trend'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'trend', must be one of '%s'",
                $this->container['trend'],
     ...
     * @return self
     */
    public function setDso($dso)
    {
        if (is_null($dso)) {
            throw new \InvalidArgumentException('non-nullable dso cannot be null');
        }
        $this->container['dso'] = $dso;
    ...
    {
        if (is_null($trend)) {
            throw new \InvalidArgumentException('non-nullable trend cannot be null');
        }
        $allowedValues = $this->getTrendAllowableValues();
        if (!in_array($trend, $allowedValues, true)) {
     ...
     * @return float|null
     */
    public function getPreviousDso()
    {
        return $this->container['previous_dso'];
    }

    /**
     * Sets previous_dso
     *
     * @param float|null $previous_dso previous_dso
     *
     * @return self
     */
    public function setPreviousDso($previous_dso)
    {
        if (is_null($previous_dso)) {
            throw new \InvalidArgumentException('non-nullable previous_dso cannot be null');
        }
        $this->container['previous_dso'] = $previous_dso;
