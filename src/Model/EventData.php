 ...
 *
 * @category Class
 * @description Event data containing the affected object
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class EventData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets object
     *
     * @param mixed|null $object object
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $previous_attributes previous_attributes
     *
     * @return self
     */
    public function setPreviousAttributes($previous_attributes)
    {
        if (is_null($previous_attributes)) {
            array_push($this->openAPINullablesSetToNull, 'previous_attributes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('previous_attributes', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
