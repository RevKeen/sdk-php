<?php
/**
 * CreateAccountingInvoicePaymentRequestInputCheckout
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CreateAccountingInvoicePaymentRequestInputCheckout Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class CreateAccountingInvoicePaymentRequestInputCheckout implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAccountingInvoicePaymentRequestInput_checkout';
    ...
    */
     ...
     *
     * @param string[]|null $allowed_methods allowed_methods
     *
     * @return self
     */
