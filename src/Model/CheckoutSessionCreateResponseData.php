...
/**
 * CheckoutSessionCreateResponseData Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class CheckoutSessionCreateResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckoutSessionCreateResponse_data';
    ...
    */
     ...
     * Sets amount_minor
     *
     * @param float|null $amount_minor amount_minor
     *
     * @return self
     */
