...
/**
 * ScheduleCollectionResponse Class Doc Comment
 *
 * @category Class
 * @description Result of scheduling a one-off Direct Debit collection.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ScheduleCollectionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduleCollectionResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\RevKeen\Model\CollectionSchedule'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\CollectionSchedule
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\CollectionSchedule $data data
     *
     * @return self
     */
