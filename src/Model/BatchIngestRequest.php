...
/**
 * BatchIngestRequest Class Doc Comment
 *
 * @category Class
 * @description A batch of usage events to ingest, supporting up to 1000 events per request.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BatchIngestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchIngestRequest';
    ...
    */
    ...
    public function setEvents($events)
    {
        ...
        if ((count($events) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $events when calling BatchIngestRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($events) < 1)) {
            throw new \InvalidArgumentException('invalid length for $events when calling BatchIngestRequest., number of items must be greater than or equal to 1.');
        }
