...
/**
 * InvoiceCommentListDetailResponse Class Doc Comment
 *
 * @category Class
 * @description A list of invoice comments with extended author details.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InvoiceCommentListDetailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceCommentListDetailResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\RevKeen\Model\InvoiceCommentDetail[]',
        'request_id' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\InvoiceCommentDetail[]
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\InvoiceCommentDetail[] $data data
     *
     * @return self
     */
