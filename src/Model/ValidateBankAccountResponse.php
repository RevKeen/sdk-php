...
/**
 * ValidateBankAccountResponse Class Doc Comment
 *
 * @category Class
 * @description Result of a Direct Debit bank-account validation check.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ValidateBankAccountResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ValidateBankAccountResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('dd_enabled', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dd_enabled'] === null) {
            $invalidProperties[] = "'dd_enabled' can't be null";
        }
     ...
     * Sets valid
     *
     * @param bool $valid Whether the account details passed modulus/sort-code validation
     *
     * @return self
     */
     ...
     * Sets bank_name
     *
     * @param string|null $bank_name Resolved bank name, if known
     *
     * @return self
     */
     ...
     * @return bool
     */
    public function getDdEnabled()
    {
        return $this->container['dd_enabled'];
    }

    /**
     * Sets dd_enabled
     *
     * @param bool $dd_enabled Whether the account accepts Direct Debit instructions
     *
     * @return self
     */
    public function setDdEnabled($dd_enabled)
    {
        if (is_null($dd_enabled)) {
            throw new \InvalidArgumentException('non-nullable dd_enabled cannot be null');
        }
        $this->container['dd_enabled'] = $dd_enabled;
     ...
     * Sets errors
     *
     * @param string[]|null $errors Validation error messages, if any
     *
     * @return self
     */
