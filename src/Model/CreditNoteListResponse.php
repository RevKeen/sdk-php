...
/**
 * CreditNoteListResponse Class Doc Comment
 *
 * @category Class
 * @description A list of credit notes matching the query filters.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreditNoteListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditNoteListResponse';
    ...
    */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\CreditNote[] $data data
     *
     * @return self
     */
