 ...
 *
 * @category Class
 * @description A payment transaction belonging to a specific customer, with amount, status, and gateway details.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CustomerPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_method_type'] === null && !$this->isNullableSetToNull('payment_method_type')) {
