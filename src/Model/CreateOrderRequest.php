 ...
 *
 * @category Class
 * @description Parameters for creating a new order with line items and customer association.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CreateOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'currency' => 'string',
        'billing_type' => 'string',
        'line_items' => '\RevKeen\Model\CreateOrderRequestLineItemsInner[]',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('billing_type', $data ?? [], 'one_time');
    ...
    */
     ...
     * Sets customer_id
     *
     * @param string|null $customer_id Customer ID (optional for guest orders)
     *
     * @return self
     */
     ...
     * Sets billing_type
     *
     * @param string|null $billing_type Billing type. one_time: Single purchase. recurring: Subscription-based.
     *
     * @return self
     */
     ...
     * Gets line_items
     *
     * @return \RevKeen\Model\CreateOrderRequestLineItemsInner[]
     */
     ...
     * Sets line_items
     *
     * @param \RevKeen\Model\CreateOrderRequestLineItemsInner[] $line_items Order line items (at least one required)
     *
     * @return self
     */
    public function setLineItems($line_items)
    {
        ...
        if ((count($line_items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $line_items when calling CreateOrderRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setNotes($notes)
    {
        ...
        if ((mb_strlen($notes) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling CreateOrderRequest., must be smaller than or equal to 1000.');
        }
     ...
     * Sets expires_at
     *
     * @param \DateTime|null $expires_at Expiration timestamp for the order
     *
     * @return self
     */
