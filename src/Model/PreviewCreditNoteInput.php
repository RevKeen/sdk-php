...
/**
 * PreviewCreditNoteInput Class Doc Comment
 *
 * @category Class
 * @description Parameters to preview a credit note without persisting it. The response shows what the credit note would look like if created with these fields.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PreviewCreditNoteInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PreviewCreditNoteInput';
    ...
    */
     ...
     * Sets invoice_id
     *
     * @param string $invoice_id Invoice to preview a credit note against.
     *
     * @return self
     */
     ...
     * Sets amount_minor
     *
     * @param int $amount_minor Proposed credit amount in cents. The preview validates that this does not exceed the invoice's outstanding creditable amount.
     *
     * @return self
     */
    public function setAmountMinor($amount_minor)
    {
        ...
        if (($amount_minor < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount_minor when calling PreviewCreditNoteInput., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param int|null $tax_amount_minor Proposed tax portion of the credit in cents.
     *
     * @return self
     */
    public function setTaxAmountMinor($tax_amount_minor)
    {
        ...
        if (($tax_amount_minor < 0)) {
            throw new \InvalidArgumentException('invalid value for $tax_amount_minor when calling PreviewCreditNoteInput., must be bigger than or equal to 0.');
        }
     ...
     * Sets credit_method
     *
     * @param string|null $credit_method Planned credit method. Defaults to refund_to_payment_method.
     *
     * @return self
     */
