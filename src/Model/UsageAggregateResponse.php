...
/**
 * UsageAggregateResponse Class Doc Comment
 *
 * @category Class
 * @description Aggregated usage totals grouped by meter and time period.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UsageAggregateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UsageAggregateResponse';
    ...
    public const OBJECT_USAGE_AGGREGATE = 'usage_aggregate';
    ...
    */
     ...
     * Sets value
     *
     * @param float $value Aggregated usage value
     *
     * @return self
     */
     ...
     * Sets event_count
     *
     * @param float $event_count Number of events in range
     *
     * @return self
     */
