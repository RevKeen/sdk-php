 ...
 *
 * @category Class
 * @description A line item within an order, representing a product, quantity, and unit price.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class OrderLineItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling OrderLineItem., must be bigger than or equal to 1.');
        }
     ...
     * Sets subtotal
     *
     * @param int $subtotal Subtotal in cents (unit_price * quantity)
     *
     * @return self
     */
     ...
     * Sets discount
     *
     * @param int|null $discount Discount in cents
     *
     * @return self
     */
     ...
     * Sets tax
     *
     * @param int|null $tax Tax in cents
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int $total Total in cents (subtotal - discount + tax)
     *
     * @return self
     */
