 ...
 *
 * @category Class
 * @description A PaymentIntent tracks the lifecycle of a payment from creation through authorization, optional 3DS authentication, and final capture.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class PaymentIntent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'customer' => 'string',
        'description' => 'string',
        'last_payment_error' => '\RevKeen\Model\PaymentIntentLastPaymentError',
        'metadata' => 'array<string,mixed>',
        'next_action' => '\RevKeen\Model\PaymentIntentNextAction',
    ...
    public const CANCELLATION_REASON_FAILED_INVOICE = 'failed_invoice';
    ...
    public function getCancellationReasonAllowableValues()
    {
        return [
            ...
            self::CANCELLATION_REASON_FAILED_INVOICE,
        ];
    }
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Public payment intent ID (pi_xxx)
     *
     * @return self
     */
     ...
     *
     * @param int $amount_capturable Amount that can be captured (for manual capture)
     *
     * @return self
     */
     ...
     *
     * @param int $amount_received Amount actually received
     *
     * @return self
     */
     ...
     *
     * @return \RevKeen\Model\PaymentIntentLastPaymentError|null
     */
     ...
     *
     * @param \RevKeen\Model\PaymentIntentLastPaymentError|null $last_payment_error last_payment_error
     *
     * @return self
     */
     ...
     * Gets next_action
     *
     * @return \RevKeen\Model\PaymentIntentNextAction|null
     */
     ...
     * Sets next_action
     *
     * @param \RevKeen\Model\PaymentIntentNextAction|null $next_action next_action
     *
     * @return self
     */
     ...
     * Sets receipt_email
     *
     * @param string|null $receipt_email Email for receipt
     *
     * @return self
     */
    ...
    public function setStatementDescriptorSuffix($statement_descriptor_suffix)
    {
        if (is_null($statement_descriptor_suffix)) {
            array_push($this->openAPINullablesSetToNull, 'statement_descriptor_suffix');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('statement_descriptor_suffix', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets status
     *
     * @param string $status Payment intent status. requires_payment_method: Needs payment method. requires_confirmation: Ready to confirm. requires_action: Requires customer action (3DS). processing: Being processed. succeeded: Payment complete. canceled: Canceled.
     *
     * @return self
     */
     ...
     * Sets capture_method
     *
     * @param string $capture_method Capture method. automatic: Capture immediately on confirmation. manual: Authorize then capture separately.
     *
     * @return self
     */
     ...
     * Sets canceled_at
     *
     * @param \DateTime|null $canceled_at When the intent was canceled
     *
     * @return self
     */
     ...
     *
     * @param string|null $cancellation_reason Why the intent was canceled
     *
     * @return self
     */
