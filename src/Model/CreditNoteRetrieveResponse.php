...
/**
 * CreditNoteRetrieveResponse Class Doc Comment
 *
 * @category Class
 * @description A single credit note with full details including the associated invoice and refund.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreditNoteRetrieveResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditNoteRetrieveResponse';
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\CreditNote
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\CreditNote $data A credit note formally reduces the amount owed on an invoice. It is the accounting counterpart of a refund — the credit note is the document, the refund is the money movement.
     *
     * @return self
     */
