 ...
 */
class BillingDetailsAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingDetails_address';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['line1'] === null && !$this->isNullableSetToNull('line1')) {
            $invalidProperties[] = "'line1' can't be null";
        }
        if ($this->container['line2'] === null && !$this->isNullableSetToNull('line2')) {
