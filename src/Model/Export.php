 ...
 *
 * @category Class
 * @description An async data export job. Create an export, poll for completion, then download the file via the presigned URL.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Export implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique export job ID
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Export job status. pending: queued. processing: generating file. completed: ready for download. failed: export failed.
     *
     * @return self
     */
     ...
     * Sets format
     *
     * @param string $format Output file format. csv: Comma-separated values. xlsx: Excel workbook.
     *
     * @return self
     */
     ...
     * Sets download_url
     *
     * @param string|null $download_url Presigned download URL (available when status is 'completed'). Expires after 1 hour.
     *
     * @return self
     */
     ...
     * Sets total_rows
     *
     * @param int|null $total_rows Total rows exported (available when completed)
     *
     * @return self
     */
     ...
     *
     * @param int|null $file_size_bytes File size in bytes (available when completed)
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at When the export was requested (ISO 8601)
     *
     * @return self
     */
     ...
     * Sets completed_at
     *
     * @param \DateTime|null $completed_at When the export completed (ISO 8601)
     *
     * @return self
     */
