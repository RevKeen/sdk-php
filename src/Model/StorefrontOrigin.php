...
/**
 * StorefrontOrigin Class Doc Comment
 *
 * @category Class
 * @description A registered storefront origin allowed for publishable-key browser calls.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class StorefrontOrigin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StorefrontOrigin';
    ...
    public const OBJECT_STOREFRONT_ORIGIN = 'storefront_origin';
