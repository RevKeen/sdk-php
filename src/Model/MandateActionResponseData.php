...
/**
 * MandateActionResponseData Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class MandateActionResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MandateActionResponse_data';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status Resulting mandate status
     *
     * @return self
     */
     ...
     *
     * @param string|null $mandate_reference Mandate reference (reinstate)
     *
     * @return self
     */
