...
/**
 * CreditNoteEligibilityResponsePaymentsInner Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class CreditNoteEligibilityResponsePaymentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditNoteEligibilityResponse_payments_inner';
    ...
    protected static $openAPITypes = [
        ...
        'amount_minor' => 'float',
        'amount_refunded_minor' => 'float',
        'amount_available_minor' => 'float',
        'card_brand' => 'string',
        'card_last4' => 'string',
        'terminal_serial' => 'string',
        'available_operations' => 'string[]',
        'constraints' => '\RevKeen\Model\CreditNoteEligibilityResponsePaymentsInnerConstraints'
    ];
    ...
    protected static $attributeMap = [
        ...
        'amount_available_minor' => 'amount_available_minor',
    ...
    protected static $setters = [
        ...
        'amount_available_minor' => 'setAmountAvailableMinor',
    ...
    protected static $getters = [
        ...
        'amount_available_minor' => 'getAmountAvailableMinor',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('amount_available_minor', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['amount_available_minor'] === null) {
            $invalidProperties[] = "'amount_available_minor' can't be null";
        }
     ...
     * Sets amount_minor
     *
     * @param float $amount_minor amount_minor
     *
     * @return self
     */
     ...
     *
     * @param float $amount_refunded_minor amount_refunded_minor
     *
     * @return self
     */
    ...
    /**
     * Gets amount_available_minor
     *
     * @return float
     */
    public function getAmountAvailableMinor()
    {
        return $this->container['amount_available_minor'];
    }

    /**
     * Sets amount_available_minor
     *
     * @param float $amount_available_minor amount_available_minor
     *
     * @return self
     */
    public function setAmountAvailableMinor($amount_available_minor)
    {
        if (is_null($amount_available_minor)) {
            throw new \InvalidArgumentException('non-nullable amount_available_minor cannot be null');
        }
        $this->container['amount_available_minor'] = $amount_available_minor;
     ...
     * Gets constraints
     *
     * @return \RevKeen\Model\CreditNoteEligibilityResponsePaymentsInnerConstraints
     */
     ...
     * Sets constraints
     *
     * @param \RevKeen\Model\CreditNoteEligibilityResponsePaymentsInnerConstraints $constraints constraints
     *
     * @return self
     */
