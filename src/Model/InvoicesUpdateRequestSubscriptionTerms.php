...
/**
 * InvoicesUpdateRequestSubscriptionTerms Class Doc Comment
 *
 * @category Class
 ...
 */
class InvoicesUpdateRequestSubscriptionTerms implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoices_update_request_subscription_terms';
    ...
    */
    ...
    public function setDurationCount($duration_count)
    {
        ...
        if (($duration_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $duration_count when calling InvoicesUpdateRequestSubscriptionTerms., must be bigger than or equal to 1.');
        }
