...
/**
 * PaymentSecurityResponse Class Doc Comment
 *
 * @category Class
 * @description Response containing the security verification results (AVS/CVV) for a specific payment attempt.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentSecurityResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentSecurityResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\RevKeen\Model\PaymentSecurityResult'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\PaymentSecurityResult
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\PaymentSecurityResult $data data
     *
     * @return self
     */
