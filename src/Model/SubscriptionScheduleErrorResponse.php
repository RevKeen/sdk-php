...
/**
 * SubscriptionScheduleErrorResponse Class Doc Comment
 *
 * @category Class
 * @description Error response returned when a subscription schedule operation fails.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SubscriptionScheduleErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionScheduleErrorResponse';
    ...
    protected static $openAPITypes = [
        'error' => '\RevKeen\Model\EventErrorResponseError'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \RevKeen\Model\EventErrorResponseError
     */
     ...
     * Sets error
     *
     * @param \RevKeen\Model\EventErrorResponseError $error error
     *
     * @return self
     */
