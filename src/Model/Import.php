 ...
 *
 * @category Class
 * @description An async data import job. Upload a CSV file to create records in bulk. Poll GET /v2/imports/:id for status and error details.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Import implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'success_count' => 'int',
        'error_count' => 'int',
        'errors' => '\RevKeen\Model\ImportErrorsInner[]',
        'created_at' => '\DateTime',
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique import job ID
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Import job status. pending: queued. validating: checking data. processing: creating records. completed: all rows imported. completed_with_errors: some rows failed. failed: import aborted.
     *
     * @return self
     */
     ...
     * Sets total_rows
     *
     * @param int|null $total_rows Total rows in the uploaded file
     *
     * @return self
     */
     ...
     * Sets processed_rows
     *
     * @param int|null $processed_rows Number of rows processed so far
     *
     * @return self
     */
     ...
     * Sets success_count
     *
     * @param int|null $success_count Number of rows successfully imported
     *
     * @return self
     */
     ...
     * Sets error_count
     *
     * @param int|null $error_count Number of rows that failed
     *
     * @return self
     */
     ...
     * Gets errors
     *
     * @return \RevKeen\Model\ImportErrorsInner[]|null
     */
     ...
     * Sets errors
     *
     * @param \RevKeen\Model\ImportErrorsInner[]|null $errors Detailed error information for failed rows
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at When the import was created (ISO 8601)
     *
     * @return self
     */
     ...
     * Sets completed_at
     *
     * @param \DateTime|null $completed_at When the import completed (ISO 8601)
     *
     * @return self
     */
