...
/**
 * CvvCodeInterpretation Class Doc Comment
 *
 * @category Class
 ...
 */
class CvvCodeInterpretation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CvvCodeInterpretation';
    ...
    public const MATCH_TYPE_MATCH = 'match';
    public const MATCH_TYPE_NO_MATCH = 'no_match';
    public const MATCH_TYPE_NOT_PROCESSED = 'not_processed';
    public const MATCH_TYPE_NOT_PROVIDED = 'not_provided';
    public const MATCH_TYPE_ISSUER_NOT_CERTIFIED = 'issuer_not_certified';
    ...
    {
        return [
            self::MATCH_TYPE_MATCH,
            self::MATCH_TYPE_NO_MATCH,
            self::MATCH_TYPE_NOT_PROCESSED,
            self::MATCH_TYPE_NOT_PROVIDED,
            self::MATCH_TYPE_ISSUER_NOT_CERTIFIED,
    ...
    */
     ...
     * Sets code
     *
     * @param string $code Raw CVV response code from gateway
     *
     * @return self
     */
     ...
     * Sets match_type
     *
     * @param string $match_type Type of CVV match
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description Human-readable description of the CVV result
     *
     * @return self
     */
     ...
     * Sets risk_level
     *
     * @param string $risk_level Risk level based on CVV result. low: match, medium: not processed, high: no match
     *
     * @return self
     */
