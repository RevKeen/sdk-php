...
/**
 * MandateRequestLookupResponseData Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class MandateRequestLookupResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MandateRequestLookupResponse_data';
    ...
    protected static $openAPITypes = [
        ...
        'expires_at' => 'string',
        'status' => 'string',
        'merchant' => '\RevKeen\Model\MandateRequestLookupResponseDataMerchant',
        'customer' => '\RevKeen\Model\MandateRequestLookupResponseDataCustomer',
        'invoice' => '\RevKeen\Model\MandateRequestLookupResponseDataInvoice'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('merchant_slug', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['merchant_slug'] === null) {
            $invalidProperties[] = "'merchant_slug' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id Mandate request ID
     *
     * @return self
     */
    ...
    {
        return $this->container['merchant_slug'];
    }
    ...
    {
        if (is_null($merchant_slug)) {
            throw new \InvalidArgumentException('non-nullable merchant_slug cannot be null');
        }
        $this->container['merchant_slug'] = $merchant_slug;
     ...
     * Sets invoice_id
     *
     * @param string|null $invoice_id Invoice ID, if the request is tied to an invoice
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param string|null $expires_at Expiry timestamp (ISO 8601)
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Mandate request status
     *
     * @return self
     */
     ...
     * Gets merchant
     *
     * @return \RevKeen\Model\MandateRequestLookupResponseDataMerchant
     */
     ...
     * Sets merchant
     *
     * @param \RevKeen\Model\MandateRequestLookupResponseDataMerchant $merchant merchant
     *
     * @return self
     */
     ...
     * Gets customer
     *
     * @return \RevKeen\Model\MandateRequestLookupResponseDataCustomer
     */
     ...
     * Sets customer
     *
     * @param \RevKeen\Model\MandateRequestLookupResponseDataCustomer $customer customer
     *
     * @return self
     */
     ...
     * Gets invoice
     *
     * @return \RevKeen\Model\MandateRequestLookupResponseDataInvoice
     */
     ...
     * Sets invoice
     *
     * @param \RevKeen\Model\MandateRequestLookupResponseDataInvoice $invoice invoice
     *
     * @return self
     */
