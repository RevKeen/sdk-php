 ...
 *
 * @category Class
 * @description Parameters for creating a subscription schedule with one or more phases of pricing and billing changes.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CreateSubscriptionScheduleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'customer' => 'string',
        'subscription' => 'string',
        'start_date' => '\RevKeen\Model\CreateSubscriptionScheduleRequestStartDate',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('end_behavior', $data ?? [], 'cancel');
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['phases']) < 1)) {
            $invalidProperties[] = "invalid value for 'phases', number of items must be greater than or equal to 1.";
        }
     ...
     * Sets customer
     *
     * @param string|null $customer Customer ID (required if no subscription)
     *
     * @return self
     */
     ...
     * Sets subscription
     *
     * @param string|null $subscription Existing subscription to attach schedule to
     *
     * @return self
     */
     ...
     * Gets start_date
     *
     * @return \RevKeen\Model\CreateSubscriptionScheduleRequestStartDate|null
     */
     ...
     * Sets start_date
     *
     * @param \RevKeen\Model\CreateSubscriptionScheduleRequestStartDate|null $start_date start_date
     *
     * @return self
     */
     ...
     * Sets phases
     *
     * @param \RevKeen\Model\SchedulePhase[] $phases Phases defining the schedule (at least one required)
     *
     * @return self
     */
    public function setPhases($phases)
    {
        ...
        if ((count($phases) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phases when calling CreateSubscriptionScheduleRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets end_behavior
     *
     * @param string|null $end_behavior What happens when all phases complete
     *
     * @return self
     */
