...
/**
 * SubscriptionTerms Class Doc Comment
 *
 * @category Class
 ...
 */
class SubscriptionTerms implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionTerms';
    ...
    */
    ...
    public function setDurationCount($duration_count)
    {
        ...
        if (($duration_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $duration_count when calling SubscriptionTerms., must be bigger than or equal to 1.');
        }
