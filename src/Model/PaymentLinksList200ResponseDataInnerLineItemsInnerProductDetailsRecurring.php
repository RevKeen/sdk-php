<?php
/**
 * PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetailsRecurring
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetailsRecurring Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetailsRecurring implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'payment_links_list_200_response_data_inner_line_items_inner_product_details_recurring';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('interval_count', $data ?? [], 1);
    }
    ...
    */
    ...
    public function setIntervalCount($interval_count)
    {
        ...
        if (($interval_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $interval_count when calling PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetailsRecurring., must be bigger than or equal to 1.');
        }
