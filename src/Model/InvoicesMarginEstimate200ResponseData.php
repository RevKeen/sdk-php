...
/**
 * InvoicesMarginEstimate200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class InvoicesMarginEstimate200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoices_margin_estimate_200_response_data';
    ...
    protected static $openAPITypes = [
        ...
        'amount_minor' => 'int',
        'currency' => 'string',
        'estimates' => '\RevKeen\Model\InvoicesMarginEstimate200ResponseDataEstimatesInner[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['estimates'] === null) {
            $invalidProperties[] = "'estimates' can't be null";
        }
     ...
     * Gets estimates
     *
     * @return \RevKeen\Model\InvoicesMarginEstimate200ResponseDataEstimatesInner[]
     */
     ...
     * Sets estimates
     *
     * @param \RevKeen\Model\InvoicesMarginEstimate200ResponseDataEstimatesInner[] $estimates estimates
     *
     * @return self
     */
