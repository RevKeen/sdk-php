...
/**
 * CancelPaymentIntentRequest Class Doc Comment
 *
 * @category Class
 * @description Parameters for canceling a payment intent that has not yet been captured.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CancelPaymentIntentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancelPaymentIntentRequest';
    ...
    */
     ...
     *
     * @param string|null $cancellation_reason Reason for cancellation
     *
     * @return self
     */
