...
/**
 * UpdatePaymentLinkStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePaymentLinkStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updatePaymentLinkStatus_request';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status New status for the payment link
     *
     * @return self
     */
