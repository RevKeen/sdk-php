...
/**
 * CancelSetupIntentRequest Class Doc Comment
 *
 * @category Class
 * @description Parameters for canceling a setup intent that is no longer needed.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CancelSetupIntentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancelSetupIntentRequest';
