...
/**
 * UpdatePaymentIntentRequest Class Doc Comment
 *
 * @category Class
 * @description Parameters for updating a payment intent before confirmation. Only amount, description, payment method, and metadata can be changed.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdatePaymentIntentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePaymentIntentRequest';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling UpdatePaymentIntentRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling UpdatePaymentIntentRequest., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling UpdatePaymentIntentRequest., must be bigger than or equal to 3.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdatePaymentIntentRequest., must be smaller than or equal to 500.');
        }
    ...
    public function setStatementDescriptor($statement_descriptor)
    {
        ...
        if ((mb_strlen($statement_descriptor) > 22)) {
            throw new \InvalidArgumentException('invalid length for $statement_descriptor when calling UpdatePaymentIntentRequest., must be smaller than or equal to 22.');
        }
    ...
    public function setStatementDescriptorSuffix($statement_descriptor_suffix)
    {
        ...
        if ((mb_strlen($statement_descriptor_suffix) > 22)) {
            throw new \InvalidArgumentException('invalid length for $statement_descriptor_suffix when calling UpdatePaymentIntentRequest., must be smaller than or equal to 22.');
        }
