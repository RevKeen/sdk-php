...
/**
 * CreditNoteLineList Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class CreditNoteLineList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditNoteLineList';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data' => '\RevKeen\Model\CreditNoteLine[]',
        'has_more' => 'bool',
        'url' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\CreditNoteLine[]
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\CreditNoteLine[] $data data
     *
     * @return self
     */
