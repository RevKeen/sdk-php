...
/**
 * ProductsExternalBatchRequest Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class ProductsExternalBatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'products_externalBatch_request';
    ...
    protected static $openAPITypes = [
        'source' => 'string',
        'products' => '\RevKeen\Model\ProductsExternalBatchRequestProductsInner[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['products']) > 100)) {
            $invalidProperties[] = "invalid value for 'products', number of items must be less than or equal to 100.";
        }
     ...
     * Sets source
     *
     * @param string $source Integration source (e.g., practicehub, wodify)
     *
     * @return self
     */
    public function setSource($source)
    {
        ...
        if ((mb_strlen($source) < 1)) {
            throw new \InvalidArgumentException('invalid length for $source when calling ProductsExternalBatchRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets products
     *
     * @return \RevKeen\Model\ProductsExternalBatchRequestProductsInner[]
     */
     ...
     * Sets products
     *
     * @param \RevKeen\Model\ProductsExternalBatchRequestProductsInner[] $products Array of products to upsert (max 100)
     *
     * @return self
     */
    public function setProducts($products)
    {
        ...
        if ((count($products) > 100)) {
            throw new \InvalidArgumentException('invalid value for $products when calling ProductsExternalBatchRequest., number of items must be less than or equal to 100.');
        }
        if ((count($products) < 1)) {
            throw new \InvalidArgumentException('invalid length for $products when calling ProductsExternalBatchRequest., number of items must be greater than or equal to 1.');
        }
