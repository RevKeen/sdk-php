    ...
    */
    ...
    public function setStartRule($start_rule)
    {
        if (is_null($start_rule)) {
            throw new \InvalidArgumentException('non-nullable start_rule cannot be null');
        }
        $allowedValues = $this->getStartRuleAllowableValues();
        if (!in_array($start_rule, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'start_rule', must be one of '%s'",
                    $start_rule,
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreatePriceRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreatePriceRequest., must be smaller than or equal to 500.');
        }
     ...
     *
     * @param int|null $percentage_rate_bps Rate in basis points. 70 = 0.7%. Required when `billing_scheme` is `percentage`. Range 0–10000 (0%–100%).
     *
     * @return self
     */
    public function setPercentageRateBps($percentage_rate_bps)
    {
        ...
        if (($percentage_rate_bps > 10000)) {
            throw new \InvalidArgumentException('invalid value for $percentage_rate_bps when calling CreatePriceRequest., must be smaller than or equal to 10000.');
        }
        if (($percentage_rate_bps < 0)) {
            throw new \InvalidArgumentException('invalid value for $percentage_rate_bps when calling CreatePriceRequest., must be bigger than or equal to 0.');
        }
