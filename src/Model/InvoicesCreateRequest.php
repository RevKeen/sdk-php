...
class InvoicesCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoices_create_request';
    ...
    protected static $openAPITypes = [
        ...
        'subscription_terms' => '\RevKeen\Model\SubscriptionTerms',
    ...
    public const ALLOWED_METHODS_DIRECT_DEBIT = 'direct_debit';
    public const ALLOWED_METHODS_PAY_BY_BANK = 'pay_by_bank';
    ...
    public function getAllowedMethodsAllowableValues()
    {
        return [
            ...
            self::ALLOWED_METHODS_DIRECT_DEBIT,
            self::ALLOWED_METHODS_PAY_BY_BANK,
    ...
    */
     ...
     *
     * @return \RevKeen\Model\SubscriptionTerms|null
     */
     ...
     *
     * @param \RevKeen\Model\SubscriptionTerms|null $subscription_terms subscription_terms
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $allowed_methods Restrict checkout payment methods for this invoice. When set, narrows available rails for checkout sessions created against this invoice. Omit to use merchant default.
     *
     * @return self
     */
