...
/**
 * CreateTaxRateRequest Class Doc Comment
 *
 * @category Class
 * @description Parameters for creating a new tax rate with a percentage and jurisdiction details.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreateTaxRateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTaxRateRequest';
    ...
    public const TAX_TYPE_SALES_TAX = 'sales_tax';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tax_type', $data ?? [], 'vat');
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['jurisdiction']) && (mb_strlen($this->container['jurisdiction']) > 50)) {
            $invalidProperties[] = "invalid value for 'jurisdiction', the character length must be smaller than or equal to 50.";
        }
     ...
     * Sets display_name
     *
     * @param string $display_name Display name for the tax rate
     *
     * @return self
     */
    public function setDisplayName($display_name)
    {
        ...
        if ((mb_strlen($display_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling CreateTaxRateRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling CreateTaxRateRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Description of the tax rate
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateTaxRateRequest., must be smaller than or equal to 500.');
        }
     ...
     * Sets jurisdiction
     *
     * @param string|null $jurisdiction Tax jurisdiction (e.g., 'US-CA', 'DE', 'GB')
     *
     * @return self
     */
    public function setJurisdiction($jurisdiction)
    {
        ...
        if ((mb_strlen($jurisdiction) > 50)) {
            throw new \InvalidArgumentException('invalid length for $jurisdiction when calling CreateTaxRateRequest., must be smaller than or equal to 50.');
        }
     ...
     * Sets percentage
     *
     * @param float $percentage Tax percentage (e.g., 8.25 for 8.25%)
     *
     * @return self
     */
    public function setPercentage($percentage)
    {
        ...
        if (($percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling CreateTaxRateRequest., must be smaller than or equal to 100.');
        }
        if (($percentage < 0)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling CreateTaxRateRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets inclusive
     *
     * @param bool|null $inclusive Whether tax is included in displayed price
     *
     * @return self
     */
     ...
     * Sets tax_type
     *
     * @param string|null $tax_type Type of tax
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country ISO 2-letter country code
     *
     * @return self
     */
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling CreateTaxRateRequest., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling CreateTaxRateRequest., must be bigger than or equal to 2.');
        }
     ...
     * Sets state
     *
     * @param string|null $state State/province code
     *
     * @return self
     */
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) > 10)) {
            throw new \InvalidArgumentException('invalid length for $state when calling CreateTaxRateRequest., must be smaller than or equal to 10.');
        }
