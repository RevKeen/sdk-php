...
class CreateCreditNoteInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'invoice_id' => 'string',
        'amount_minor' => 'float',
        'tax_amount_minor' => 'float',
        'credit_method' => 'string',
        'reason' => 'string',
        'reason_code' => 'string',
        'cancel_subscription' => 'bool',
        'is_prorated' => 'bool',
        'proration_days_total' => 'float',
        'proration_days_unused' => 'float',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('customer_present', $data ?? [], false);
    }
    ...
    */
     ...
     * Sets amount_minor
     *
     * @param float $amount_minor Amount to credit in cents
     *
     * @return self
     */
     ...
     *
     * @param float|null $tax_amount_minor Tax portion of the credit in cents (for UK/EU VAT compliance)
     *
     * @return self
     */
     ...
     *
     * @param float|null $proration_days_total Total days in the billing period (for prorated credits)
     *
     * @return self
     */
     ...
     *
     * @param float|null $proration_days_unused Unused days in the billing period (for prorated credits)
     *
     * @return self
     */
     ...
     * Sets auto_route
     *
     * @param bool|null $auto_route When true, automatically trigger the process-credit-note task for multi-gateway reversal routing. Response will include gateway_operations array.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $customer_present For terminal (card-present) transactions: whether the customer is physically at the terminal. Defaults to false in API context.
     *
     * @return self
     */
