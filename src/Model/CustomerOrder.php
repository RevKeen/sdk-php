 ...
 *
 * @category Class
 * @description An order belonging to a specific customer, with line items and fulfillment status.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomerOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerOrder';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fulfilled_at'] === null && !$this->isNullableSetToNull('fulfilled_at')) {
            $invalidProperties[] = "'fulfilled_at' can't be null";
        }
     ...
     * Sets fulfilled_at
     *
     * @param string|null $fulfilled_at fulfilled_at
     *
     * @return self
     */
