<?php
/**
 * CreatePaymentLinkRequestLineItemsInnerPriceDataProductData
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CreatePaymentLinkRequestLineItemsInnerPriceDataProductData Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class CreatePaymentLinkRequestLineItemsInnerPriceDataProductData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createPaymentLink_request_line_items_inner_price_data_product_data';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreatePaymentLinkRequestLineItemsInnerPriceDataProductData., must be bigger than or equal to 1.');
        }
