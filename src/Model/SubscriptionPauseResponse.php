...
/**
 * SubscriptionPauseResponse Class Doc Comment
 *
 * @category Class
 * @description The subscription after being paused, showing the pause effective date and planned resume date.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SubscriptionPauseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionPauseResponse';
