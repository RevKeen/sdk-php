...
/**
 * CartCheckoutSession Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class CartCheckoutSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CartCheckoutSession';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['session_token'] === null && !$this->isNullableSetToNull('session_token')) {
