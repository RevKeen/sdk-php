...
/**
 * ScheduleCollectionRequest Class Doc Comment
 *
 * @category Class
 * @description Parameters for scheduling a one-off Direct Debit collection against an active mandate. BACS is not real-time: the collection settles 3–5 working days after submission and nothing is marked paid until the bureau confirms.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ScheduleCollectionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduleCollectionRequest';
    ...
    public const SOURCE_TYPE_PAYMENT_LINK = 'payment_link';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('requested_collection_date', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets currency
     *
     * @param string $currency ISO 4217 currency. Bacs collections are GBP-only.
     *
     * @return self
     */
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ScheduleCollectionRequest., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ScheduleCollectionRequest., must be bigger than or equal to 3.');
        }
     ...
     * Sets source_type
     *
     * @param string $source_type What the collection settles. The settlement webhook resolves invoices by this reference.
     *
     * @return self
     */
     ...
     * Sets source_id
     *
     * @param string $source_id Invoice or payment-link ID the collection is for
     *
     * @return self
     */
     ...
     *
     * @param string|null $requested_collection_date Earliest acceptable collection date (ISO date). The backend resolves the Bacs working-day chain; must be on/after the bureau's earliest allowed date.
     *
     * @return self
     */
    public function setRequestedCollectionDate($requested_collection_date)
    {
        if (is_null($requested_collection_date)) {
            throw new \InvalidArgumentException('non-nullable requested_collection_date cannot be null');
        }
