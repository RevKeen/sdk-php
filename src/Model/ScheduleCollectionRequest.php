 ...
 *
 * @category Class
 * @description Parameters for scheduling a one-off Direct Debit collection against an active mandate. L&amp;Z confirms the permitted collection date; nothing is marked paid until the bureau confirms the collection outcome.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
