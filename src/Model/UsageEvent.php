 ...
 *
 * @category Class
 * @description A single usage event representing customer consumption of a metered resource.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class UsageEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets customer_id
     *
     * @param string|null $customer_id RevKeen customer ID
     *
     * @return self
     */
     ...
     *
     * @param string|null $external_customer_id Your external customer identifier
     *
     * @return self
     */
     ...
     *
     * @param string|null $subscription_id Subscription ID to attribute usage to
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float|null $quantity Event quantity (default: 1)
     *
     * @return self
     */
     ...
     *
     * @param string|null $idempotency_key Unique key for deduplication
     *
     * @return self
     */
