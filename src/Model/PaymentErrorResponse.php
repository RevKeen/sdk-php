...
/**
 * PaymentErrorResponse Class Doc Comment
 *
 * @category Class
 * @description Error response returned when a payment operation fails.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentErrorResponse';
