 ...
 *
 * @category Class
 * @description A manually configured tax rate applied to invoices and charges. For automatic tax calculation, use the Quaderno integration instead.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class TaxRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier for the tax rate
     *
     * @return self
     */
     ...
     * Sets inclusive
     *
     * @param bool $inclusive Whether tax is included in displayed price (EU style)
     *
     * @return self
     */
     ...
     * Sets tax_type
     *
     * @param string $tax_type Type of tax
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool $active Whether the tax rate is active
     *
     * @return self
     */
