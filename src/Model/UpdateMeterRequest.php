...
/**
 * UpdateMeterRequest Class Doc Comment
 *
 * @category Class
 * @description Parameters for updating an existing meter. Only display name and metadata can be changed.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateMeterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateMeterRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('value_expression', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Updated meter name
     *
     * @return self
     */
     ...
     * Sets slug
     *
     * @param string|null $slug Updated slug
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Meter status
     *
     * @return self
     */
     ...
     * Sets value_key
     *
     * @param string|null $value_key Updated value key
     *
     * @return self
     */
     ...
     *
     * @param string|null $value_expression Updated constrained arithmetic expression over numeric event properties. null clears it.
     *
     * @return self
     */
    public function setValueExpression($value_expression)
    {
        if (is_null($value_expression)) {
            array_push($this->openAPINullablesSetToNull, 'value_expression');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('value_expression', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param array<string,mixed>[]|null $filter_conditions Updated filter conditions
     *
     * @return self
     */
     ...
     *
     * @param string|null $unique_count_key Updated unique count key
     *
     * @return self
     */
     ...
     * Sets unit_name
     *
     * @param string|null $unit_name Updated unit name
     *
     * @return self
     */
     ...
     * Sets carry_forward
     *
     * @param bool|null $carry_forward Updated carry forward setting
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,mixed>|null $metadata Updated metadata
     *
     * @return self
     */
     ...
     *
     * @param float[]|null $alert_thresholds Updated threshold percentages for usage.threshold.reached webhooks.
     *
     * @return self
     */
    public function setAlertThresholds($alert_thresholds)
    {
        ...
        if ((count($alert_thresholds) > 5)) {
            throw new \InvalidArgumentException('invalid value for $alert_thresholds when calling UpdateMeterRequest., number of items must be less than or equal to 5.');
        }
