...
/**
 * CreateVoidInput Class Doc Comment
 *
 * @category Class
 * @description Parameters for creating a void. Specify the transaction ID of the unsettled payment to cancel.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreateVoidInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateVoidInput';
    ...
    */
     ...
     * Sets payment_id
     *
     * @param string $payment_id The ID of the payment to void. Must be unsettled.
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string|null $reason Reason for the void
     *
     * @return self
     */
    public function setReason($reason)
    {
        ...
        if ((mb_strlen($reason) > 500)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling CreateVoidInput., must be smaller than or equal to 500.');
        }
     ...
     * Sets reason_code
     *
     * @param string|null $reason_code Standardized reason code for the void
     *
     * @return self
     */
