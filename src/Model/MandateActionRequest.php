...
/**
 * MandateActionRequest Class Doc Comment
 *
 * @category Class
 * @description Optional parameters for a mandate lifecycle action (cancel / suspend / reinstate).
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MandateActionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MandateActionRequest';
    ...
    */
     ...
     * Sets reason
     *
     * @param string|null $reason Optional reason recorded on the audit trail
     *
     * @return self
     */
