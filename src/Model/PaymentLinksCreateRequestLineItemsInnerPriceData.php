...
/**
 * PaymentLinksCreateRequestLineItemsInnerPriceData Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class PaymentLinksCreateRequestLineItemsInnerPriceData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'payment_links_create_request_line_items_inner_price_data';
    ...
    protected static $openAPITypes = [
        'currency' => 'string',
        'unit_amount' => 'int',
        'product_data' => '\RevKeen\Model\PaymentLinksCreateRequestLineItemsInnerPriceDataProductData',
        'product' => 'string',
        'recurring' => '\RevKeen\Model\PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetailsRecurring',
        'tax_behavior' => 'string'
    ];
    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling PaymentLinksCreateRequestLineItemsInnerPriceData., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling PaymentLinksCreateRequestLineItemsInnerPriceData., must be bigger than or equal to 3.');
        }
     ...
     * Sets unit_amount
     *
     * @param int $unit_amount unit_amount
     *
     * @return self
     */
    public function setUnitAmount($unit_amount)
    {
        ...
        if (($unit_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_amount when calling PaymentLinksCreateRequestLineItemsInnerPriceData., must be bigger than or equal to 0.');
        }
     ...
     * Gets product_data
     *
     * @return \RevKeen\Model\PaymentLinksCreateRequestLineItemsInnerPriceDataProductData|null
     */
     ...
     * Sets product_data
     *
     * @param \RevKeen\Model\PaymentLinksCreateRequestLineItemsInnerPriceDataProductData|null $product_data product_data
     *
     * @return self
     */
     ...
     * Gets recurring
     *
     * @return \RevKeen\Model\PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetailsRecurring|null
     */
     ...
     * Sets recurring
     *
     * @param \RevKeen\Model\PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetailsRecurring|null $recurring recurring
     *
     * @return self
     */
    ...
    public function setTaxBehavior($tax_behavior)
    {
        ...
        $allowedValues = $this->getTaxBehaviorAllowableValues();
        if (!is_null($tax_behavior) && !in_array($tax_behavior, $allowedValues, true)) {
