...
/**
 * StorefrontStatusCheck Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class StorefrontStatusCheck implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StorefrontStatusCheck';
    ...
    public const ID_CART_ENABLED = 'cart_enabled';
    public const ID_KEYS = 'keys';
    public const ID_ORIGINS = 'origins';
    public const ID_PRODUCT_READ = 'product_read';
    public const ID_WEBHOOKS = 'webhooks';
    public const ID_AVAILABILITY = 'availability';
    public const STATUS_PASS = 'pass';
    public const STATUS_WARN = 'warn';
    public const STATUS_FAIL = 'fail';
    public const CODE_CART_DISABLED = 'CART_DISABLED';
    public const CODE_KEYS_MISSING = 'KEYS_MISSING';
    public const CODE_ORIGIN_MISSING = 'ORIGIN_MISSING';
    public const CODE_PRODUCT_READ_UNAVAILABLE = 'PRODUCT_READ_UNAVAILABLE';
    public const CODE_WEBHOOK_MISSING = 'WEBHOOK_MISSING';
    public const CODE_WEBHOOK_UNREACHABLE = 'WEBHOOK_UNREACHABLE';
    ...
    {
        return [
            self::ID_CART_ENABLED,
            self::ID_KEYS,
            self::ID_ORIGINS,
            self::ID_PRODUCT_READ,
            self::ID_WEBHOOKS,
    ...
    {
        return [
            self::CODE_CART_DISABLED,
            self::CODE_KEYS_MISSING,
            self::CODE_ORIGIN_MISSING,
            self::CODE_PRODUCT_READ_UNAVAILABLE,
            self::CODE_WEBHOOK_MISSING,
            self::CODE_WEBHOOK_UNREACHABLE,
        ];
    }
    ...
    */
     ...
     * Sets next_action
     *
     * @param string|null $next_action next_action
     *
     * @return self
     */
