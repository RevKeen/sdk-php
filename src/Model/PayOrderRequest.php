 ...
 *
 * @category Class
 * @description Parameters for paying an order, specifying the payment method and optional partial amount.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class PayOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $payment_method_id Saved payment method ID
     *
     * @return self
     */
     ...
     * Sets payment_token
     *
     * @param string|null $payment_token One-time payment token
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param int|null $amount Partial payment amount in cents (defaults to full amount_due)
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PayOrderRequest., must be bigger than or equal to 1.');
        }
