...
/**
 * BillingAnchorRulesResponse Class Doc Comment
 *
 * @category Class
 * @description Billing anchor rules that determine how billing dates are calculated for different start modes and intervals.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BillingAnchorRulesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingAnchorRulesResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\RevKeen\Model\BillingAnchorRulesResponseDataInner[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\BillingAnchorRulesResponseDataInner[]
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\BillingAnchorRulesResponseDataInner[] $data data
     *
     * @return self
     */
