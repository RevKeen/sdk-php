 ...
 *
 * @category Class
 * @description A line item within a subscription, representing a specific product and price that the customer is billed for each cycle.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class SubscriptionItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['price_id'] === null && !$this->isNullableSetToNull('price_id')) {
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling SubscriptionItem., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $fulfillment_type none: service (no order), physical: creates shipping order, digital: creates download order
     *
     * @return self
     */
