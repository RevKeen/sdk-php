 ...
 *
 * @category Class
 * @description A business entity (company) associated with a customer for B2B billing.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Business implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const OBJECT_BUSINESS = 'business';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('billing_phone', $data ?? [], null);
        ...
        $this->setIfExists('billing_postcode', $data ?? [], null);
    ...
    */
     ...
     * Sets company_number
     *
     * @param string|null $company_number Company registration number
     *
     * @return self
     */
     ...
     * Sets tax_identifier
     *
     * @param string|null $tax_identifier Tax ID (VAT, EIN, etc.)
     *
     * @return self
     */
    public function setTaxIdentifier($tax_identifier)
    {
        if (is_null($tax_identifier)) {
            array_push($this->openAPINullablesSetToNull, 'tax_identifier');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tax_identifier', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets billing_email
     *
     * @param string|null $billing_email Billing email address
     *
     * @return self
     */
     ...
     * Sets billing_phone
     *
     * @param string|null $billing_phone Billing phone number
     *
     * @return self
     */
    public function setBillingPhone($billing_phone)
    {
        if (is_null($billing_phone)) {
            array_push($this->openAPINullablesSetToNull, 'billing_phone');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('billing_phone', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $billing_postcode Billing postcode/ZIP
     *
     * @return self
     */
    public function setBillingPostcode($billing_postcode)
    {
        if (is_null($billing_postcode)) {
            array_push($this->openAPINullablesSetToNull, 'billing_postcode');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('billing_postcode', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $billing_country Billing country (ISO 3166-1 alpha-2)
     *
     * @return self
     */
