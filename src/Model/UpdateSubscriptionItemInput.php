...
/**
 * UpdateSubscriptionItemInput Class Doc Comment
 *
 * @category Class
 * @description Parameters for updating a subscription line item, such as changing the quantity.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateSubscriptionItemInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSubscriptionItemInput';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling UpdateSubscriptionItemInput., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateSubscriptionItemInput., must be smaller than or equal to 500.');
        }
     ...
     *
     * @param int|null $unit_amount_minor Unit price in cents
     *
     * @return self
     */
    public function setUnitAmountMinor($unit_amount_minor)
    {
        ...
        if (($unit_amount_minor < 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_amount_minor when calling UpdateSubscriptionItemInput., must be bigger than or equal to 0.');
        }
     ...
     * Sets price_id
     *
     * @param string|null $price_id Swap the item onto another Price. Allowed only when the new Price shares the same meter_id (fail closed otherwise).
     *
     * @return self
     */
