...
/**
 * StorefrontAvailability Class Doc Comment
 *
 * @category Class
 * @description Derived availability (capacity + oversell − reserved − confirmed). &#x60;unknown&#x60; when the product does not track availability.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class StorefrontAvailability implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StorefrontAvailability';
    ...
    public const STATUS_PLENTY = 'plenty';
    public const STATUS_LOW = 'low';
    public const STATUS_SOLDOUT = 'soldout';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['remaining'] === null && !$this->isNullableSetToNull('remaining')) {
            $invalidProperties[] = "'remaining' can't be null";
        }
        if ($this->container['display_mode'] === null) {
            $invalidProperties[] = "'display_mode' can't be null";
        }
        if ($this->container['low_stock_threshold'] === null && !$this->isNullableSetToNull('low_stock_threshold')) {
            $invalidProperties[] = "'low_stock_threshold' can't be null";
        }
     ...
     * Sets display_mode
     *
     * @param string $display_mode display_mode
     *
     * @return self
     */
