 ...
 *
 * @category Class
 * @description A list of payment methods attached to a customer, with optional type filtering.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class PaymentMethodList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodList';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data' => '\RevKeen\Model\PaymentMethod[]',
        'has_more' => 'bool',
        'url' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\PaymentMethod[]
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\PaymentMethod[] $data Array of payment methods
     *
     * @return self
     */
