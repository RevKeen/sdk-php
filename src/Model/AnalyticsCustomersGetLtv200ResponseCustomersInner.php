<?php
/**
 * AnalyticsCustomersGetLtv200ResponseCustomersInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * AnalyticsCustomersGetLtv200ResponseCustomersInner Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class AnalyticsCustomersGetLtv200ResponseCustomersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'analytics_customers_getLtv_200_response_customers_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ltv'] === null) {
            $invalidProperties[] = "'ltv' can't be null";
        }
        if ($this->container['total_revenue'] === null) {
            $invalidProperties[] = "'total_revenue' can't be null";
        }
        if ($this->container['avg_order_value'] === null) {
            $invalidProperties[] = "'avg_order_value' can't be null";
        }
     ...
     *
     * @param float $avg_order_value avg_order_value
     *
     * @return self
     */
    public function setAvgOrderValue($avg_order_value)
    {
        if (is_null($avg_order_value)) {
            throw new \InvalidArgumentException('non-nullable avg_order_value cannot be null');
        }
     ...
     * Sets order_count
     *
     * @param float $order_count order_count
     *
     * @return self
     */
