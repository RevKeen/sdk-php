...
/**
 * MandateActionResponse Class Doc Comment
 *
 * @category Class
 * @description Result of a mandate lifecycle action.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MandateActionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MandateActionResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\RevKeen\Model\MandateActionResponseData'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\MandateActionResponseData
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\MandateActionResponseData $data data
     *
     * @return self
     */
