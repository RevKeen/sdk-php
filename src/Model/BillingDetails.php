...
class BillingDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'email' => 'string',
        'phone' => 'string',
        'address' => '\RevKeen\Model\BillingDetailsAddress'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Full name on the payment method
     *
     * @return self
     */
     ...
     * Gets address
     *
     * @return \RevKeen\Model\BillingDetailsAddress
     */
     ...
     * Sets address
     *
     * @param \RevKeen\Model\BillingDetailsAddress $address address
     *
     * @return self
     */
