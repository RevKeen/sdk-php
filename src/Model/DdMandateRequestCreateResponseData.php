...
/**
 * DdMandateRequestCreateResponseData Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class DdMandateRequestCreateResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DdMandateRequestCreateResponse_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('idempotent', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['idempotent'] === null) {
            $invalidProperties[] = "'idempotent' can't be null";
        }
     ...
     * Sets token
     *
     * @param string $token Signed mandate-request token for the emailed link
     *
     * @return self
     */
     ...
     * Sets signable_url
     *
     * @param string $signable_url Customer-facing URL that opens the sign flow
     *
     * @return self
     */
    ...
    {
        return $this->container['idempotent'];
    }

    /**
     * Sets idempotent
     *
     * @param bool $idempotent True when an existing live request was returned instead of creating a new one
     *
     * @return self
     */
    public function setIdempotent($idempotent)
    {
        if (is_null($idempotent)) {
            throw new \InvalidArgumentException('non-nullable idempotent cannot be null');
        }
        $this->container['idempotent'] = $idempotent;
