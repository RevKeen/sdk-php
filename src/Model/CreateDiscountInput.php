...
/**
 * CreateDiscountInput Class Doc Comment
 *
 * @category Class
 * @description Parameters for creating a new discount code with amount, type, and usage limits.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreateDiscountInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDiscountInput';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('first_time_customer', $data ?? [], false);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['discount_value'] < 0.01)) {
     ...
     * Sets code
     *
     * @param string $code Unique discount code (will be uppercased)
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CreateDiscountInput., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CreateDiscountInput., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateDiscountInput., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateDiscountInput., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateDiscountInput., must be smaller than or equal to 1000.');
        }
     ...
     * Sets discount_value
     *
     * @param float $discount_value Discount value - percentage (1-100) or amount in cents
     *
     * @return self
     */
    public function setDiscountValue($discount_value)
    {
        ...
        if (($discount_value < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $discount_value when calling CreateDiscountInput., must be bigger than or equal to 0.01.');
        }
     ...
     * Sets applies_to
     *
     * @param string|null $applies_to Which products the discount applies to
     *
     * @return self
     */
     ...
     * Sets scope
     *
     * @param string|null $scope Scope of where discount can be applied
     *
     * @return self
     */
     ...
     * Sets product_ids
     *
     * @param string[]|null $product_ids Product IDs if applies_to is 'specific_products'
     *
     * @return self
     */
     ...
     *
     * @param int|null $max_redemptions Maximum total redemptions allowed
     *
     * @return self
     */
    public function setMaxRedemptions($max_redemptions)
    {
        ...
        if (($max_redemptions < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_redemptions when calling CreateDiscountInput., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param int|null $max_redemptions_per_user Maximum redemptions per customer (0 = unlimited)
     *
     * @return self
     */
    public function setMaxRedemptionsPerUser($max_redemptions_per_user)
    {
        ...
        if (($max_redemptions_per_user < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_redemptions_per_user when calling CreateDiscountInput., must be bigger than or equal to 0.');
        }
     ...
     * Sets valid_from
     *
     * @param string|null $valid_from Start date (ISO 8601)
     *
     * @return self
     */
     ...
     * Sets valid_until
     *
     * @param string|null $valid_until End date (ISO 8601)
     *
     * @return self
     */
     ...
     * Sets recurring_type
     *
     * @param string|null $recurring_type How the discount applies to recurring payments
     *
     * @return self
     */
    public function setRecurringType($recurring_type)
    {
        if (is_null($recurring_type)) {
            throw new \InvalidArgumentException('non-nullable recurring_type cannot be null');
        }
        $allowedValues = $this->getRecurringTypeAllowableValues();
     ...
     *
     * @param int|null $recurring_cycles Number of billing cycles (only if recurring_type is 'repeating')
     *
     * @return self
     */
    public function setRecurringCycles($recurring_cycles)
    {
        if (is_null($recurring_cycles)) {
            throw new \InvalidArgumentException('non-nullable recurring_cycles cannot be null');
        }

        if (($recurring_cycles < 1)) {
            throw new \InvalidArgumentException('invalid value for $recurring_cycles when calling CreateDiscountInput., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param bool|null $first_time_customer Only available to first-time customers
     *
     * @return self
     */
