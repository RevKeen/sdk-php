 ...
 *
 * @category Class
 * @description Parameters for updating an existing price. Amounts cannot be changed — archive and create a new price instead.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdatePriceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePriceRequest';
    ...
    */
     ...
     * Sets active
     *
     * @param bool|null $active Whether the price is active
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdatePriceRequest., must be smaller than or equal to 100.');
        }
     ...
     * Sets nickname
     *
     * @param string|null $nickname Display name
     *
     * @return self
     */
    public function setNickname($nickname)
    {
        ...
        if (!is_null($nickname) && (mb_strlen($nickname) > 100)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling UpdatePriceRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdatePriceRequest., must be smaller than or equal to 500.');
        }
    ...
    public function setLookupKey($lookup_key)
    {
        ...
        if (!is_null($lookup_key) && (mb_strlen($lookup_key) > 100)) {
            throw new \InvalidArgumentException('invalid length for $lookup_key when calling UpdatePriceRequest., must be smaller than or equal to 100.');
        }
