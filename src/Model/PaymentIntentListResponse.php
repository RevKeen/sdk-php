 ...
 *
 * @category Class
 * @description A paginated list of payment intents matching the query filters.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class PaymentIntentListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data' => '\RevKeen\Model\PaymentIntent[]',
        'has_more' => 'bool',
        'url' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\PaymentIntent[]
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\PaymentIntent[] $data data
     *
     * @return self
     */
