...
/**
 * DdMandateRequestConsumeResponseData Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class DdMandateRequestConsumeResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DdMandateRequestConsumeResponse_data';
    ...
    */
     ...
     * Sets idempotent
     *
     * @param bool|null $idempotent idempotent
     *
     * @return self
     */
     ...
     * Gets pdf_documents
     *
     * @return \RevKeen\Model\DdMandatePdfReference[]|null
     */
     ...
     * Sets pdf_documents
     *
     * @param \RevKeen\Model\DdMandatePdfReference[]|null $pdf_documents pdf_documents
     *
     * @return self
     */
