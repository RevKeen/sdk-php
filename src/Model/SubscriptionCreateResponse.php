...
/**
 * SubscriptionCreateResponse Class Doc Comment
 *
 * @category Class
 * @description The newly created subscription with billing schedule and initial invoice details.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SubscriptionCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionCreateResponse';
