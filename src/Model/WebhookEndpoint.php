...
class WebhookEndpoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier for the webhook endpoint
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url The URL that receives webhook POST requests
     *
     * @return self
     */
     ...
     * Sets enabled_events
     *
     * @param string[] $enabled_events Event types this endpoint subscribes to
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Whether the endpoint is currently receiving events
     *
     * @return self
     */
     ...
     * Sets secret
     *
     * @param string|null $secret Signing secret. Returned only on create or secret rotation.
     *
     * @return self
     */
     ...
     *
     * @param string $circuit_breaker_state Circuit breaker status. Opens after repeated delivery failures.
     *
     * @return self
     */
     ...
     *
     * @param float $total_deliveries Total number of delivery attempts
     *
     * @return self
     */
     ...
     *
     * @param float $successful_deliveries Number of successful deliveries
     *
     * @return self
     */
     ...
     *
     * @param float $failed_deliveries Number of failed deliveries
     *
     * @return self
     */
     ...
     *
     * @param string|null $last_delivery_at Timestamp of the most recent delivery attempt
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param string $created_at When the endpoint was created
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param string $updated_at When the endpoint was last modified
     *
     * @return self
     */
