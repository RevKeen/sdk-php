...
/**
 * AnalyticsInvoicesGetArAging200Response Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class AnalyticsInvoicesGetArAging200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'analytics_invoices_getArAging_200_response';
    ...
    protected static $openAPITypes = [
        'as_of_date' => 'string',
        'buckets' => '\RevKeen\Model\AnalyticsInvoicesGetArAging200ResponseBucketsInner[]',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('total_outstanding', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['total_outstanding'] === null) {
            $invalidProperties[] = "'total_outstanding' can't be null";
        }
     ...
     * Gets buckets
     *
     * @return \RevKeen\Model\AnalyticsInvoicesGetArAging200ResponseBucketsInner[]
     */
     ...
     * Sets buckets
     *
     * @param \RevKeen\Model\AnalyticsInvoicesGetArAging200ResponseBucketsInner[] $buckets buckets
     *
     * @return self
     */
    ...
    {
        if (is_null($total_outstanding)) {
            throw new \InvalidArgumentException('non-nullable total_outstanding cannot be null');
        }
     ...
     * Sets total_invoices
     *
     * @param float $total_invoices total_invoices
     *
     * @return self
     */
