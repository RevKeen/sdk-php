<?php
/**
 * AnalyticsRevenueGetTimeSeries200ResponseDataPointsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * AnalyticsRevenueGetTimeSeries200ResponseDataPointsInner Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class AnalyticsRevenueGetTimeSeries200ResponseDataPointsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'analytics_revenue_getTimeSeries_200_response_dataPoints_inner';
    ...
    */
     ...
     * Sets invoice_count
     *
     * @param float $invoice_count invoice_count
     *
     * @return self
     */
     ...
     *
     * @param float $avg_invoice_value avg_invoice_value
     *
     * @return self
     */
