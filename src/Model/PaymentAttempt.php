...
class PaymentAttempt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['avs_code'] === null && !$this->isNullableSetToNull('avs_code')) {
            $invalidProperties[] = "'avs_code' can't be null";
        }
        if ($this->container['cvv_code'] === null && !$this->isNullableSetToNull('cvv_code')) {
            $invalidProperties[] = "'cvv_code' can't be null";
        }
        if ($this->container['issuer_code'] === null && !$this->isNullableSetToNull('issuer_code')) {
     ...
     *
     * @param string|null $gateway_order_id The exact order_id sent to the gateway (NMI). Format: payatt_<public_id>. Primary correlation key for webhook mapping.
     *
     * @return self
     */
     ...
     *
     * @param string|null $gateway_transaction_id Transaction ID returned by the gateway (NMI's transaction reference).
     *
     * @return self
     */
     ...
     * Sets transaction_id
     *
     * @param string|null $transaction_id Legacy transaction reference (deprecated - use gateway_transaction_id)
     *
     * @return self
     */
     ...
     * Sets avs_code
     *
     * @param string|null $avs_code Address Verification System response code
     *
     * @return self
     */
     ...
     * Sets cvv_code
     *
     * @param string|null $cvv_code CVV verification response code
     *
     * @return self
     */
     ...
     * Sets issuer_code
     *
     * @param string|null $issuer_code Issuer-specific response code
     *
     * @return self
     */
    public function setIssuerCode($issuer_code)
    {
        if (is_null($issuer_code)) {
            array_push($this->openAPINullablesSetToNull, 'issuer_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('issuer_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
