...
class CreateMeterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $value_expression Constrained arithmetic expression over numeric event properties. Example: input_tokens + output_tokens
     *
     * @return self
     */
    public function setValueExpression($value_expression)
    {
        if (is_null($value_expression)) {
            throw new \InvalidArgumentException('non-nullable value_expression cannot be null');
        }
