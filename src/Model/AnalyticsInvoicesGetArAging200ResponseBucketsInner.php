<?php
/**
 * AnalyticsInvoicesGetArAging200ResponseBucketsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * AnalyticsInvoicesGetArAging200ResponseBucketsInner Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class AnalyticsInvoicesGetArAging200ResponseBucketsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'analytics_invoices_getArAging_200_response_buckets_inner';
    ...
    */
     ...
     * Sets total_minor
     *
     * @param float $total_minor total_minor
     *
     * @return self
     */
