 ...
 *
 * @category Class
 * @description A financial movement in the unified transaction model. Every money movement — payments, refunds, voids, disputes — is recorded as a transaction linked to an invoice.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Transaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const OBJECT_TRANSACTION = 'transaction';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Transaction type. sale: original payment. refund: money returned. void: cancel before settlement. capture: capture a previous auth. dispute: chargeback. adjustment: manual correction.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Transaction status. pending: processing. succeeded: completed. failed: declined or errored. voided: canceled.
     *
     * @return self
     */
     ...
     *
     * @param string|null $parent_transaction_id Parent transaction ID (required for refunds, voids, disputes, adjustments)
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param int $amount Transaction amount in minor units (cents)
     *
     * @return self
     */
     ...
     *
     * @param int|null $amount_refunded Amount refunded in minor units
     *
     * @return self
     */
     ...
     * Sets gateway
     *
     * @param string|null $gateway Payment gateway (e.g., 'nmi')
     *
     * @return self
     */
     ...
     *
     * @param string|null $gateway_transaction_id Gateway's transaction reference
     *
     * @return self
     */
     ...
     *
     * @param string|null $gateway_response_code Gateway response code
     *
     * @return self
     */
     ...
     *
     * @param string|null $gateway_response_text Gateway response message
     *
     * @return self
     */
