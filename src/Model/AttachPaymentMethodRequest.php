...
/**
 * AttachPaymentMethodRequest Class Doc Comment
 *
 * @category Class
 * @description Parameters for attaching a payment method to a customer. The payment method must have been created first.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AttachPaymentMethodRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AttachPaymentMethodRequest';
    ...
    */
     ...
     * Sets customer_id
     *
     * @param string $customer_id ID of the customer to attach the payment method to
     *
     * @return self
     */
