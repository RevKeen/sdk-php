 ...
 *
 * @category Class
 * @description Parameters for updating an existing product. Only the provided fields are changed.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class UpdateProductRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateProductRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAmountMinor($amount_minor)
    {
        ...
        if (($amount_minor < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount_minor when calling UpdateProductRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTrialDays($trial_days)
    {
        ...
        if (($trial_days < 0)) {
            throw new \InvalidArgumentException('invalid value for $trial_days when calling UpdateProductRequest., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $fulfillment_type Fulfillment type for the product.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $track_inventory Enable/disable the finite purchase cap (one-time products only). Requires stock_quantity when enabled.
     *
     * @return self
     */
     ...
     * Sets stock_quantity
     *
     * @param int|null $stock_quantity Remaining units that can be purchased. Required (non-negative) when track_inventory is true.
     *
     * @return self
     */
    public function setStockQuantity($stock_quantity)
    {
        ...
        if (!is_null($stock_quantity) && ($stock_quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $stock_quantity when calling UpdateProductRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setBillingAnchorDay($billing_anchor_day)
    {
        ...
        if (!is_null($billing_anchor_day) && ($billing_anchor_day > 31)) {
            throw new \InvalidArgumentException('invalid value for $billing_anchor_day when calling UpdateProductRequest., must be smaller than or equal to 31.');
        }
        if (!is_null($billing_anchor_day) && ($billing_anchor_day < 1)) {
            throw new \InvalidArgumentException('invalid value for $billing_anchor_day when calling UpdateProductRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets max_payments
     *
     * @param int|null $max_payments max_payments
     *
     * @return self
     */
    public function setMaxPayments($max_payments)
    {
        ...
        if (!is_null($max_payments) && ($max_payments > 999)) {
            throw new \InvalidArgumentException('invalid value for $max_payments when calling UpdateProductRequest., must be smaller than or equal to 999.');
        }
        if (!is_null($max_payments) && ($max_payments < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_payments when calling UpdateProductRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets image_url
     *
     * @param string|null $image_url Product image S3 key or public URL. Pass null to remove.
     *
     * @return self
     */
