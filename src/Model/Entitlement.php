...
class Entitlement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ACCESS_LEVEL_PARTIAL = 'partial';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('benefit_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['benefit_id'] === null) {
            $invalidProperties[] = "'benefit_id' can't be null";
        }
        ...
        if ($this->container['subscription_status'] === null && !$this->isNullableSetToNull('subscription_status')) {
    ...
    {
        return $this->container['benefit_id'];
    }

    /**
     * Sets benefit_id
     *
     * @param string $benefit_id benefit_id
     *
     * @return self
     */
    public function setBenefitId($benefit_id)
    {
        if (is_null($benefit_id)) {
            throw new \InvalidArgumentException('non-nullable benefit_id cannot be null');
        }
        $this->container['benefit_id'] = $benefit_id;
     ...
     * Sets benefit
     *
     * @param \RevKeen\Model\Benefit $benefit benefit
     *
     * @return self
     */
