<?php
/**
 * MandateRequestLookupResponseDataInvoice
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * MandateRequestLookupResponseDataInvoice Class Doc Comment
 *
 * @category Class
 * @description Invoice details, if the request is tied to an invoice
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MandateRequestLookupResponseDataInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MandateRequestLookupResponse_data_invoice';
    ...
    */
     ...
     * Sets amount_due
     *
     * @param string|null $amount_due amount_due
     *
     * @return self
     */
