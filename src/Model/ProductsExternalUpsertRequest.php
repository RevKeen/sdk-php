...
/**
 * ProductsExternalUpsertRequest Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class ProductsExternalUpsertRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'products_externalUpsert_request';
    ...
    protected static $setters = [
        ...
        'external_updated_at' => 'setExternalUpdatedAt',
    ...
    protected static $getters = [
        ...
        'external_updated_at' => 'getExternalUpdatedAt',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('external_updated_at', $data ?? [], null);
    ...
    */
     ...
     * Sets merchant_id
     *
     * @param string|null $merchant_id Deprecated: merchantId is derived from API key authentication. This field is ignored.
     *
     * @return self
     * @deprecated
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductsExternalUpsertRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets kind
     *
     * @param string|null $kind Product kind - subscription or one-time
     *
     * @return self
     */
     ...
     * Sets amount_cents
     *
     * @param int $amount_cents Price in minor units (cents)
     *
     * @return self
     */
    public function setAmountCents($amount_cents)
    {
        ...
        if (($amount_cents < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount_cents when calling ProductsExternalUpsertRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ProductsExternalUpsertRequest., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ProductsExternalUpsertRequest., must be bigger than or equal to 3.');
        }
     ...
     * Sets is_active
     *
     * @param bool|null $is_active Whether the product is active
     *
     * @return self
     */
     ...
     * Sets interval
     *
     * @param string|null $interval Billing interval for subscriptions
     *
     * @return self
     */
    ...
    public function setIntervalCount($interval_count)
    {
        ...
        if (($interval_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $interval_count when calling ProductsExternalUpsertRequest., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets external_updated_at
     *
     * @return \DateTime|null
     */
    public function getExternalUpdatedAt()
    {
        return $this->container['external_updated_at'];
    }

    /**
     * Sets external_updated_at
     *
     * @param \DateTime|null $external_updated_at External system's last update timestamp for stale update protection
     *
     * @return self
     */
    public function setExternalUpdatedAt($external_updated_at)
    {
        if (is_null($external_updated_at)) {
            throw new \InvalidArgumentException('non-nullable external_updated_at cannot be null');
        }
        $this->container['external_updated_at'] = $external_updated_at;
     ...
     * Sets external_ref
     *
     * @param string|null $external_ref Additional external reference (e.g., membership ID)
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,mixed>|null $metadata Additional metadata from external system
     *
     * @return self
     */
