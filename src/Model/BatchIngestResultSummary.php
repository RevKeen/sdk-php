...
/**
 * BatchIngestResultSummary Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class BatchIngestResultSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchIngestResult_summary';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ingested'] === null) {
            $invalidProperties[] = "'ingested' can't be null";
        }
     ...
     * Sets duplicate
     *
     * @param float $duplicate duplicate
     *
     * @return self
     */
