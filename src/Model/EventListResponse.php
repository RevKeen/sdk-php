 ...
 *
 * @category Class
 * @description A paginated list of events matching the query filters.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class EventListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\Event[] $data data
     *
     * @return self
     */
