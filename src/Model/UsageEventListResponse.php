...
/**
 * UsageEventListResponse Class Doc Comment
 *
 * @category Class
 * @description A paginated list of usage events matching the query filters.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UsageEventListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UsageEventListResponse';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data' => '\RevKeen\Model\UsageEventRecord[]',
        'has_more' => 'bool'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\UsageEventRecord[]
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\UsageEventRecord[] $data Array of usage event objects
     *
     * @return self
     */
