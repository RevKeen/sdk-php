...
/**
 * TestEventResponse Class Doc Comment
 *
 * @category Class
 * @description The test event that was sent, including delivery status.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TestEventResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TestEventResponse';
    ...
    */
     ...
     * Sets success
     *
     * @param bool $success Whether the test event was created
     *
     * @return self
     */
     ...
     * Gets event
     *
     * @return \RevKeen\Model\Event|null
     */
     ...
     * Sets event
     *
     * @param \RevKeen\Model\Event|null $event The created test event
     *
     * @return self
     */
