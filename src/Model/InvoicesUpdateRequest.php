...
/**
 * InvoicesUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class InvoicesUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoices_update_request';
    ...
    protected static $openAPITypes = [
        ...
        'subscription_terms' => '\RevKeen\Model\InvoicesUpdateRequestSubscriptionTerms'
    ];
    ...
    */
     ...
     * Sets total_minor
     *
     * @param int|null $total_minor total_minor
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $allowed_methods Update the invoice's restricted payment methods. Empty array clears restriction (merchant defaults apply); omit to leave unchanged.
     *
     * @return self
     */
     ...
     *
     * @return \RevKeen\Model\InvoicesUpdateRequestSubscriptionTerms|null
     */
     ...
     *
     * @param \RevKeen\Model\InvoicesUpdateRequestSubscriptionTerms|null $subscription_terms subscription_terms
     *
     * @return self
     */
