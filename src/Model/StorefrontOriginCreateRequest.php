...
/**
 * StorefrontOriginCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class StorefrontOriginCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StorefrontOriginCreateRequest';
    ...
    */
     ...
     * Sets origin
     *
     * @param string $origin Exact origin, e.g. https://shop.example.com or http://localhost:3000.
     *
     * @return self
     */
