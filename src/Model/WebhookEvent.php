 ...
 *
 * @category Class
 * @description The envelope for all webhook event deliveries. Contains the event type, timestamp, and the affected object in the data field.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class WebhookEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created' => 'int',
        'livemode' => 'bool',
        'data' => '\RevKeen\Model\WebhookEventData'
    ];
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Event type using dot notation (e.g., `payment.succeeded`)
     *
     * @return self
     */
     ...
     * Sets livemode
     *
     * @param bool|null $livemode Whether this event occurred in live mode
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \RevKeen\Model\WebhookEventData
     */
     ...
     * Sets data
     *
     * @param \RevKeen\Model\WebhookEventData $data data
     *
     * @return self
     */
