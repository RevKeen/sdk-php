...
/**
 * DdMandatePdfReference Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class DdMandatePdfReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DdMandatePdfReference';
    ...
    protected static $setters = [
        ...
        'compliance_version' => 'setComplianceVersion'
    ];
    ...
    protected static $getters = [
        ...
        'compliance_version' => 'getComplianceVersion'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pdf_type', $data ?? [], null);
        ...
        $this->setIfExists('compliance_version', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pdf_type'] === null) {
            $invalidProperties[] = "'pdf_type' can't be null";
        }
        ...
        if ($this->container['compliance_version'] === null) {
            $invalidProperties[] = "'compliance_version' can't be null";
        }
     ...
     * Sets pdf_type
     *
     * @param string $pdf_type pdf_type
     *
     * @return self
     */
    ...
    {
        if (is_null($pdf_type)) {
            throw new \InvalidArgumentException('non-nullable pdf_type cannot be null');
        }
    ...
    /**
     * Gets compliance_version
     *
     * @return string
     */
    public function getComplianceVersion()
    {
        return $this->container['compliance_version'];
    }

    /**
     * Sets compliance_version
     *
     * @param string $compliance_version compliance_version
     *
     * @return self
     */
    public function setComplianceVersion($compliance_version)
    {
        if (is_null($compliance_version)) {
            throw new \InvalidArgumentException('non-nullable compliance_version cannot be null');
        }
        $this->container['compliance_version'] = $compliance_version;
