...
class WebhookEventData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets object
     *
     * @param object|null $object The object that triggered the event (e.g., Payment, Invoice, Subscription)
     *
     * @return self
     */
     ...
     *
     * @param object|null $previous_attributes Previous values of attributes that changed (for update events)
     *
     * @return self
     */
