<?php
/**
 * CreateAccountingInvoicePaymentRequestInputExternalCustomer
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CreateAccountingInvoicePaymentRequestInputExternalCustomer Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class CreateAccountingInvoicePaymentRequestInputExternalCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAccountingInvoicePaymentRequestInput_external_customer';
