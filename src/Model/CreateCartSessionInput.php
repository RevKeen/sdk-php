...
/**
 * CreateCartSessionInput Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class CreateCartSessionInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCartSessionInput';
    ...
    protected static $openAPITypes = [
        ...
        'mode' => 'string',
        'customer_id' => 'string',
        'line_items' => '\RevKeen\Model\CartLineItemInput[]',
    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateCartSessionInput., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateCartSessionInput., must be bigger than or equal to 3.');
        }
     ...
     * Gets line_items
     *
     * @return \RevKeen\Model\CartLineItemInput[]|null
     */
     ...
     * Sets line_items
     *
     * @param \RevKeen\Model\CartLineItemInput[]|null $line_items line_items
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $add_ons_offered add_ons_offered
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_link_id Seed this cart from a cart-enabled payment link.
     *
     * @return self
     */
