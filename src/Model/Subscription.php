 ...
 *
 * @category Class
 * @description A subscription with full plan, billing, and status details.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'dunning' => '\RevKeen\Model\SubscriptionDunning'
    ];
    ...
    */
     ...
     * Sets merchant_id
     *
     * @param string $merchant_id Owning merchant UUID
     *
     * @return self
     */
     ...
     * Sets product_id
     *
     * @param string|null $product_id Product UUID
     *
     * @return self
     */
     ...
     * Sets price_id
     *
     * @param string|null $price_id Price UUID
     *
     * @return self
     */
     ...
     * Sets plan_id
     *
     * @param string|null $plan_id Plan UUID
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int $quantity Subscribed quantity
     *
     * @return self
     */
     ...
     * Sets amount_minor
     *
     * @param int $amount_minor Recurring amount in minor units
     *
     * @return self
     */
     ...
     *
     * @param string $billing_interval Billing interval (day, week, month, year)
     *
     * @return self
     */
     ...
     *
     * @param \DateTime $current_period_start Current period start (ISO 8601)
     *
     * @return self
     */
     ...
     *
     * @param \DateTime $current_period_end Current period end (ISO 8601)
     *
     * @return self
     */
     ...
     * Sets trial_end
     *
     * @param \DateTime|null $trial_end Trial end (ISO 8601)
     *
     * @return self
     */
     ...
     * Sets canceled_at
     *
     * @param \DateTime|null $canceled_at Cancellation timestamp (ISO 8601)
     *
     * @return self
     */
     ...
     * Gets dunning
     *
     * @return \RevKeen\Model\SubscriptionDunning|null
     */
     ...
     * Sets dunning
     *
     * @param \RevKeen\Model\SubscriptionDunning|null $dunning dunning
     *
     * @return self
     */
