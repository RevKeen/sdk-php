...
/**
 * BillingPreviewResponseData Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class BillingPreviewResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingPreviewResponse_data';
    ...
    protected static $openAPITypes = [
        'items' => '\RevKeen\Model\SubscriptionPreviewRenewalResponseDataUpcomingRenewalsInner[]',
        'summary' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('first_charge_date', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['trial_end_date'] === null && !$this->isNullableSetToNull('trial_end_date')) {
            $invalidProperties[] = "'trial_end_date' can't be null";
        }
        if ($this->container['schedule_end_date'] === null && !$this->isNullableSetToNull('schedule_end_date')) {
            $invalidProperties[] = "'schedule_end_date' can't be null";
        }
     ...
     * Sets items
     *
     * @param \RevKeen\Model\SubscriptionPreviewRenewalResponseDataUpcomingRenewalsInner[] $items items
     *
     * @return self
     */
     ...
     *
     * @param int $total_amount_minor total_amount_minor
     *
     * @return self
     */
    ...
    {
        if (is_null($first_charge_date)) {
            throw new \InvalidArgumentException('non-nullable first_charge_date cannot be null');
        }
     ...
     *
     * @param \DateTime|null $schedule_end_date schedule_end_date
     *
     * @return self
     */
