...
/**
 * DdMandateRequestCancelResponseData Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class DdMandateRequestCancelResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DdMandateRequestCancelResponse_data';
    ...
    */
     ...
     * Sets cancelled_by
     *
     * @param string|null $cancelled_by cancelled_by
     *
     * @return self
     */
