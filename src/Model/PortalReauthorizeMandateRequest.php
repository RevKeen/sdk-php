...
/**
 * PortalReauthorizeMandateRequest Class Doc Comment
 *
 * @category Class
 * @package  RevKeen
 * @author   OpenAPI Generator team
 ...
 */
class PortalReauthorizeMandateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortalReauthorizeMandateRequest';
    ...
    protected static $openAPITypes = [
        ...
        'acceptance' => '\RevKeen\Model\PortalReauthorizeMandateRequestAcceptance'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['account_holder_name']) > 255)) {
            $invalidProperties[] = "invalid value for 'account_holder_name', the character length must be smaller than or equal to 255.";
        }
        ...
        if (!preg_match("/^\\d{8}$/", $this->container['account_number'])) {
            $invalidProperties[] = "invalid value for 'account_number', must be conform to the pattern /^\\d{8}$/.";
        }
    ...
    public function setAccountHolderName($account_holder_name)
    {
        ...
        if ((mb_strlen($account_holder_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $account_holder_name when calling PortalReauthorizeMandateRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($account_holder_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_holder_name when calling PortalReauthorizeMandateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSortCode($sort_code)
    {
        ...
        if ((mb_strlen($sort_code) > 8)) {
            throw new \InvalidArgumentException('invalid length for $sort_code when calling PortalReauthorizeMandateRequest., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($sort_code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $sort_code when calling PortalReauthorizeMandateRequest., must be bigger than or equal to 6.');
        }
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((!preg_match("/^\\d{8}$/", ObjectSerializer::toString($account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$account_number when calling PortalReauthorizeMandateRequest., must conform to the pattern /^\\d{8}$/.");
        }
    ...
    public function setVerificationToken($verification_token)
    {
        ...
        if ((mb_strlen($verification_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $verification_token when calling PortalReauthorizeMandateRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets acceptance
     *
     * @return \RevKeen\Model\PortalReauthorizeMandateRequestAcceptance
     */
     ...
     * Sets acceptance
     *
     * @param \RevKeen\Model\PortalReauthorizeMandateRequestAcceptance $acceptance acceptance
     *
     * @return self
     */
