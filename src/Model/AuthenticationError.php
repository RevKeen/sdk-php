 ...
 *
 * @category Class
 * @description Returned when the API key is missing, invalid, or expired. Verify your x-api-key header contains a valid key.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class AuthenticationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'error' => '\RevKeen\Model\AuthenticationErrorError'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \RevKeen\Model\AuthenticationErrorError
     */
     ...
     * Sets error
     *
     * @param \RevKeen\Model\AuthenticationErrorError $error error
     *
     * @return self
     */
