 ...
 *
 * @category Class
 * @description Parameters for creating a setup intent to save a payment method for a customer.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CreateSetupIntentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('usage', $data ?? [], 'off_session');
    ...
    */
     ...
     * Sets usage
     *
     * @param string|null $usage How the payment method will be used
     *
     * @return self
     */
