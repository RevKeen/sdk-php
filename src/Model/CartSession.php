...
class CartSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'email' => 'setEmail',
        'promotional_consent' => 'setPromotionalConsent',
        'sms_consent' => 'setSmsConsent',
    ...
    protected static $getters = [
        ...
        'email' => 'getEmail',
        'promotional_consent' => 'getPromotionalConsent',
        'sms_consent' => 'getSmsConsent',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('promotional_consent', $data ?? [], null);
        $this->setIfExists('sms_consent', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['promotional_consent'] === null && !$this->isNullableSetToNull('promotional_consent')) {
            $invalidProperties[] = "'promotional_consent' can't be null";
        }
        if ($this->container['sms_consent'] === null && !$this->isNullableSetToNull('sms_consent')) {
            $invalidProperties[] = "'sms_consent' can't be null";
        }
     ...
     * Sets email
     *
     * @param string|null $email Captured customer email for recovery, if provided.
     *
     * @return self
     */
    ...
    /**
     * Gets promotional_consent
     *
     * @return bool|null
     */
    public function getPromotionalConsent()
    {
        return $this->container['promotional_consent'];
    }

    /**
     * Sets promotional_consent
     *
     * @param bool|null $promotional_consent promotional_consent
     *
     * @return self
     */
    public function setPromotionalConsent($promotional_consent)
    {
        if (is_null($promotional_consent)) {
            array_push($this->openAPINullablesSetToNull, 'promotional_consent');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('promotional_consent', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['promotional_consent'] = $promotional_consent;
    ...
    {
        return $this->container['sms_consent'];
    }

    /**
     * Sets sms_consent
     *
     * @param bool|null $sms_consent sms_consent
     *
     * @return self
     */
    public function setSmsConsent($sms_consent)
    {
        if (is_null($sms_consent)) {
            array_push($this->openAPINullablesSetToNull, 'sms_consent');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sms_consent', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['sms_consent'] = $sms_consent;
     ...
     * Sets public_token
     *
     * @param string $public_token Anon-access token. Use to build /c/[cart_session_id]?token=... URLs for customer-facing cart checkout. Open carts can be reviewed and edited; unexpired abandoned carts can be reviewed and converted as-is. Expired and converted carts are inaccessible.
     *
     * @return self
     */
