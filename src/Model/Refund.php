 ...
 *
 * @category Class
 * @description A refund represents money returned to a customer after a completed payment. Refunds create a child transaction linked to the original payment for audit trail purposes.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Refund implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'order_id' => 'setOrderId',
        'gateway' => 'setGateway',
        'gateway_refund_id' => 'setGatewayRefundId',
        'amount_minor' => 'setAmountMinor',
        'currency' => 'setCurrency',
        'reason' => 'setReason',
        'reason_details' => 'setReasonDetails',
        'status' => 'setStatus',
    ...
    protected static $getters = [
        ...
        'order_id' => 'getOrderId',
        'gateway' => 'getGateway',
        'gateway_refund_id' => 'getGatewayRefundId',
        'amount_minor' => 'getAmountMinor',
        'currency' => 'getCurrency',
        'reason' => 'getReason',
        'reason_details' => 'getReasonDetails',
        'status' => 'getStatus',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('gateway_refund_id', $data ?? [], null);
        $this->setIfExists('amount_minor', $data ?? [], null);
        $this->setIfExists('currency', $data ?? [], null);
        $this->setIfExists('reason', $data ?? [], null);
        $this->setIfExists('reason_details', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['gateway_refund_id'] === null && !$this->isNullableSetToNull('gateway_refund_id')) {
            $invalidProperties[] = "'gateway_refund_id' can't be null";
        }
        ...
        if ($this->container['reason_details'] === null && !$this->isNullableSetToNull('reason_details')) {
            $invalidProperties[] = "'reason_details' can't be null";
        }
        ...
        if ($this->container['processed_at'] === null && !$this->isNullableSetToNull('processed_at')) {
     ...
     * Sets payment_id
     *
     * @param string $payment_id The original payment ID this refund is for (alias for parent_transaction_id)
     *
     * @return self
     */
     ...
     *
     * @param string $parent_transaction_id Parent transaction ID in unified transaction model. Same as payment_id for refunds.
     *
     * @return self
     */
     ...
     * Sets gateway
     *
     * @param string $gateway Name of the payment processor that handled this refund
     *
     * @return self
     */
    ...
    /**
     * Gets gateway_refund_id
     *
     * @return string|null
     */
    public function getGatewayRefundId()
    {
        return $this->container['gateway_refund_id'];
    }

    /**
     * Sets gateway_refund_id
     *
     * @param string|null $gateway_refund_id gateway_refund_id
     *
     * @return self
     */
    public function setGatewayRefundId($gateway_refund_id)
    {
        if (is_null($gateway_refund_id)) {
            array_push($this->openAPINullablesSetToNull, 'gateway_refund_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('gateway_refund_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['gateway_refund_id'] = $gateway_refund_id;
     ...
     * Sets amount_minor
     *
     * @param float $amount_minor Refund amount in cents
     *
     * @return self
     */
    ...
    {
        return $this->container['reason_details'];
    }

    /**
     * Sets reason_details
     *
     * @param string|null $reason_details reason_details
     *
     * @return self
     */
    public function setReasonDetails($reason_details)
    {
        if (is_null($reason_details)) {
            array_push($this->openAPINullablesSetToNull, 'reason_details');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reason_details', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['reason_details'] = $reason_details;
