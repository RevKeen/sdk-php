...
/**
 * RefundTerminalPaymentRequest Class Doc Comment
 *
 * @category Class
 * @description Parameters for refunding a completed terminal payment, optionally specifying a partial amount.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RefundTerminalPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RefundTerminalPaymentRequest';
    ...
    */
     ...
     * Sets amount_minor
     *
     * @param int|null $amount_minor Amount to refund in minor units. Omit for a full refund.
     *
     * @return self
     */
    ...
    public function setReason($reason)
    {
        ...
        if ((mb_strlen($reason) > 500)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling RefundTerminalPaymentRequest., must be smaller than or equal to 500.');
        }
