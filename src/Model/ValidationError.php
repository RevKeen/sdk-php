 ...
 *
 * @category Class
 * @description Returned when request parameters or body fail schema validation. The details.fields object maps each invalid parameter to its validation errors.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ValidationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'error' => '\RevKeen\Model\ValidationErrorError'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \RevKeen\Model\ValidationErrorError
     */
     ...
     * Sets error
     *
     * @param \RevKeen\Model\ValidationErrorError $error error
     *
     * @return self
     */
