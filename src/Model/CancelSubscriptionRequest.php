...
class CancelSubscriptionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('cancel_at_period_end', $data ?? [], true);
    ...
    */
     ...
     *
     * @param bool|null $cancel_at_period_end If `true` (default), cancel at the end of the current period. If `false`, cancel immediately.
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string|null $reason Merchant-visible note recording why the customer canceled.
     *
     * @return self
     */
    public function setReason($reason)
    {
        ...
        if ((mb_strlen($reason) > 500)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling CancelSubscriptionRequest., must be smaller than or equal to 500.');
        }
