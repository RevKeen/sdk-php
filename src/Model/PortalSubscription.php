...
class PortalSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['billing_end_strategy'] === null && !$this->isNullableSetToNull('billing_end_strategy')) {
            $invalidProperties[] = "'billing_end_strategy' can't be null";
        }
        if ($this->container['billing_max_cycles'] === null && !$this->isNullableSetToNull('billing_max_cycles')) {
            $invalidProperties[] = "'billing_max_cycles' can't be null";
        }
    ...
    public function setBillingEndStrategy($billing_end_strategy)
    {
        if (is_null($billing_end_strategy)) {
            array_push($this->openAPINullablesSetToNull, 'billing_end_strategy');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('billing_end_strategy', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
