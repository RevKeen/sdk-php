...
/**
 * PreviewCollectionRequest Class Doc Comment
 *
 * @category Class
 * @description Parameters for previewing the Direct Debit notice → collection → settlement date chain.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PreviewCollectionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PreviewCollectionRequest';
    ...
    */
     ...
     *
     * @param string|null $requested_collection_date Preferred collection date (ISO date). Backend resolves the working-day chain.
     *
     * @return self
     */
     ...
     *
     * @param string|null $subscription_id Subscription the collection is previewed for, if any
     *
     * @return self
     */
