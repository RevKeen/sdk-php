...
class UsageBalanceMeter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'tiers_mode' => 'string',
        'unit_amount_minor' => 'float',
        'unit_amount_decimal' => 'string',
        'package_size' => 'float',
        'percentage_rate_bps' => 'float',
        'current_value' => 'float',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['price_name'] === null && !$this->isNullableSetToNull('price_name')) {
            $invalidProperties[] = "'price_name' can't be null";
        }
        if ($this->container['unit_name'] === null && !$this->isNullableSetToNull('unit_name')) {
            $invalidProperties[] = "'unit_name' can't be null";
        }
        if ($this->container['billing_scheme'] === null && !$this->isNullableSetToNull('billing_scheme')) {
            $invalidProperties[] = "'billing_scheme' can't be null";
        }
        if ($this->container['tiers_mode'] === null && !$this->isNullableSetToNull('tiers_mode')) {
            $invalidProperties[] = "'tiers_mode' can't be null";
        }
        ...
        if ($this->container['percentage_rate_bps'] === null && !$this->isNullableSetToNull('percentage_rate_bps')) {
            $invalidProperties[] = "'percentage_rate_bps' can't be null";
        }
     ...
     * Sets price_name
     *
     * @param string|null $price_name Attached price display name
     *
     * @return self
     */
    public function setPriceName($price_name)
    {
        if (is_null($price_name)) {
            array_push($this->openAPINullablesSetToNull, 'price_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('price_name', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets billing_scheme
     *
     * @param string|null $billing_scheme Pricing scheme used for estimated charges: per_unit, tiered, or percentage
     *
     * @return self
     */
    public function setBillingScheme($billing_scheme)
    {
        if (is_null($billing_scheme)) {
            array_push($this->openAPINullablesSetToNull, 'billing_scheme');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('billing_scheme', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets tiers_mode
     *
     * @param string|null $tiers_mode Tier mode when billing_scheme is tiered
     *
     * @return self
     */
     ...
     *
     * @param float|null $unit_amount_minor Per-unit amount in minor currency units when applicable. Null when the rate is sub-penny — see `unit_amount_decimal`.
     *
     * @return self
     */
     ...
     *
     * @param string|null $unit_amount_decimal Exact per-unit rate in minor units as a decimal string (sub-penny safe, e.g. \"0.02\"). Mirrors Stripe's `unit_amount_decimal`.
     *
     * @return self
     */
     ...
     * Sets package_size
     *
     * @param float|null $package_size Package size when package-style metered pricing is configured
     *
     * @return self
     */
     ...
     *
     * @param float|null $percentage_rate_bps Percentage rate in basis points when billing_scheme is percentage. 70 = 0.7%.
     *
     * @return self
     */
     ...
     * Sets last_event_at
     *
     * @param string|null $last_event_at Most recent usage event timestamp in the current billing period
     *
     * @return self
     */
