...
class PaymentLinksList200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets selection_mode
     *
     * @param string|null $selection_mode Customer-facing checkout shape. bundle=all products together; single_select=radio picker; multi_select=cart with quantity per line.
     *
     * @return self
     */
     ...
     *
     * @param string|null $highlighted_product_id For single_select only — option shown with a 'Popular' badge.
     *
     * @return self
     */
