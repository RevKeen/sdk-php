...
/**
 * PortalInvoice Class Doc Comment
 *
 * @category Class
 * @description A customer-facing invoice projection. Lists and retrievals are scoped to invoices owned by the authenticated customer.
 * @package  RevKeen
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PortalInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortalInvoice';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['subtotal'] === null && !$this->isNullableSetToNull('subtotal')) {
            $invalidProperties[] = "'subtotal' can't be null";
        }
        if ($this->container['tax_amount'] === null && !$this->isNullableSetToNull('tax_amount')) {
            $invalidProperties[] = "'tax_amount' can't be null";
        }
        if ($this->container['discount_amount'] === null && !$this->isNullableSetToNull('discount_amount')) {
        ...
        if ($this->container['amount_due'] === null && !$this->isNullableSetToNull('amount_due')) {
            $invalidProperties[] = "'amount_due' can't be null";
        }
        if ($this->container['invoice_date'] === null && !$this->isNullableSetToNull('invoice_date')) {
