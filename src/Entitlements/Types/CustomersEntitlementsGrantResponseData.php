...
class CustomersEntitlementsGrantResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var ?CustomersEntitlementsGrantResponseDataBenefit $benefit
     */
    #[JsonProperty('benefit')]
    public ?CustomersEntitlementsGrantResponseDataBenefit $benefit;
    ...
    /**
     * @var value-of<CustomersEntitlementsGrantResponseDataStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var value-of<CustomersEntitlementsGrantResponseDataAccessLevel> $accessLevel
     */
     ...
     *   status: value-of<CustomersEntitlementsGrantResponseDataStatus>,
     *   hasAccess: bool,
     *   accessLevel: value-of<CustomersEntitlementsGrantResponseDataAccessLevel>,
     *   benefit?: ?CustomersEntitlementsGrantResponseDataBenefit,
     *   expiresAt?: ?DateTime,
