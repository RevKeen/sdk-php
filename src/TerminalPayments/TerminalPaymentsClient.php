...
namespace RevKeen\TerminalPayments;

use GuzzleHttp\ClientInterface;
use RevKeen\Core\Client\RawClient;
use RevKeen\TerminalPayments\Requests\ListTerminalPaymentsRequest;
use RevKeen\Types\TerminalPaymentListResponse;
...
use RevKeen\TerminalPayments\Requests\CreateTerminalPaymentRequest;
use RevKeen\Types\TerminalPaymentResponse;
use RevKeen\TerminalPayments\Requests\RefundTerminalPaymentRequest;
use RevKeen\TerminalPayments\Requests\VoidTerminalPaymentRequest;
...
class TerminalPaymentsClient
{
     ...
     *
     * @param ListTerminalPaymentsRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * } $options
     * @return TerminalPaymentListResponse
     * @throws RevkeenException
     * @throws RevkeenApiException
     */
    public function list(ListTerminalPaymentsRequest $request = new ListTerminalPaymentsRequest(), ?array $options = null): TerminalPaymentListResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return TerminalPaymentListResponse::fromJson($json);
            }
     ...
     *
     * @param CreateTerminalPaymentRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws RevkeenApiException
     */
    public function create(CreateTerminalPaymentRequest $request, ?array $options = null): TerminalPaymentResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return TerminalPaymentResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     *
     * @param string $id Terminal payment attempt ID
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws RevkeenApiException
     */
    public function retrieve(string $id, ?array $options = null): TerminalPaymentResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws RevkeenApiException
     */
    public function cancel(string $id, ?array $options = null): TerminalPaymentResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Default_->value,
                    path: "terminal-payments/{$id}/cancel",
                    method: HttpMethod::POST,
                ),
                $options,
            );
     ...
     *
     * @param string $id Terminal payment attempt ID of the original sale
     * @param RefundTerminalPaymentRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws RevkeenApiException
     */
    public function refund(string $id, RefundTerminalPaymentRequest $request = new RefundTerminalPaymentRequest(), ?array $options = null): TerminalPaymentResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Default_->value,
                    path: "terminal-payments/{$id}/refund",
                    method: HttpMethod::POST,
                    body: $request,
                ),
                $options,
     ...
     *
     * @param string $id Terminal payment attempt ID of the original sale
     * @param VoidTerminalPaymentRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws RevkeenApiException
     */
    public function void(string $id, VoidTerminalPaymentRequest $request = new VoidTerminalPaymentRequest(), ?array $options = null): TerminalPaymentResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Default_->value,
                    path: "terminal-payments/{$id}/void",
                    method: HttpMethod::POST,
                    body: $request,
                ),
                $options,
