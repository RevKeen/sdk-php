...
use RevKeen\Types\WebhookEndpointListResponse;
...
use RevKeen\WebhookEndpoints\Requests\CreateWebhookEndpointInput;
use RevKeen\Types\WebhookEndpointCreateResponse;
use RevKeen\Types\WebhookEndpointRetrieveResponse;
use RevKeen\Types\WebhookEndpointDeleteResponse;
use RevKeen\WebhookEndpoints\Requests\UpdateWebhookEndpointInput;
use RevKeen\Types\WebhookEndpointUpdateResponse;
use RevKeen\Types\WebhookEndpointRotateSecretResponse;
...
class WebhookEndpointsClient
{
     ...
     */
    public function webhookEndpointsList(WebhookEndpointsListRequest $request = new WebhookEndpointsListRequest(), ?array $options = null): WebhookEndpointListResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return WebhookEndpointListResponse::fromJson($json);
            }
     ...
     *
     * @param CreateWebhookEndpointInput $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws RevkeenApiException
     */
    public function webhookEndpointsCreate(CreateWebhookEndpointInput $request, ?array $options = null): WebhookEndpointCreateResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return WebhookEndpointCreateResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return WebhookEndpointRetrieveResponse
     * @throws RevkeenException
     * @throws RevkeenApiException
     */
    public function webhookEndpointsRetrieve(string $id, ?array $options = null): WebhookEndpointRetrieveResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return WebhookEndpointRetrieveResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     * @throws RevkeenApiException
     */
    public function webhookEndpointsDelete(string $id, ?array $options = null): WebhookEndpointDeleteResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return WebhookEndpointDeleteResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     *
     * @param string $id Webhook endpoint ID
     * @param UpdateWebhookEndpointInput $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return WebhookEndpointUpdateResponse
     * @throws RevkeenException
     * @throws RevkeenApiException
     */
    public function webhookEndpointsUpdate(string $id, UpdateWebhookEndpointInput $request = new UpdateWebhookEndpointInput(), ?array $options = null): WebhookEndpointUpdateResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return WebhookEndpointUpdateResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return WebhookEndpointRotateSecretResponse
     * @throws RevkeenException
     * @throws RevkeenApiException
     */
    public function webhookEndpointsRotateSecret(string $id, ?array $options = null): WebhookEndpointRotateSecretResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return WebhookEndpointRotateSecretResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
