...
class WebhookEndpointsUpdateResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<WebhookEndpointsUpdateResponseDataStatus> $status
     */
    #[JsonProperty('status')]
    public string $status;

    /**
     * @var value-of<WebhookEndpointsUpdateResponseDataCircuitBreakerState> $circuitBreakerState
     */
     ...
     *   status: value-of<WebhookEndpointsUpdateResponseDataStatus>,
     *   circuitBreakerState: value-of<WebhookEndpointsUpdateResponseDataCircuitBreakerState>,
