...
class WebhookEndpointsRetrieveResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<WebhookEndpointsRetrieveResponseDataStatus> $status
     */
    #[JsonProperty('status')]
    public string $status;

    /**
     * @var value-of<WebhookEndpointsRetrieveResponseDataCircuitBreakerState> $circuitBreakerState
     */
     ...
     *   status: value-of<WebhookEndpointsRetrieveResponseDataStatus>,
     *   circuitBreakerState: value-of<WebhookEndpointsRetrieveResponseDataCircuitBreakerState>,
