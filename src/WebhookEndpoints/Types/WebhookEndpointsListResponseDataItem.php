...
class WebhookEndpointsListResponseDataItem extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<WebhookEndpointsListResponseDataItemStatus> $status
     */
    #[JsonProperty('status')]
    public string $status;

    /**
     * @var value-of<WebhookEndpointsListResponseDataItemCircuitBreakerState> $circuitBreakerState
     */
     ...
     *   status: value-of<WebhookEndpointsListResponseDataItemStatus>,
     *   circuitBreakerState: value-of<WebhookEndpointsListResponseDataItemCircuitBreakerState>,
