...
class SubscriptionsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subscriptionsCancelSubscription'] to see the possible values for this operation
     *
     ...
     */
    public function subscriptionsCancelSubscription($id, $cancel_subscription_input = null, string $contentType = self::contentTypes['subscriptionsCancelSubscription'][0])
    {
        list($response) = $this->subscriptionsCancelSubscriptionWithHttpInfo($id, $cancel_subscription_input, $contentType);
        return $response;
    }
     ...
     */
    public function subscriptionsCancelSubscriptionWithHttpInfo($id, $cancel_subscription_input = null, string $contentType = self::contentTypes['subscriptionsCancelSubscription'][0])
    {
        $request = $this->subscriptionsCancelSubscriptionRequest($id, $cancel_subscription_input, $contentType);
     ...
     */
    public function subscriptionsCancelSubscriptionAsync($id, $cancel_subscription_input = null, string $contentType = self::contentTypes['subscriptionsCancelSubscription'][0])
    {
        return $this->subscriptionsCancelSubscriptionAsyncWithHttpInfo($id, $cancel_subscription_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subscriptionsCancelSubscriptionAsyncWithHttpInfo($id, $cancel_subscription_input = null, string $contentType = self::contentTypes['subscriptionsCancelSubscription'][0])
    {
     ...
     */
    public function subscriptionsCancelSubscriptionRequest($id, $cancel_subscription_input = null, string $contentType = self::contentTypes['subscriptionsCancelSubscription'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling subscriptionsCancelSubscription'
            );
        }
    ...
    /**
     * Operation subscriptionsRetrieve
     *
     * Get subscription by ID
     *
     * @param  string $id Subscription UUID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subscriptionsRetrieve'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RevKeen\Model\SubscriptionRetrieveResponse
     */
    public function subscriptionsRetrieve($id, string $contentType = self::contentTypes['subscriptionsRetrieve'][0])
    {
        list($response) = $this->subscriptionsRetrieveWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation subscriptionsRetrieveWithHttpInfo
     *
     * Get subscription by ID
     *
     * @param  string $id Subscription UUID (required)
     ...
     */
    public function subscriptionsRetrieveWithHttpInfo($id, string $contentType = self::contentTypes['subscriptionsRetrieve'][0])
    {
        $request = $this->subscriptionsRetrieveRequest($id, $contentType);
    ...
    /**
     * Operation subscriptionsRetrieveAsync
     *
     * Get subscription by ID
     *
     * @param  string $id Subscription UUID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subscriptionsRetrieveAsync($id, string $contentType = self::contentTypes['subscriptionsRetrieve'][0])
    {
        return $this->subscriptionsRetrieveAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation subscriptionsRetrieveAsyncWithHttpInfo
     *
     * Get subscription by ID
     *
     * @param  string $id Subscription UUID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subscriptionsRetrieveAsyncWithHttpInfo($id, string $contentType = self::contentTypes['subscriptionsRetrieve'][0])
    {
    ...
    /**
     * Create request for operation 'subscriptionsRetrieve'
     *
     * @param  string $id Subscription UUID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subscriptionsRetrieve'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function subscriptionsRetrieveRequest($id, string $contentType = self::contentTypes['subscriptionsRetrieve'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling subscriptionsRetrieve'
            );
        }
