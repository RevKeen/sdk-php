...
class RefundsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['refundsRetrieve'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RevKeen\Model\RefundRetrieveResponse
     */
    public function refundsRetrieve($id, string $contentType = self::contentTypes['refundsRetrieve'][0])
    {
        list($response) = $this->refundsRetrieveWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     */
    public function refundsRetrieveWithHttpInfo($id, string $contentType = self::contentTypes['refundsRetrieve'][0])
    {
        $request = $this->refundsRetrieveRequest($id, $contentType);
    ...
    /**
     * Operation refundsRetrieveAsync
     *
     * Get refund by ID
     *
     * @param  string $id Refund public ID (ref_xxx) or UUID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundsRetrieveAsync($id, string $contentType = self::contentTypes['refundsRetrieve'][0])
    {
        return $this->refundsRetrieveAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation refundsRetrieveAsyncWithHttpInfo
     *
     * Get refund by ID
     *
     * @param  string $id Refund public ID (ref_xxx) or UUID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundsRetrieveAsyncWithHttpInfo($id, string $contentType = self::contentTypes['refundsRetrieve'][0])
    {
    ...
    /**
     * Create request for operation 'refundsRetrieve'
     *
     * @param  string $id Refund public ID (ref_xxx) or UUID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['refundsRetrieve'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function refundsRetrieveRequest($id, string $contentType = self::contentTypes['refundsRetrieve'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling refundsRetrieve'
            );
        }
