...
class CheckoutSessionsApi
{
    ...
    /**
     * Operation checkoutSessionsRetrieve
     *
     * Retrieve a checkout session
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['checkoutSessionsRetrieve'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function checkoutSessionsRetrieve($id, string $contentType = self::contentTypes['checkoutSessionsRetrieve'][0])
    {
        list($response) = $this->checkoutSessionsRetrieveWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation checkoutSessionsRetrieveWithHttpInfo
     *
     * Retrieve a checkout session
     *
     * @param  string $id (required)
     ...
     */
    public function checkoutSessionsRetrieveWithHttpInfo($id, string $contentType = self::contentTypes['checkoutSessionsRetrieve'][0])
    {
        $request = $this->checkoutSessionsRetrieveRequest($id, $contentType);
    ...
    /**
     * Operation checkoutSessionsRetrieveAsync
     *
     * Retrieve a checkout session
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkoutSessionsRetrieveAsync($id, string $contentType = self::contentTypes['checkoutSessionsRetrieve'][0])
    {
        return $this->checkoutSessionsRetrieveAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation checkoutSessionsRetrieveAsyncWithHttpInfo
     *
     * Retrieve a checkout session
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkoutSessionsRetrieveAsyncWithHttpInfo($id, string $contentType = self::contentTypes['checkoutSessionsRetrieve'][0])
    {
    ...
    /**
     * Create request for operation 'checkoutSessionsRetrieve'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['checkoutSessionsRetrieve'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function checkoutSessionsRetrieveRequest($id, string $contentType = self::contentTypes['checkoutSessionsRetrieve'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling checkoutSessionsRetrieve'
            );
        }
