...
class CustomerPortalApi
{
     ...
     *
     * @param  int|null $limit Maximum number of results to return (1-100, default 20). (optional, default to 20)
     * @param  string|null $starting_after Cursor — return results created before the row with this ID. (optional)
     * @param  string|null $ending_before Cursor — return results created after the row with this ID. (optional)
    ...
    /**
     * Operation customerPortalMandatesCancel
     *
     * Cancel a Direct Debit mandate
     *
     * @param  string $id Mandate ID (required)
     * @param  \RevKeen\Model\PaymentLinksExpireRequest|null $payment_links_expire_request payment_links_expire_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesCancel'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RevKeen\Model\CustomerPortalMandatesCancel200Response|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse
     */
    public function customerPortalMandatesCancel($id, $payment_links_expire_request = null, string $contentType = self::contentTypes['customerPortalMandatesCancel'][0])
    {
        list($response) = $this->customerPortalMandatesCancelWithHttpInfo($id, $payment_links_expire_request, $contentType);
        return $response;
    }

    /**
     * Operation customerPortalMandatesCancelWithHttpInfo
     *
     * Cancel a Direct Debit mandate
     *
     * @param  string $id Mandate ID (required)
     ...
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RevKeen\Model\CustomerPortalMandatesCancel200Response|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerPortalMandatesCancelWithHttpInfo($id, $payment_links_expire_request = null, string $contentType = self::contentTypes['customerPortalMandatesCancel'][0])
    {
        $request = $this->customerPortalMandatesCancelRequest($id, $payment_links_expire_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\RevKeen\Model\CustomerPortalMandatesCancel200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation customerPortalMandatesCancelAsync
     *
     * Cancel a Direct Debit mandate
     *
     * @param  string $id Mandate ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerPortalMandatesCancelAsync($id, $payment_links_expire_request = null, string $contentType = self::contentTypes['customerPortalMandatesCancel'][0])
    {
        return $this->customerPortalMandatesCancelAsyncWithHttpInfo($id, $payment_links_expire_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customerPortalMandatesCancelAsyncWithHttpInfo
     *
     * Cancel a Direct Debit mandate
     *
     * @param  string $id Mandate ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerPortalMandatesCancelAsyncWithHttpInfo($id, $payment_links_expire_request = null, string $contentType = self::contentTypes['customerPortalMandatesCancel'][0])
    {
        $returnType = '\RevKeen\Model\CustomerPortalMandatesCancel200Response';
        $request = $this->customerPortalMandatesCancelRequest($id, $payment_links_expire_request, $contentType);
    ...
    /**
     * Create request for operation 'customerPortalMandatesCancel'
     *
     * @param  string $id Mandate ID (required)
     * @param  \RevKeen\Model\PaymentLinksExpireRequest|null $payment_links_expire_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesCancel'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerPortalMandatesCancelRequest($id, $payment_links_expire_request = null, string $contentType = self::contentTypes['customerPortalMandatesCancel'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling customerPortalMandatesCancel'
            );
        }



        $resourcePath = '/customer-portal/mandates/{id}/cancel';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation customerPortalMandatesList
     *
     * List the authenticated customer&#39;s Direct Debit mandates
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesList'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RevKeen\Model\PortalMandateList|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse
     */
    public function customerPortalMandatesList(string $contentType = self::contentTypes['customerPortalMandatesList'][0])
    {
        list($response) = $this->customerPortalMandatesListWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation customerPortalMandatesListWithHttpInfo
     *
     * List the authenticated customer&#39;s Direct Debit mandates
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesList'] to see the possible values for this operation
     ...
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RevKeen\Model\PortalMandateList|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerPortalMandatesListWithHttpInfo(string $contentType = self::contentTypes['customerPortalMandatesList'][0])
    {
        $request = $this->customerPortalMandatesListRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\RevKeen\Model\PortalMandateList',
                        $request,
                        $response,
                    );
                case 401:
    ...
    /**
     * Operation customerPortalMandatesListAsync
     *
     * List the authenticated customer&#39;s Direct Debit mandates
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesList'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerPortalMandatesListAsync(string $contentType = self::contentTypes['customerPortalMandatesList'][0])
    {
        return $this->customerPortalMandatesListAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customerPortalMandatesListAsyncWithHttpInfo
     *
     * List the authenticated customer&#39;s Direct Debit mandates
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesList'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerPortalMandatesListAsyncWithHttpInfo(string $contentType = self::contentTypes['customerPortalMandatesList'][0])
    {
        $returnType = '\RevKeen\Model\PortalMandateList';
        $request = $this->customerPortalMandatesListRequest($contentType);
    ...
    /**
     * Create request for operation 'customerPortalMandatesList'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesList'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerPortalMandatesListRequest(string $contentType = self::contentTypes['customerPortalMandatesList'][0])
    {


        $resourcePath = '/customer-portal/mandates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation customerPortalMandatesReauthorize
     *
     * Re-authorise a Direct Debit mandate with new bank details
     *
     * @param  string $id ID of the mandate being replaced. (required)
     * @param  \RevKeen\Model\PortalReauthorizeMandateRequest $portal_reauthorize_mandate_request portal_reauthorize_mandate_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesReauthorize'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RevKeen\Model\PortalReauthorizeMandateResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse
     */
    public function customerPortalMandatesReauthorize($id, $portal_reauthorize_mandate_request, string $contentType = self::contentTypes['customerPortalMandatesReauthorize'][0])
    {
        list($response) = $this->customerPortalMandatesReauthorizeWithHttpInfo($id, $portal_reauthorize_mandate_request, $contentType);
        return $response;
    }

    /**
     * Operation customerPortalMandatesReauthorizeWithHttpInfo
     *
     * Re-authorise a Direct Debit mandate with new bank details
     *
     * @param  string $id ID of the mandate being replaced. (required)
     * @param  \RevKeen\Model\PortalReauthorizeMandateRequest $portal_reauthorize_mandate_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesReauthorize'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RevKeen\Model\PortalReauthorizeMandateResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerPortalMandatesReauthorizeWithHttpInfo($id, $portal_reauthorize_mandate_request, string $contentType = self::contentTypes['customerPortalMandatesReauthorize'][0])
    {
        $request = $this->customerPortalMandatesReauthorizeRequest($id, $portal_reauthorize_mandate_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\RevKeen\Model\PortalReauthorizeMandateResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation customerPortalMandatesReauthorizeAsync
     *
     * Re-authorise a Direct Debit mandate with new bank details
     *
     * @param  string $id ID of the mandate being replaced. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerPortalMandatesReauthorizeAsync($id, $portal_reauthorize_mandate_request, string $contentType = self::contentTypes['customerPortalMandatesReauthorize'][0])
    {
        return $this->customerPortalMandatesReauthorizeAsyncWithHttpInfo($id, $portal_reauthorize_mandate_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customerPortalMandatesReauthorizeAsyncWithHttpInfo
     *
     * Re-authorise a Direct Debit mandate with new bank details
     *
     * @param  string $id ID of the mandate being replaced. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerPortalMandatesReauthorizeAsyncWithHttpInfo($id, $portal_reauthorize_mandate_request, string $contentType = self::contentTypes['customerPortalMandatesReauthorize'][0])
    {
        $returnType = '\RevKeen\Model\PortalReauthorizeMandateResponse';
        $request = $this->customerPortalMandatesReauthorizeRequest($id, $portal_reauthorize_mandate_request, $contentType);
    ...
    /**
     * Create request for operation 'customerPortalMandatesReauthorize'
     *
     * @param  string $id ID of the mandate being replaced. (required)
     * @param  \RevKeen\Model\PortalReauthorizeMandateRequest $portal_reauthorize_mandate_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesReauthorize'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerPortalMandatesReauthorizeRequest($id, $portal_reauthorize_mandate_request, string $contentType = self::contentTypes['customerPortalMandatesReauthorize'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling customerPortalMandatesReauthorize'
            );
        }

        // verify the required parameter 'portal_reauthorize_mandate_request' is set
        if ($portal_reauthorize_mandate_request === null || (is_array($portal_reauthorize_mandate_request) && count($portal_reauthorize_mandate_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $portal_reauthorize_mandate_request when calling customerPortalMandatesReauthorize'
            );
        }


        $resourcePath = '/customer-portal/mandates/{id}/re-authorize';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($portal_reauthorize_mandate_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($portal_reauthorize_mandate_request));
            } else {
                $httpBody = $portal_reauthorize_mandate_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation customerPortalMandatesReauthorizeSendOtp
     *
     * Send a step-up OTP for a Direct Debit bank-detail change
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesReauthorizeSendOtp'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RevKeen\Model\PortalReauthorizeSendOtpResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse
     */
    public function customerPortalMandatesReauthorizeSendOtp($id, string $contentType = self::contentTypes['customerPortalMandatesReauthorizeSendOtp'][0])
    {
        list($response) = $this->customerPortalMandatesReauthorizeSendOtpWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation customerPortalMandatesReauthorizeSendOtpWithHttpInfo
     *
     * Send a step-up OTP for a Direct Debit bank-detail change
     *
     ...
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RevKeen\Model\PortalReauthorizeSendOtpResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerPortalMandatesReauthorizeSendOtpWithHttpInfo($id, string $contentType = self::contentTypes['customerPortalMandatesReauthorizeSendOtp'][0])
    {
        $request = $this->customerPortalMandatesReauthorizeSendOtpRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\RevKeen\Model\PortalReauthorizeSendOtpResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation customerPortalMandatesReauthorizeSendOtpAsync
     *
     * Send a step-up OTP for a Direct Debit bank-detail change
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerPortalMandatesReauthorizeSendOtpAsync($id, string $contentType = self::contentTypes['customerPortalMandatesReauthorizeSendOtp'][0])
    {
        return $this->customerPortalMandatesReauthorizeSendOtpAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customerPortalMandatesReauthorizeSendOtpAsyncWithHttpInfo
     *
     * Send a step-up OTP for a Direct Debit bank-detail change
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerPortalMandatesReauthorizeSendOtpAsyncWithHttpInfo($id, string $contentType = self::contentTypes['customerPortalMandatesReauthorizeSendOtp'][0])
    {
        $returnType = '\RevKeen\Model\PortalReauthorizeSendOtpResponse';
        $request = $this->customerPortalMandatesReauthorizeSendOtpRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'customerPortalMandatesReauthorizeSendOtp'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesReauthorizeSendOtp'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerPortalMandatesReauthorizeSendOtpRequest($id, string $contentType = self::contentTypes['customerPortalMandatesReauthorizeSendOtp'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling customerPortalMandatesReauthorizeSendOtp'
            );
        }


        $resourcePath = '/customer-portal/mandates/{id}/re-authorize/send-otp';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation customerPortalMandatesReauthorizeVerifyOtp
     *
     * Verify a step-up OTP and receive a change-of-bank token
     *
     * @param  string $id id (required)
     * @param  \RevKeen\Model\PortalReauthorizeVerifyOtpRequest $portal_reauthorize_verify_otp_request portal_reauthorize_verify_otp_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesReauthorizeVerifyOtp'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RevKeen\Model\PortalReauthorizeVerifyOtpResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse
     */
    public function customerPortalMandatesReauthorizeVerifyOtp($id, $portal_reauthorize_verify_otp_request, string $contentType = self::contentTypes['customerPortalMandatesReauthorizeVerifyOtp'][0])
    {
        list($response) = $this->customerPortalMandatesReauthorizeVerifyOtpWithHttpInfo($id, $portal_reauthorize_verify_otp_request, $contentType);
        return $response;
    }

    /**
     * Operation customerPortalMandatesReauthorizeVerifyOtpWithHttpInfo
     *
     * Verify a step-up OTP and receive a change-of-bank token
     *
     * @param  string $id (required)
     * @param  \RevKeen\Model\PortalReauthorizeVerifyOtpRequest $portal_reauthorize_verify_otp_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesReauthorizeVerifyOtp'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RevKeen\Model\PortalReauthorizeVerifyOtpResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse|\RevKeen\Model\CustomerPortalErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerPortalMandatesReauthorizeVerifyOtpWithHttpInfo($id, $portal_reauthorize_verify_otp_request, string $contentType = self::contentTypes['customerPortalMandatesReauthorizeVerifyOtp'][0])
    {
        $request = $this->customerPortalMandatesReauthorizeVerifyOtpRequest($id, $portal_reauthorize_verify_otp_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\RevKeen\Model\PortalReauthorizeVerifyOtpResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation customerPortalMandatesReauthorizeVerifyOtpAsync
     *
     * Verify a step-up OTP and receive a change-of-bank token
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerPortalMandatesReauthorizeVerifyOtpAsync($id, $portal_reauthorize_verify_otp_request, string $contentType = self::contentTypes['customerPortalMandatesReauthorizeVerifyOtp'][0])
    {
        return $this->customerPortalMandatesReauthorizeVerifyOtpAsyncWithHttpInfo($id, $portal_reauthorize_verify_otp_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customerPortalMandatesReauthorizeVerifyOtpAsyncWithHttpInfo
     *
     * Verify a step-up OTP and receive a change-of-bank token
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerPortalMandatesReauthorizeVerifyOtpAsyncWithHttpInfo($id, $portal_reauthorize_verify_otp_request, string $contentType = self::contentTypes['customerPortalMandatesReauthorizeVerifyOtp'][0])
    {
        $returnType = '\RevKeen\Model\PortalReauthorizeVerifyOtpResponse';
        $request = $this->customerPortalMandatesReauthorizeVerifyOtpRequest($id, $portal_reauthorize_verify_otp_request, $contentType);
    ...
    /**
     * Create request for operation 'customerPortalMandatesReauthorizeVerifyOtp'
     *
     * @param  string $id (required)
     * @param  \RevKeen\Model\PortalReauthorizeVerifyOtpRequest $portal_reauthorize_verify_otp_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customerPortalMandatesReauthorizeVerifyOtp'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerPortalMandatesReauthorizeVerifyOtpRequest($id, $portal_reauthorize_verify_otp_request, string $contentType = self::contentTypes['customerPortalMandatesReauthorizeVerifyOtp'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling customerPortalMandatesReauthorizeVerifyOtp'
            );
        }

        // verify the required parameter 'portal_reauthorize_verify_otp_request' is set
        if ($portal_reauthorize_verify_otp_request === null || (is_array($portal_reauthorize_verify_otp_request) && count($portal_reauthorize_verify_otp_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $portal_reauthorize_verify_otp_request when calling customerPortalMandatesReauthorizeVerifyOtp'
            );
        }


        $resourcePath = '/customer-portal/mandates/{id}/re-authorize/verify-otp';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($portal_reauthorize_verify_otp_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($portal_reauthorize_verify_otp_request));
            } else {
                $httpBody = $portal_reauthorize_verify_otp_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  string $id Subscription ID to cancel. (required)
