...
class PricesApi
{
    ...
    /**
     * Operation pricesRetrieve
     *
     * Retrieve a price
     *
     * @param  string $id Price ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pricesRetrieve'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RevKeen\Model\Price|\RevKeen\Model\PriceErrorResponse|\RevKeen\Model\PriceErrorResponse
     */
    public function pricesRetrieve($id, string $contentType = self::contentTypes['pricesRetrieve'][0])
    {
        list($response) = $this->pricesRetrieveWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation pricesRetrieveWithHttpInfo
     *
     * Retrieve a price
     *
     * @param  string $id Price ID (required)
     ...
     * @return array of \RevKeen\Model\Price|\RevKeen\Model\PriceErrorResponse|\RevKeen\Model\PriceErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function pricesRetrieveWithHttpInfo($id, string $contentType = self::contentTypes['pricesRetrieve'][0])
    {
        $request = $this->pricesRetrieveRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pricesRetrieveAsync($id, string $contentType = self::contentTypes['pricesRetrieve'][0])
    {
        return $this->pricesRetrieveAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation pricesRetrieveAsyncWithHttpInfo
     *
     * Retrieve a price
     *
     * @param  string $id Price ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pricesRetrieveAsyncWithHttpInfo($id, string $contentType = self::contentTypes['pricesRetrieve'][0])
    {
        $returnType = '\RevKeen\Model\Price';
        $request = $this->pricesRetrieveRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'pricesRetrieve'
     *
     * @param  string $id Price ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pricesRetrieve'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function pricesRetrieveRequest($id, string $contentType = self::contentTypes['pricesRetrieve'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling pricesRetrieve'
            );
        }
