...
class WebhooksApi
{
    ...
    /**
     * Operation webhooksMeterArchived
     *
     * Meter archived
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksMeterArchived'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhooksMeterArchived($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterArchived'][0])
    {
        $this->webhooksMeterArchivedWithHttpInfo($webhook_event, $contentType);
    }

    /**
     * Operation webhooksMeterArchivedWithHttpInfo
     *
     * Meter archived
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksMeterArchivedWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterArchived'][0])
    {
        $request = $this->webhooksMeterArchivedRequest($webhook_event, $contentType);
    ...
    /**
     * Operation webhooksMeterArchivedAsync
     *
     * Meter archived
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksMeterArchivedAsync($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterArchived'][0])
    {
        return $this->webhooksMeterArchivedAsyncWithHttpInfo($webhook_event, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksMeterArchivedAsyncWithHttpInfo
     *
     * Meter archived
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksMeterArchivedAsyncWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterArchived'][0])
    {
        $returnType = '';
        $request = $this->webhooksMeterArchivedRequest($webhook_event, $contentType);
    ...
    /**
     * Create request for operation 'webhooksMeterArchived'
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksMeterArchived'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksMeterArchivedRequest($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterArchived'][0])
    {



        $resourcePath = '/meter.archived';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhooksMeterCreated
     *
     * Meter created
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksMeterCreated'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhooksMeterCreated($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterCreated'][0])
    {
        $this->webhooksMeterCreatedWithHttpInfo($webhook_event, $contentType);
    }

    /**
     * Operation webhooksMeterCreatedWithHttpInfo
     *
     * Meter created
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksMeterCreatedWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterCreated'][0])
    {
        $request = $this->webhooksMeterCreatedRequest($webhook_event, $contentType);
    ...
    /**
     * Operation webhooksMeterCreatedAsync
     *
     * Meter created
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksMeterCreatedAsync($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterCreated'][0])
    {
        return $this->webhooksMeterCreatedAsyncWithHttpInfo($webhook_event, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksMeterCreatedAsyncWithHttpInfo
     *
     * Meter created
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksMeterCreatedAsyncWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterCreated'][0])
    {
        $returnType = '';
        $request = $this->webhooksMeterCreatedRequest($webhook_event, $contentType);
    ...
    /**
     * Create request for operation 'webhooksMeterCreated'
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksMeterCreated'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksMeterCreatedRequest($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterCreated'][0])
    {



        $resourcePath = '/meter.created';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhooksMeterPriceCreated
     *
     * Meter price created
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksMeterPriceCreated'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhooksMeterPriceCreated($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceCreated'][0])
    {
        $this->webhooksMeterPriceCreatedWithHttpInfo($webhook_event, $contentType);
    }

    /**
     * Operation webhooksMeterPriceCreatedWithHttpInfo
     *
     * Meter price created
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksMeterPriceCreatedWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceCreated'][0])
    {
        $request = $this->webhooksMeterPriceCreatedRequest($webhook_event, $contentType);
    ...
    /**
     * Operation webhooksMeterPriceCreatedAsync
     *
     * Meter price created
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksMeterPriceCreatedAsync($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceCreated'][0])
    {
        return $this->webhooksMeterPriceCreatedAsyncWithHttpInfo($webhook_event, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksMeterPriceCreatedAsyncWithHttpInfo
     *
     * Meter price created
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksMeterPriceCreatedAsyncWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceCreated'][0])
    {
        $returnType = '';
        $request = $this->webhooksMeterPriceCreatedRequest($webhook_event, $contentType);
    ...
    /**
     * Create request for operation 'webhooksMeterPriceCreated'
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksMeterPriceCreated'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksMeterPriceCreatedRequest($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceCreated'][0])
    {



        $resourcePath = '/meter_price.created';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhooksMeterPriceDeactivated
     *
     * Meter price deactivated
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksMeterPriceDeactivated'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhooksMeterPriceDeactivated($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceDeactivated'][0])
    {
        $this->webhooksMeterPriceDeactivatedWithHttpInfo($webhook_event, $contentType);
    }

    /**
     * Operation webhooksMeterPriceDeactivatedWithHttpInfo
     *
     * Meter price deactivated
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksMeterPriceDeactivatedWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceDeactivated'][0])
    {
        $request = $this->webhooksMeterPriceDeactivatedRequest($webhook_event, $contentType);
    ...
    /**
     * Operation webhooksMeterPriceDeactivatedAsync
     *
     * Meter price deactivated
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksMeterPriceDeactivatedAsync($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceDeactivated'][0])
    {
        return $this->webhooksMeterPriceDeactivatedAsyncWithHttpInfo($webhook_event, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksMeterPriceDeactivatedAsyncWithHttpInfo
     *
     * Meter price deactivated
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksMeterPriceDeactivatedAsyncWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceDeactivated'][0])
    {
        $returnType = '';
        $request = $this->webhooksMeterPriceDeactivatedRequest($webhook_event, $contentType);
    ...
    /**
     * Create request for operation 'webhooksMeterPriceDeactivated'
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksMeterPriceDeactivated'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksMeterPriceDeactivatedRequest($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceDeactivated'][0])
    {



        $resourcePath = '/meter_price.deactivated';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhooksMeterPriceUpdated
     *
     * Meter price updated
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksMeterPriceUpdated'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhooksMeterPriceUpdated($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceUpdated'][0])
    {
        $this->webhooksMeterPriceUpdatedWithHttpInfo($webhook_event, $contentType);
    }

    /**
     * Operation webhooksMeterPriceUpdatedWithHttpInfo
     *
     * Meter price updated
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksMeterPriceUpdatedWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceUpdated'][0])
    {
        $request = $this->webhooksMeterPriceUpdatedRequest($webhook_event, $contentType);
    ...
    /**
     * Operation webhooksMeterPriceUpdatedAsync
     *
     * Meter price updated
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksMeterPriceUpdatedAsync($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceUpdated'][0])
    {
        return $this->webhooksMeterPriceUpdatedAsyncWithHttpInfo($webhook_event, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksMeterPriceUpdatedAsyncWithHttpInfo
     *
     * Meter price updated
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksMeterPriceUpdatedAsyncWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceUpdated'][0])
    {
        $returnType = '';
        $request = $this->webhooksMeterPriceUpdatedRequest($webhook_event, $contentType);
    ...
    /**
     * Create request for operation 'webhooksMeterPriceUpdated'
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksMeterPriceUpdated'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksMeterPriceUpdatedRequest($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterPriceUpdated'][0])
    {



        $resourcePath = '/meter_price.updated';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhooksMeterUpdated
     *
     * Meter updated
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksMeterUpdated'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhooksMeterUpdated($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterUpdated'][0])
    {
        $this->webhooksMeterUpdatedWithHttpInfo($webhook_event, $contentType);
    }

    /**
     * Operation webhooksMeterUpdatedWithHttpInfo
     *
     * Meter updated
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksMeterUpdatedWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterUpdated'][0])
    {
        $request = $this->webhooksMeterUpdatedRequest($webhook_event, $contentType);
    ...
    /**
     * Operation webhooksMeterUpdatedAsync
     *
     * Meter updated
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksMeterUpdatedAsync($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterUpdated'][0])
    {
        return $this->webhooksMeterUpdatedAsyncWithHttpInfo($webhook_event, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksMeterUpdatedAsyncWithHttpInfo
     *
     * Meter updated
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksMeterUpdatedAsyncWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterUpdated'][0])
    {
        $returnType = '';
        $request = $this->webhooksMeterUpdatedRequest($webhook_event, $contentType);
    ...
    /**
     * Create request for operation 'webhooksMeterUpdated'
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksMeterUpdated'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksMeterUpdatedRequest($webhook_event = null, string $contentType = self::contentTypes['webhooksMeterUpdated'][0])
    {



        $resourcePath = '/meter.updated';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhooksUsageEventIngested
     *
     * Usage event ingested
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksUsageEventIngested'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhooksUsageEventIngested($webhook_event = null, string $contentType = self::contentTypes['webhooksUsageEventIngested'][0])
    {
        $this->webhooksUsageEventIngestedWithHttpInfo($webhook_event, $contentType);
    }

    /**
     * Operation webhooksUsageEventIngestedWithHttpInfo
     *
     * Usage event ingested
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksUsageEventIngestedWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksUsageEventIngested'][0])
    {
        $request = $this->webhooksUsageEventIngestedRequest($webhook_event, $contentType);
    ...
    /**
     * Operation webhooksUsageEventIngestedAsync
     *
     * Usage event ingested
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksUsageEventIngestedAsync($webhook_event = null, string $contentType = self::contentTypes['webhooksUsageEventIngested'][0])
    {
        return $this->webhooksUsageEventIngestedAsyncWithHttpInfo($webhook_event, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksUsageEventIngestedAsyncWithHttpInfo
     *
     * Usage event ingested
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksUsageEventIngestedAsyncWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksUsageEventIngested'][0])
    {
        $returnType = '';
        $request = $this->webhooksUsageEventIngestedRequest($webhook_event, $contentType);
    ...
    /**
     * Create request for operation 'webhooksUsageEventIngested'
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksUsageEventIngested'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksUsageEventIngestedRequest($webhook_event = null, string $contentType = self::contentTypes['webhooksUsageEventIngested'][0])
    {



        $resourcePath = '/usage.event.ingested';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhooksUsageInvoiceCreated
     *
     * Usage invoice created
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksUsageInvoiceCreated'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhooksUsageInvoiceCreated($webhook_event = null, string $contentType = self::contentTypes['webhooksUsageInvoiceCreated'][0])
    {
        $this->webhooksUsageInvoiceCreatedWithHttpInfo($webhook_event, $contentType);
    }

    /**
     * Operation webhooksUsageInvoiceCreatedWithHttpInfo
     *
     * Usage invoice created
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksUsageInvoiceCreatedWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksUsageInvoiceCreated'][0])
    {
        $request = $this->webhooksUsageInvoiceCreatedRequest($webhook_event, $contentType);
    ...
    /**
     * Operation webhooksUsageInvoiceCreatedAsync
     *
     * Usage invoice created
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksUsageInvoiceCreatedAsync($webhook_event = null, string $contentType = self::contentTypes['webhooksUsageInvoiceCreated'][0])
    {
        return $this->webhooksUsageInvoiceCreatedAsyncWithHttpInfo($webhook_event, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksUsageInvoiceCreatedAsyncWithHttpInfo
     *
     * Usage invoice created
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksUsageInvoiceCreatedAsyncWithHttpInfo($webhook_event = null, string $contentType = self::contentTypes['webhooksUsageInvoiceCreated'][0])
    {
        $returnType = '';
        $request = $this->webhooksUsageInvoiceCreatedRequest($webhook_event, $contentType);
    ...
    /**
     * Create request for operation 'webhooksUsageInvoiceCreated'
     *
     * @param  \RevKeen\Model\WebhookEvent|null $webhook_event (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksUsageInvoiceCreated'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksUsageInvoiceCreatedRequest($webhook_event = null, string $contentType = self::contentTypes['webhooksUsageInvoiceCreated'][0])
    {



        $resourcePath = '/usage.invoice.created';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
