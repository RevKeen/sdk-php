...
class WebhookEndpointsApi
{
     ...
     *
     * @param  string $id Webhook endpoint ID (required)
    ...
    /**
     * Operation webhookEndpointsGet
     *
     * Get webhook endpoint
     *
     * @param  string $id Webhook endpoint ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookEndpointsGet'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RevKeen\Model\WebhookEndpointsGet200Response
     */
    public function webhookEndpointsGet($id, string $contentType = self::contentTypes['webhookEndpointsGet'][0])
    {
        list($response) = $this->webhookEndpointsGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation webhookEndpointsGetWithHttpInfo
     *
     * Get webhook endpoint
     *
     * @param  string $id Webhook endpoint ID (required)
     ...
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RevKeen\Model\WebhookEndpointsGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookEndpointsGetWithHttpInfo($id, string $contentType = self::contentTypes['webhookEndpointsGet'][0])
    {
        $request = $this->webhookEndpointsGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\RevKeen\Model\WebhookEndpointsGet200Response',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation webhookEndpointsGetAsync
     *
     * Get webhook endpoint
     *
     * @param  string $id Webhook endpoint ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookEndpointsGetAsync($id, string $contentType = self::contentTypes['webhookEndpointsGet'][0])
    {
        return $this->webhookEndpointsGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhookEndpointsGetAsyncWithHttpInfo
     *
     * Get webhook endpoint
     *
     * @param  string $id Webhook endpoint ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookEndpointsGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['webhookEndpointsGet'][0])
    {
        $returnType = '\RevKeen\Model\WebhookEndpointsGet200Response';
        $request = $this->webhookEndpointsGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'webhookEndpointsGet'
     *
     * @param  string $id Webhook endpoint ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookEndpointsGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhookEndpointsGetRequest($id, string $contentType = self::contentTypes['webhookEndpointsGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling webhookEndpointsGet'
            );
        }
     ...
     *
     * @param  string|null $status Filter by endpoint status (optional)
     * @param  int|null $limit Maximum number of results to return (1-100, default 20) (optional, default to 20)
     * @param  int|null $offset Number of results to skip for pagination (optional, default to 0)
