...
class PaymentIntentsApi
{
    ...
    /**
     * Operation paymentIntentsRetrieve
     *
     * Retrieve a payment intent
     *
     * @param  string $id Payment intent ID (pi_xxx) (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['paymentIntentsRetrieve'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RevKeen\Model\PaymentIntent|\RevKeen\Model\PaymentIntentErrorResponse
     */
    public function paymentIntentsRetrieve($id, string $contentType = self::contentTypes['paymentIntentsRetrieve'][0])
    {
        list($response) = $this->paymentIntentsRetrieveWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation paymentIntentsRetrieveWithHttpInfo
     *
     * Retrieve a payment intent
     *
     * @param  string $id Payment intent ID (pi_xxx) (required)
     ...
     */
    public function paymentIntentsRetrieveWithHttpInfo($id, string $contentType = self::contentTypes['paymentIntentsRetrieve'][0])
    {
        $request = $this->paymentIntentsRetrieveRequest($id, $contentType);
    ...
    /**
     * Operation paymentIntentsRetrieveAsync
     *
     * Retrieve a payment intent
     *
     * @param  string $id Payment intent ID (pi_xxx) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paymentIntentsRetrieveAsync($id, string $contentType = self::contentTypes['paymentIntentsRetrieve'][0])
    {
        return $this->paymentIntentsRetrieveAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation paymentIntentsRetrieveAsyncWithHttpInfo
     *
     * Retrieve a payment intent
     *
     * @param  string $id Payment intent ID (pi_xxx) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paymentIntentsRetrieveAsyncWithHttpInfo($id, string $contentType = self::contentTypes['paymentIntentsRetrieve'][0])
    {
        $returnType = '\RevKeen\Model\PaymentIntent';
        $request = $this->paymentIntentsRetrieveRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'paymentIntentsRetrieve'
     *
     * @param  string $id Payment intent ID (pi_xxx) (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['paymentIntentsRetrieve'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function paymentIntentsRetrieveRequest($id, string $contentType = self::contentTypes['paymentIntentsRetrieve'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling paymentIntentsRetrieve'
            );
        }
