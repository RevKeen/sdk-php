...
class InvoicesApi
{
    ...
    /**
     * Operation invoicesRetrieve
     *
     * Get invoice
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['invoicesRetrieve'] to see the possible values for this operation
     *
     * @throws \RevKeen\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RevKeen\Model\InvoiceResponse
     */
    public function invoicesRetrieve($id, string $contentType = self::contentTypes['invoicesRetrieve'][0])
    {
        list($response) = $this->invoicesRetrieveWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation invoicesRetrieveWithHttpInfo
     *
     * Get invoice
     *
     * @param  string $id (required)
     ...
     * @return array of \RevKeen\Model\InvoiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function invoicesRetrieveWithHttpInfo($id, string $contentType = self::contentTypes['invoicesRetrieve'][0])
    {
        $request = $this->invoicesRetrieveRequest($id, $contentType);
    ...
    /**
     * Operation invoicesRetrieveAsync
     *
     * Get invoice
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoicesRetrieveAsync($id, string $contentType = self::contentTypes['invoicesRetrieve'][0])
    {
        return $this->invoicesRetrieveAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation invoicesRetrieveAsyncWithHttpInfo
     *
     * Get invoice
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoicesRetrieveAsyncWithHttpInfo($id, string $contentType = self::contentTypes['invoicesRetrieve'][0])
    {
        $returnType = '\RevKeen\Model\InvoiceResponse';
        $request = $this->invoicesRetrieveRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'invoicesRetrieve'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['invoicesRetrieve'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function invoicesRetrieveRequest($id, string $contentType = self::contentTypes['invoicesRetrieve'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling invoicesRetrieve'
            );
        }
