...
namespace RevKeen\Transactions;

use GuzzleHttp\ClientInterface;
use RevKeen\Core\Client\RawClient;
use RevKeen\Transactions\Requests\TransactionsListRequest;
use RevKeen\Types\TransactionListResponse;
...
use RevKeen\Types\TransactionRetrieveResponse;
...
class TransactionsClient
{
     ...
     */
    public function list(TransactionsListRequest $request = new TransactionsListRequest(), ?array $options = null): TransactionListResponse
    {
     ...
     * @throws RevkeenApiException
     */
    public function retrieve(string $id, ?array $options = null): TransactionRetrieveResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return TransactionRetrieveResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
