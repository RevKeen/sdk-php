...
class CreatePaymentLinkResponse extends JsonSerializableType
{
    ...
    /**
     * @var value-of<CreatePaymentLinkResponseMode> $mode
     */
    #[JsonProperty('mode')]
    public string $mode;

    /**
     * @var value-of<CreatePaymentLinkResponseStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var ?array<CreatePaymentLinkResponseLineItemsItem> $lineItems
     */
    #[JsonProperty('line_items'), ArrayType([CreatePaymentLinkResponseLineItemsItem::class])]
    ...
    /**
     * @var ?value-of<CreatePaymentLinkResponseTaxBehavior> $taxBehavior
     */
     ...
     *   merchantId: string,
     *   publicId: string,
     *   mode: value-of<CreatePaymentLinkResponseMode>,
     *   status: value-of<CreatePaymentLinkResponseStatus>,
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
     *   name?: ?string,
     *   slug?: ?string,
     ...
     *   lineItems?: ?array<CreatePaymentLinkResponseLineItemsItem>,
     *   successUrl?: ?string,
     *   cancelUrl?: ?string,
     *   redirectUrl?: ?string,
     *   collectShipping?: ?bool,
     *   allowPromotionCodes?: ?bool,
     *   taxBehavior?: ?value-of<CreatePaymentLinkResponseTaxBehavior>,
