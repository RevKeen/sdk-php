...
class UpdatePaymentLinkStatusResponse extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<UpdatePaymentLinkStatusResponseStatus> $status
     */
    #[JsonProperty('status')]
     ...
     * @param array{
     *   id: string,
     *   status: value-of<UpdatePaymentLinkStatusResponseStatus>,
