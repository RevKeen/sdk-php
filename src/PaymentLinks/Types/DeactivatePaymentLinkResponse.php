...
class DeactivatePaymentLinkResponse extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<DeactivatePaymentLinkResponseStatus> $status
     */
    #[JsonProperty('status')]
     ...
     * @param array{
     *   id: string,
     *   status: value-of<DeactivatePaymentLinkResponseStatus>,
