...
class ExpirePaymentLinkResponse extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<ExpirePaymentLinkResponseMode> $mode
     */
    #[JsonProperty('mode')]
    public string $mode;

    /**
     * @var value-of<ExpirePaymentLinkResponseStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var ?array<ExpirePaymentLinkResponseLineItemsItem> $lineItems
     */
    #[JsonProperty('line_items'), ArrayType([ExpirePaymentLinkResponseLineItemsItem::class])]
    ...
    /**
     * @var ?value-of<ExpirePaymentLinkResponseTaxBehavior> $taxBehavior
     */
     ...
     *   merchantId: string,
     *   publicId: string,
     *   mode: value-of<ExpirePaymentLinkResponseMode>,
     *   status: value-of<ExpirePaymentLinkResponseStatus>,
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
     *   name?: ?string,
     *   slug?: ?string,
     ...
     *   lineItems?: ?array<ExpirePaymentLinkResponseLineItemsItem>,
     *   successUrl?: ?string,
     *   cancelUrl?: ?string,
     *   redirectUrl?: ?string,
     *   collectShipping?: ?bool,
     *   allowPromotionCodes?: ?bool,
     *   taxBehavior?: ?value-of<ExpirePaymentLinkResponseTaxBehavior>,
