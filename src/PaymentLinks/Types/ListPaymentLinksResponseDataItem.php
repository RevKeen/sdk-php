...
class ListPaymentLinksResponseDataItem extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<ListPaymentLinksResponseDataItemMode> $mode
     */
    #[JsonProperty('mode')]
    public string $mode;

    /**
     * @var value-of<ListPaymentLinksResponseDataItemStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var ?array<ListPaymentLinksResponseDataItemLineItemsItem> $lineItems
     */
    #[JsonProperty('line_items'), ArrayType([ListPaymentLinksResponseDataItemLineItemsItem::class])]
    ...
    /**
     * @var ?value-of<ListPaymentLinksResponseDataItemTaxBehavior> $taxBehavior
     */
     ...
     *   merchantId: string,
     *   publicId: string,
     *   mode: value-of<ListPaymentLinksResponseDataItemMode>,
     *   status: value-of<ListPaymentLinksResponseDataItemStatus>,
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
     *   name?: ?string,
     *   slug?: ?string,
     ...
     *   lineItems?: ?array<ListPaymentLinksResponseDataItemLineItemsItem>,
     *   successUrl?: ?string,
     *   cancelUrl?: ?string,
     *   redirectUrl?: ?string,
     *   collectShipping?: ?bool,
     *   allowPromotionCodes?: ?bool,
     *   taxBehavior?: ?value-of<ListPaymentLinksResponseDataItemTaxBehavior>,
