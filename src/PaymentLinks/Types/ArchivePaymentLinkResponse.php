...
class ArchivePaymentLinkResponse extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<ArchivePaymentLinkResponseStatus> $status
     */
    #[JsonProperty('status')]
     ...
     * @param array{
     *   id: string,
     *   status: value-of<ArchivePaymentLinkResponseStatus>,
