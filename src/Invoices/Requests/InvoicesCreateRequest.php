...
use RevKeen\Invoices\Types\InvoicesCreateRequestAllowedMethodsItem;
...
class InvoicesCreateRequest extends JsonSerializableType
{
    ...
    /**
     * @var ?array<value-of<InvoicesCreateRequestAllowedMethodsItem>> $allowedMethods Restrict checkout payment methods for this invoice. When set, narrows available rails for checkout sessions created against this invoice. Omit to use merchant default.
     */
     ...
     *   allowedMethods?: ?array<value-of<InvoicesCreateRequestAllowedMethodsItem>>,
     * } $values
     */
