...
use RevKeen\Types\MeterPriceListResponse;
use RevKeen\Meters\Requests\CreateMeterPriceRequest;
use RevKeen\Types\MeterPriceResponse;
use RevKeen\Meters\Requests\UpdateMeterPriceRequest;
...
class MetersClient
{
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return MeterPriceListResponse
     * @throws RevkeenException
     * @throws RevkeenApiException
     */
    public function listPrices(string $meterId, ?array $options = null): MeterPriceListResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return MeterPriceListResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     *
     * @param string $meterId Meter ID
     * @param CreateMeterPriceRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return MeterPriceResponse
     * @throws RevkeenException
     * @throws RevkeenApiException
     */
    public function createPrice(string $meterId, CreateMeterPriceRequest $request, ?array $options = null): MeterPriceResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return MeterPriceResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     * @param UpdateMeterPriceRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws RevkeenApiException
     */
    public function updatePrice(string $meterId, string $priceId, UpdateMeterPriceRequest $request = new UpdateMeterPriceRequest(), ?array $options = null): MeterPriceResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Default_->value,
                    path: "meters/{$meterId}/prices/{$priceId}",
                    method: HttpMethod::PATCH,
                    body: $request,
                ),
                $options,
     ...
     * @throws RevkeenApiException
     */
    public function deactivatePrice(string $meterId, string $priceId, ?array $options = null): MeterPriceResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Default_->value,
                    path: "meters/{$meterId}/prices/{$priceId}/deactivate",
                    method: HttpMethod::POST,
                ),
                $options,
            );
