...
class CreateMeterRequest extends JsonSerializableType
{
    ...
    /**
     * @var ?array<float> $alertThresholds Threshold percentages that trigger usage.threshold.reached webhooks.
     */
    #[JsonProperty('alert_thresholds'), ArrayType(['float'])]
    ...
    public function __construct(
        ...
        $this->alertThresholds = $values['alertThresholds'] ?? null;
    }
}
