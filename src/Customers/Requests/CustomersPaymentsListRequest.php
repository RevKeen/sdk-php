...
use RevKeen\Customers\Types\CustomersPaymentsListRequestStatus;

class CustomersPaymentsListRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<CustomersPaymentsListRequestStatus> $status Filter by payment status
     */
     ...
     *   endingBefore?: ?string,
     *   status?: ?value-of<CustomersPaymentsListRequestStatus>,
     * } $values
     */
