...
use RevKeen\Customers\Types\CustomersSubscriptionsListRequestStatus;

class CustomersSubscriptionsListRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<CustomersSubscriptionsListRequestStatus> $status Filter by subscription status
     */
     ...
     *   endingBefore?: ?string,
     *   status?: ?value-of<CustomersSubscriptionsListRequestStatus>,
     * } $values
     */
