...
{
    /**
     * @var float $totalOpen Total number of disputes currently requiring action
     */
    #[JsonProperty('total_open')]
    public float $totalOpen;

    /**
     * @var float $overdueCount Number of disputes past their evidence submission deadline
     */
