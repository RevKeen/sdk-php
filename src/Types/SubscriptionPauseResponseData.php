...
class SubscriptionPauseResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<SubscriptionPauseResponseDataStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var value-of<SubscriptionPauseResponseDataBillingInterval> $billingInterval
     */
    ...
    /**
     * @var ?SubscriptionPauseResponseDataDunning $dunning
     */
    #[JsonProperty('dunning')]
    public ?SubscriptionPauseResponseDataDunning $dunning;
     ...
     *   merchantId: string,
     *   customerId: string,
     *   status: value-of<SubscriptionPauseResponseDataStatus>,
     *   quantity: int,
     *   amountMinor: int,
     *   currency: string,
     *   billingInterval: value-of<SubscriptionPauseResponseDataBillingInterval>,
     ...
     *   trialEnd?: ?DateTime,
     *   canceledAt?: ?DateTime,
     *   dunning?: ?SubscriptionPauseResponseDataDunning,
     * } $values
     */
