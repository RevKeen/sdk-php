...
class SubscriptionCreateResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<SubscriptionCreateResponseDataStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var value-of<SubscriptionCreateResponseDataBillingInterval> $billingInterval
     */
    ...
    /**
     * @var ?SubscriptionCreateResponseDataDunning $dunning
     */
    #[JsonProperty('dunning')]
    public ?SubscriptionCreateResponseDataDunning $dunning;
     ...
     *   merchantId: string,
     *   customerId: string,
     *   status: value-of<SubscriptionCreateResponseDataStatus>,
     *   quantity: int,
     *   amountMinor: int,
     *   currency: string,
     *   billingInterval: value-of<SubscriptionCreateResponseDataBillingInterval>,
     ...
     *   trialEnd?: ?DateTime,
     *   canceledAt?: ?DateTime,
     *   dunning?: ?SubscriptionCreateResponseDataDunning,
     * } $values
     */
