...
class WebhookEndpointListResponseDataItem extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<WebhookEndpointListResponseDataItemStatus> $status
     */
    #[JsonProperty('status')]
    public string $status;

    /**
     * @var value-of<WebhookEndpointListResponseDataItemCircuitBreakerState> $circuitBreakerState Circuit breaker status - 'open' means deliveries are paused due to failures
     */
     ...
     *   status: value-of<WebhookEndpointListResponseDataItemStatus>,
     *   circuitBreakerState: value-of<WebhookEndpointListResponseDataItemCircuitBreakerState>,
