...
class SubscriptionReactivateResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<SubscriptionReactivateResponseDataStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var value-of<SubscriptionReactivateResponseDataBillingInterval> $billingInterval
     */
    ...
    /**
     * @var ?SubscriptionReactivateResponseDataDunning $dunning
     */
    #[JsonProperty('dunning')]
    public ?SubscriptionReactivateResponseDataDunning $dunning;
     ...
     *   merchantId: string,
     *   customerId: string,
     *   status: value-of<SubscriptionReactivateResponseDataStatus>,
     *   quantity: int,
     *   amountMinor: int,
     *   currency: string,
     *   billingInterval: value-of<SubscriptionReactivateResponseDataBillingInterval>,
     ...
     *   trialEnd?: ?DateTime,
     *   canceledAt?: ?DateTime,
     *   dunning?: ?SubscriptionReactivateResponseDataDunning,
     * } $values
     */
