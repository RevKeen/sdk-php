...
class ChargeCaptureResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<ChargeCaptureResponseDataStatus> $status
     */
    #[JsonProperty('status')]
     ...
     *   currency: string,
     *   status: value-of<ChargeCaptureResponseDataStatus>,
     *   description: string,
     *   captured: bool,
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
