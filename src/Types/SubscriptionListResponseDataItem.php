...
class SubscriptionListResponseDataItem extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<SubscriptionListResponseDataItemStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var value-of<SubscriptionListResponseDataItemBillingInterval> $billingInterval
     */
    ...
    /**
     * @var ?SubscriptionListResponseDataItemDunning $dunning
     */
    #[JsonProperty('dunning')]
    public ?SubscriptionListResponseDataItemDunning $dunning;
     ...
     *   merchantId: string,
     *   customerId: string,
     *   status: value-of<SubscriptionListResponseDataItemStatus>,
     *   quantity: int,
     *   amountMinor: int,
     *   currency: string,
     *   billingInterval: value-of<SubscriptionListResponseDataItemBillingInterval>,
     ...
     *   trialEnd?: ?DateTime,
     *   canceledAt?: ?DateTime,
     *   dunning?: ?SubscriptionListResponseDataItemDunning,
     * } $values
     */
