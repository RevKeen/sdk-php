...
class SubscriptionChangePlanResponseSubscription extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<SubscriptionChangePlanResponseSubscriptionStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var value-of<SubscriptionChangePlanResponseSubscriptionBillingInterval> $billingInterval
     */
    ...
    /**
     * @var ?SubscriptionChangePlanResponseSubscriptionDunning $dunning
     */
    #[JsonProperty('dunning')]
    public ?SubscriptionChangePlanResponseSubscriptionDunning $dunning;
     ...
     *   merchantId: string,
     *   customerId: string,
     *   status: value-of<SubscriptionChangePlanResponseSubscriptionStatus>,
     *   quantity: int,
     *   amountMinor: int,
     *   currency: string,
     *   billingInterval: value-of<SubscriptionChangePlanResponseSubscriptionBillingInterval>,
     ...
     *   trialEnd?: ?DateTime,
     *   canceledAt?: ?DateTime,
     *   dunning?: ?SubscriptionChangePlanResponseSubscriptionDunning,
     * } $values
     */
