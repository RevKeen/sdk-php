...
class ChargeRefundResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<ChargeRefundResponseDataStatus> $status
     */
    #[JsonProperty('status')]
     ...
     *   currency: string,
     *   status: value-of<ChargeRefundResponseDataStatus>,
     *   description: string,
     *   captured: bool,
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
