...
class SubscriptionRetrieveResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<SubscriptionRetrieveResponseDataStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var value-of<SubscriptionRetrieveResponseDataBillingInterval> $billingInterval
     */
    ...
    /**
     * @var ?SubscriptionRetrieveResponseDataDunning $dunning
     */
    #[JsonProperty('dunning')]
    public ?SubscriptionRetrieveResponseDataDunning $dunning;
     ...
     *   merchantId: string,
     *   customerId: string,
     *   status: value-of<SubscriptionRetrieveResponseDataStatus>,
     *   quantity: int,
     *   amountMinor: int,
     *   currency: string,
     *   billingInterval: value-of<SubscriptionRetrieveResponseDataBillingInterval>,
     ...
     *   trialEnd?: ?DateTime,
     *   canceledAt?: ?DateTime,
     *   dunning?: ?SubscriptionRetrieveResponseDataDunning,
     * } $values
     */
