...
class WebhookEndpoint extends JsonSerializableType
{
    ...
    /**
     * @var ?string $secret Signing secret (only returned on create or rotate)
     */
    #[JsonProperty('secret')]
    public ?string $secret;

    /**
     * @var value-of<WebhookEndpointCircuitBreakerState> $circuitBreakerState Circuit breaker status - 'open' means deliveries are paused due to failures
     */
