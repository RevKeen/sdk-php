...
class SubscriptionResumeResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<SubscriptionResumeResponseDataStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var value-of<SubscriptionResumeResponseDataBillingInterval> $billingInterval
     */
    ...
    /**
     * @var ?SubscriptionResumeResponseDataDunning $dunning
     */
    #[JsonProperty('dunning')]
    public ?SubscriptionResumeResponseDataDunning $dunning;
     ...
     *   merchantId: string,
     *   customerId: string,
     *   status: value-of<SubscriptionResumeResponseDataStatus>,
     *   quantity: int,
     *   amountMinor: int,
     *   currency: string,
     *   billingInterval: value-of<SubscriptionResumeResponseDataBillingInterval>,
     ...
     *   trialEnd?: ?DateTime,
     *   canceledAt?: ?DateTime,
     *   dunning?: ?SubscriptionResumeResponseDataDunning,
     * } $values
     */
