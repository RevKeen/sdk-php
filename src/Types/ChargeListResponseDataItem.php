...
class ChargeListResponseDataItem extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<ChargeListResponseDataItemStatus> $status
     */
    #[JsonProperty('status')]
     ...
     *   currency: string,
     *   status: value-of<ChargeListResponseDataItemStatus>,
     *   description: string,
     *   captured: bool,
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
