...
class SubscriptionCancelSubscriptionResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<SubscriptionCancelSubscriptionResponseDataStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var value-of<SubscriptionCancelSubscriptionResponseDataBillingInterval> $billingInterval
     */
    ...
    /**
     * @var ?SubscriptionCancelSubscriptionResponseDataDunning $dunning
     */
    #[JsonProperty('dunning')]
    public ?SubscriptionCancelSubscriptionResponseDataDunning $dunning;
     ...
     *   merchantId: string,
     *   customerId: string,
     *   status: value-of<SubscriptionCancelSubscriptionResponseDataStatus>,
     *   quantity: int,
     *   amountMinor: int,
     *   currency: string,
     *   billingInterval: value-of<SubscriptionCancelSubscriptionResponseDataBillingInterval>,
     ...
     *   trialEnd?: ?DateTime,
     *   canceledAt?: ?DateTime,
     *   dunning?: ?SubscriptionCancelSubscriptionResponseDataDunning,
     * } $values
     */
