...
class ChargeRetrieveResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<ChargeRetrieveResponseDataStatus> $status
     */
    #[JsonProperty('status')]
     ...
     *   currency: string,
     *   status: value-of<ChargeRetrieveResponseDataStatus>,
     *   description: string,
     *   captured: bool,
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
