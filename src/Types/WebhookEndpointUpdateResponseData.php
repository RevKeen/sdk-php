...
class WebhookEndpointUpdateResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<WebhookEndpointUpdateResponseDataStatus> $status
     */
    #[JsonProperty('status')]
    public string $status;

    /**
     * @var value-of<WebhookEndpointUpdateResponseDataCircuitBreakerState> $circuitBreakerState Circuit breaker status - 'open' means deliveries are paused due to failures
     */
     ...
     *   status: value-of<WebhookEndpointUpdateResponseDataStatus>,
     *   circuitBreakerState: value-of<WebhookEndpointUpdateResponseDataCircuitBreakerState>,
