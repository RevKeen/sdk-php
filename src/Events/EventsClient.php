...
namespace RevKeen\Events;

use GuzzleHttp\ClientInterface;
use RevKeen\Core\Client\RawClient;
use RevKeen\Events\Requests\EventsListRequest;
use RevKeen\Types\EventListResponse;
...
use RevKeen\Types\Event;
use RevKeen\Types\ResendWebhookResponse;
use RevKeen\Events\Requests\CreateTestEventRequest;
use RevKeen\Types\TestEventResponse;
...
class EventsClient
{
     ...
     *
     * @param EventsListRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function list(EventsListRequest $request = new EventsListRequest(), ?array $options = null): EventListResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return EventListResponse::fromJson($json);
            }
     ...
     * @throws RevkeenApiException
     */
    public function retrieve(string $id, ?array $options = null): Event
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws RevkeenApiException
     */
    public function resend(string $id, ?array $options = null): ResendWebhookResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return ResendWebhookResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     *
     * @param CreateTestEventRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws RevkeenApiException
     */
    public function createTest(CreateTestEventRequest $request, ?array $options = null): TestEventResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return TestEventResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
