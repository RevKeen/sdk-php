...
namespace RevKeen\CreditNotes;

use GuzzleHttp\ClientInterface;
use RevKeen\Core\Client\RawClient;
use RevKeen\CreditNotes\Requests\CreditNotesListRequest;
...
use RevKeen\CreditNotes\Requests\CreateCreditNoteInput;
use RevKeen\Types\CreditNoteCreateResponse;
use RevKeen\Types\CreditNoteRetrieveResponse;
use RevKeen\Types\CreditNoteVoidResponse;
...
class CreditNotesClient
{
     ...
     *
     * @param CreditNotesListRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function list(CreditNotesListRequest $request = new CreditNotesListRequest(), ?array $options = null): CreditNoteListResponse
    {
        ...
        if ($request->creditMethod != null) {
            $query['credit_method'] = $request->creditMethod;
        }
     ...
     *
     * @param CreateCreditNoteInput $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws RevkeenApiException
     */
    public function create(CreateCreditNoteInput $request, ?array $options = null): CreditNoteCreateResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return CreditNoteCreateResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     * @throws RevkeenApiException
     */
    public function retrieve(string $id, ?array $options = null): CreditNoteRetrieveResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return CreditNoteRetrieveResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     * @throws RevkeenApiException
     */
    public function void(string $id, ?array $options = null): CreditNoteVoidResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return CreditNoteVoidResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
