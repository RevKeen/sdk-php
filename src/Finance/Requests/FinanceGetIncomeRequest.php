...
use RevKeen\Finance\Types\FinanceGetIncomeRequestGroupBy;

class FinanceGetIncomeRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<FinanceGetIncomeRequestGroupBy> $groupBy Group results by time period
     */
     ...
     *   startDate: string,
     *   endDate: string,
     *   groupBy?: ?value-of<FinanceGetIncomeRequestGroupBy>,
