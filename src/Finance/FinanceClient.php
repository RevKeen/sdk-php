...
use RevKeen\Finance\Requests\FinanceGetIncomeRequest;
use RevKeen\Finance\Types\FinanceGetIncomeResponse;
...
use RevKeen\Finance\Types\FinanceGetSummaryResponse;
...
class FinanceClient
{
     ...
     *
     * @param FinanceGetIncomeRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * } $options
     * @return FinanceGetIncomeResponse
     * @throws RevkeenException
     * @throws RevkeenApiException
     */
    public function getincome(FinanceGetIncomeRequest $request, ?array $options = null): FinanceGetIncomeResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return FinanceGetIncomeResponse::fromJson($json);
            }
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return FinanceGetSummaryResponse
     * @throws RevkeenException
     * @throws RevkeenApiException
     */
    public function getsummary(?array $options = null): FinanceGetSummaryResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return FinanceGetSummaryResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new RevkeenException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
