...
use RevKeen\Payments\Requests\CapturePaymentRequest;
use RevKeen\Payments\Requests\CancelPaymentRequest;
...
class PaymentsClient
{
     ...
     * @throws RevkeenApiException
     */
    public function captureAPayment(string $id, CapturePaymentRequest $request = new CapturePaymentRequest(), ?array $options = null): Payment
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws RevkeenApiException
     */
    public function cancelAPayment(string $id, CancelPaymentRequest $request = new CancelPaymentRequest(), ?array $options = null): Payment
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
