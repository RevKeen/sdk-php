...
namespace RevKeen\Prices;

use GuzzleHttp\ClientInterface;
use RevKeen\Core\Client\RawClient;
use RevKeen\Prices\Requests\PricesListRequest;
use RevKeen\Types\PriceListResponse;
...
use RevKeen\Prices\Requests\CreatePriceRequest;
use RevKeen\Types\Price;
use RevKeen\Prices\Requests\UpdatePriceRequest;
...
class PricesClient
{
     ...
     *
     * @param PricesListRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function list(PricesListRequest $request = new PricesListRequest(), ?array $options = null): PriceListResponse
    {
        ...
        if ($request->pricingModel != null) {
            $query['pricing_model'] = $request->pricingModel;
        }
        ...
        if ($request->lookupKey != null) {
            $query['lookup_key'] = $request->lookupKey;
        }
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return PriceListResponse::fromJson($json);
            }
     ...
     * @throws RevkeenApiException
     */
    public function create(CreatePriceRequest $request, ?array $options = null): Price
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws RevkeenApiException
     */
    public function retrieve(string $id, ?array $options = null): Price
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws RevkeenApiException
     */
    public function archive(string $id, ?array $options = null): Price
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws RevkeenApiException
     */
    public function update(string $id, UpdatePriceRequest $request = new UpdatePriceRequest(), ?array $options = null): Price
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
