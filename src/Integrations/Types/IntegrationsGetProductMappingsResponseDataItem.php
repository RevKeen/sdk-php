...
class IntegrationsGetProductMappingsResponseDataItem extends JsonSerializableType
{
    ...
    /**
     * @var ?float $productAmountMinor
     */
    #[JsonProperty('productAmountMinor')]
    public ?float $productAmountMinor;

    /**
     * @var ?string $productCurrency
     */
    ...
    public function __construct(
        ...
        $this->productAmountMinor = $values['productAmountMinor'] ?? null;
        $this->productCurrency = $values['productCurrency'] ?? null;
