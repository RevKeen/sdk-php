...
namespace RevKeen\TaxRates;

use GuzzleHttp\ClientInterface;
use RevKeen\Core\Client\RawClient;
use RevKeen\TaxRates\Requests\GetTaxRatesRequest;
use RevKeen\Types\TaxRateListResponse;
...
use RevKeen\TaxRates\Requests\CreateTaxRateRequest;
use RevKeen\Types\TaxRate;
use RevKeen\TaxRates\Requests\UpdateTaxRateRequest;
...
class TaxRatesClient
{
     ...
     *
     * @param GetTaxRatesRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function listTaxRates(GetTaxRatesRequest $request = new GetTaxRatesRequest(), ?array $options = null): TaxRateListResponse
    {
        ...
        if ($request->taxType != null) {
            $query['tax_type'] = $request->taxType;
        }
        ...
        if ($request->inclusive != null) {
            $query['inclusive'] = $request->inclusive;
        }
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return TaxRateListResponse::fromJson($json);
            }
     ...
     * @throws RevkeenApiException
     */
    public function createATaxRate(CreateTaxRateRequest $request, ?array $options = null): TaxRate
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws RevkeenApiException
     */
    public function retrieveATaxRate(string $id, ?array $options = null): TaxRate
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws RevkeenApiException
     */
    public function archiveATaxRate(string $id, ?array $options = null): TaxRate
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws RevkeenApiException
     */
    public function updateATaxRate(string $id, UpdateTaxRateRequest $request = new UpdateTaxRateRequest(), ?array $options = null): TaxRate
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
